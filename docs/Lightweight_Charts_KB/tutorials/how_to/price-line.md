...
---
source_url: https://tradingview.github.io/lightweight-charts/tutorials/how_to/price-line
---

# Add Price LineA price line is a horizontal line drawn across the width of the chart at a specific price value.
This example shows how to add price lines to your chart.
## Short answer[​](#short-answer)
A price line can be added to a chart by using the
[`createPriceLine`](/lightweight-charts/docs/api/interfaces/ISeriesApi#createpriceline) method on an existing series
([ISeriesApi](/lightweight-charts/docs/api/interfaces/ISeriesApi)) instance.
```
const myPriceLine = {
price: 1234,
color: '#3179F5',
...
### Price Lines Chart
A line chart demonstrating multiple horizontal price lines with custom styling. The chart features:
- **Chart Type**: Single line series with blue solid line (#2962FF), lineWidth: 2
...
- **Data Pattern**: Volatile trend showing multiple peaks and troughs, starting at 27.58, rising to peak of ~108.24, declining sharply, then recovering to 29.57
- **Price Lines**: Three horizontal reference lines with different styles:
  - **Max Price Line** (teal dashed line, #26a69a): Positioned at 108.24, labeled "max price"
  - **Average Price Line** (black dotted line, #000000): Positioned at 59.23, labeled "ave price"
  - **Min Price Line** (red dashed line, #ef5350): Positioned at 10.22, labeled "min price"
- **Current Value**: Blue rectangular tooltip showing "29.57" at the rightmost data point
- **Purpose**: Demonstrates how to add custom price lines with different colors, styles (solid/dotted/dashed), and labels to mark important price levels
...
- [createPriceLine](/lightweight-charts/docs/api/interfaces/ISeriesApi#createpriceline) - Method to create a new Price Line.
- [PriceLineOptions](/lightweight-charts/docs/api/interfaces/PriceLineOptions) - Price Line options.
- [LineStyle](/lightweight-charts/docs/api/enumerations/LineStyle) - Available line styles.
