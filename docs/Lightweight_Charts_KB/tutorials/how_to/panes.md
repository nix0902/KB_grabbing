...
---
source_url: https://tradingview.github.io/lightweight-charts/tutorials/how_to/panes
---

# PanesLightweight Charts™ allows you to create multiple [panes](/lightweight-charts/docs/next/panes) in a single chart.
...
### Multiple Panes Chart
A dual-pane chart demonstrating the separation of price and volume data into independent chart areas. The chart features:
- **Top Pane (Candlestick Chart)**: 
  - **Chart Type**: Candlestick series showing price action
  - **Candle Colors**: Green (#26a69a) for bullish candles, red (#ef5350) for bearish candles
  - **Y-Axis (Price Scale)**: Vertical axis on the right showing values from 20.00 to 140.00
  - **Grid Lines**: Light gray horizontal and vertical grid lines
  - **Data Pattern**: Volatile price movements with wicks showing high/low ranges
- **Bottom Pane (Area Chart)**:
  - **Chart Type**: Area series with blue line and gradient fill
  - **Y-Axis**: Separate vertical axis showing different value scale
  - **Data Pattern**: Smooth trend showing gradual increase with minor fluctuations
- **Pane Separator**: Red horizontal line (#f22c3d) between the two panes
- **Purpose**: Demonstrates how to display multiple independent chart areas with different data series and scales

## How to add a pane[​](#how-to-add-a-pane)
