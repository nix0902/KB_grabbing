...
> Source: https://tradingview.github.io/lightweight-charts/tutorials/a11y/conclusion
...
- **Keyboard navigation:** The implementation of
keyboard-only navigation on our chart, allowing for interaction exclusively
through keystrokes.

- **ARIA roles and descriptive content:** The additions of ARIA
...
- **High contrast and scalable font size:** The detection of the user's
...
tipThe complete example code provides further insights, and reviewing it is
...
](/lightweight-charts/056b6ae28c3a0b8b735f4f7a5f1b0977.html)
- [
Download the file
