# Time zones | Lightweight Charts

---

Time zones | Lightweight Charts[Skip to main content](#__docusaurus_skipToContent_fallback)
...
### Using pure JavaScript[​](#using-pure-javascript)
...
### Using the date-fns-tz library[​](#using-the-date-fns-tz-library)
...
### Using the IANA time zone database[​](#using-the-iana-time-zone-database)
...
## Why are time zones not supported?[​](#why-are-time-zones-not-supported)
