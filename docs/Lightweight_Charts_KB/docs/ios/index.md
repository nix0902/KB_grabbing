# iOS wrapper | Lightweight Charts

---

iOS wrapper | Lightweight Charts[Skip to main content](#__docusaurus_skipToContent_fallback)
...
## How to run the provided example[​](#how-to-run-the-provided-example)

The [GitHub repository](https://github.com/tradingview/LightweightChartsIOS) for LightweightChartsIOS contains an example of the library in action. To run the example, start by cloning the repository, go to the *Example* directory, and then run
