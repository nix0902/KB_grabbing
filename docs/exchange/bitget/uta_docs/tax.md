# Get Unified Account Tax Records | Bitget API

**URL:** https://www.bitget.com/api-doc/uta/tax/Get-Tax-Records
...
Error Code
Enumeration
TaxGet Unified Account Tax Records
Get Unified Account Tax Records
Copy Page
Description​
...
bizType	String	Yes	Product type
SPOT Spot trading
...
OTHER Other
marginType	String	No	Margin Type:
...
- The unit iscoin
ts	String	The timestamp that system generated the data
