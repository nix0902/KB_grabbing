# Get Rebate Info | Bitget API

**URL:** https://www.bitget.com/api-doc/broker/commission/Get-Rebate-Info
...
Apikey
Error Code
Broker CommissionGet Rebate Info
Get Rebate Info
...
affiliationType	String	Type of rebate relationship
affiliateClient channel
official Official (website) channel
userLevel	String	User level
VIP0
VIP1
...
VIP7
