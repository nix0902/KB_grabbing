::: top-nav
::: top-menu
[![](../../images/log-jk382.svg){.logo}](https://www.bitget.com/en/){.logo-link
target="_self"}

-   [Spot]{#spot data-text="现货"}
-   [FuturesⓂ(USDT/Coin)]{#mix data-text="专业合约"}
-   [Broker]{#broker data-text="Broker"}
-   [Spot Margin]{#margin data-text="现货杠杆"}
-   [Copy Trading]{#copyTrade data-text="跟单交易"}
:::

[English](javascript:void(0);){#international .international}
:::

[ NAV ![](../../images/navbar-cad8cdcb.png) ](index.html#){#nav-button}

::: toc-wrapper
::: lang-selector
[console](index.html#){language-name="console"}
:::
...
<!-- -->
```
-   [Welcome](index.html#welcome){.toc-h1 .toc-link
    data-title="Welcome"}
    -   [Coming Soon](index.html#coming-soon){.toc-h2 .toc-link
        data-title="Coming Soon"}
        -   [New Feature
            Forecast](index.html#new-feature-forecast){.toc-h3 .toc-link
            data-title="New Feature Forecast"}
        -   [Update Forecast](index.html#update-forecast){.toc-h3
            .toc-link data-title="Update Forecast"}
-   [Update log](index.html#update-log){.toc-h1 .toc-link
    data-title="Update log"}
-   [Introduction](index.html#introduction){.toc-h1 .toc-link
    data-title="Introduction"}
    -   [API Introduction](index.html#api-introduction){.toc-h2
        .toc-link data-title="API Introduction"}
    -   [Updates](index.html#updates){.toc-h2 .toc-link
        data-title="Updates"}
    -   [Contact Us](index.html#contact-us){.toc-h2 .toc-link
        data-title="Contact Us"}
    -   [FAQ](index.html#faq){.toc-h2 .toc-link data-title="FAQ"}
-   [Quick Start](index.html#quick-start){.toc-h1 .toc-link
    data-title="Quick Start"}
    -   [Access Preparation](index.html#access-preparation){.toc-h2
        .toc-link data-title="Access Preparation"}
    -   [SDK/Code Example](index.html#sdk-code-example){.toc-h2
        .toc-link data-title="SDK/Code Example"}
    -   [Interface Type](index.html#interface-type){.toc-h2 .toc-link
        data-title="Interface Type"}
    -   [Access Restriction](index.html#access-restriction){.toc-h2
        .toc-link data-title="Access Restriction"}
    -   [API Domain Name](index.html#api-domain-name){.toc-h2 .toc-link
        data-title="API Domain Name"}
    -   [API Verification](index.html#api-verification){.toc-h2
        .toc-link data-title="API Verification"}
    -   [Signature](index.html#signature){.toc-h2 .toc-link
        data-title="Signature"}
    -   [HMAC Signature Code
        Demo](index.html#hmac-signature-code-demo){.toc-h2 .toc-link
        data-title="HMAC Signature Code Demo"}
    -   [RSA Signature Demo
        Code](index.html#rsa-signature-demo-code){.toc-h2 .toc-link
        data-title="RSA Signature Demo Code"}
    -   [Request Interaction](index.html#request-interaction){.toc-h2
        .toc-link data-title="Request Interaction"}
    -   [Standard
        Specification](index.html#standard-specification){.toc-h2
        .toc-link data-title="Standard Specification"}
    -   [API Common
        parameters](index.html#api-common-parameters){.toc-h2 .toc-link
        data-title="API Common parameters"}
        -   [productType](index.html#producttype){.toc-h3 .toc-link
            data-title="productType"}
        -   [candlestick
            interval](index.html#candlestick-interval){.toc-h3 .toc-link
            data-title="candlestick interval"}
        -   [marginMode](index.html#marginmode){.toc-h3 .toc-link
            data-title="marginMode"}
        -   [holdMode](index.html#holdmode){.toc-h3 .toc-link
            data-title="holdMode"}
        -   [holdSide](index.html#holdside){.toc-h3 .toc-link
            data-title="holdSide"}
        -   [business](index.html#business){.toc-h3 .toc-link
            data-title="business"}
        -   [side](index.html#side){.toc-h3 .toc-link data-title="side"}
        -   [tradeSide](index.html#tradeside){.toc-h3 .toc-link
            data-title="tradeSide"}
        -   [timeInForceValue](index.html#timeinforcevalue){.toc-h3
            .toc-link data-title="timeInForceValue"}
        -   [orderType](index.html#ordertype){.toc-h3 .toc-link
            data-title="orderType"}
        -   [state](index.html#state){.toc-h3 .toc-link
            data-title="state"}
        -   [triggerType](index.html#triggertype){.toc-h3 .toc-link
            data-title="triggerType"}
        -   [planType](index.html#plantype){.toc-h3 .toc-link
            data-title="planType"}
        -   [isPlan](index.html#isplan){.toc-h3 .toc-link
            data-title="isPlan"}
        -   [planStatus](index.html#planstatus){.toc-h3 .toc-link
            data-title="planStatus"}
        -   [enterPointSource](index.html#enterpointsource){.toc-h3
            .toc-link data-title="enterPointSource"}
        -   [stopType](index.html#stoptype){.toc-h3 .toc-link
            data-title="stopType"}
        -   [Websocket planType](index.html#websocket-plantype){.toc-h3
            .toc-link data-title="Websocket planType"}
        -   [symbolStatus](index.html#symbolstatus){.toc-h3 .toc-link
            data-title="symbolStatus"}
        -   [fullStatus](index.html#fullstatus){.toc-h3 .toc-link
            data-title="fullStatus"}
        -   [sortRule](index.html#sortrule){.toc-h3 .toc-link
            data-title="sortRule"}
        -   [sortFlag](index.html#sortflag){.toc-h3 .toc-link
            data-title="sortFlag"}
        -   [languageType](index.html#languagetype){.toc-h3 .toc-link
            data-title="languageType"}
        -   [marginType](index.html#margintype){.toc-h3 .toc-link
            data-title="marginType"}
        -   [leverType](index.html#levertype){.toc-h3 .toc-link
            data-title="leverType"}
        -   [traceType](index.html#tracetype){.toc-h3 .toc-link
            data-title="traceType"}
        -   [orderSource](index.html#ordersource){.toc-h3 .toc-link
            data-title="orderSource"}
    -   [Demo Coin Test on Simulated
        Trading](index.html#demo-coin-test-on-simulated-trading){.toc-h2
        .toc-link data-title="Demo Coin Test on Simulated Trading"}
        -   [Get Symbol Information on Simulated
            Trading](index.html#get-symbol-information-on-simulated-trading){.toc-h3
            .toc-link
            data-title="Get Symbol Information on Simulated Trading"}
        -   [Get Depth Information in Simulated
            Trading](index.html#get-depth-information-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get Depth Information in Simulated Trading"}
        -   [Get Ticker Information in Simulated
            Trading](index.html#get-ticker-information-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get Ticker Information in Simulated Trading"}
        -   [Get Account Information in Simulated
            Trading](index.html#get-account-information-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get Account Information in Simulated Trading"}
        -   [Get Open Count in Simulated
            Trading](index.html#get-open-count-in-simulated-trading){.toc-h3
            .toc-link data-title="Get Open Count in Simulated Trading"}
        -   [Get Symbol Position in Simulated
            Trading](index.html#get-symbol-position-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get Symbol Position in Simulated Trading"}
        -   [Get All Position in Simulated
            Trading](index.html#get-all-position-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get All Position in Simulated Trading"}
        -   [Place Order in Simulated
            Trading](index.html#place-order-in-simulated-trading){.toc-h3
            .toc-link data-title="Place Order in Simulated Trading"}
        -   [Place Plan order in Simulated
            Trading](index.html#place-plan-order-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Place Plan order in Simulated Trading"}
        -   [Cancel Plan Order in Simulated
            Trading](index.html#cancel-plan-order-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Cancel Plan Order in Simulated Trading"}
        -   [Cancel All trigger Order in Stimualted
            Trading](index.html#cancel-all-trigger-order-in-stimualted-trading){.toc-h3
            .toc-link
            data-title="Cancel All trigger Order in Stimualted Trading"}
        -   [Get Plan Order (TPSL) List in Simulated
            Trading](index.html#get-plan-order-tpsl-list-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get Plan Order (TPSL) List in Simulated Trading"}
        -   [Get History Plan Orders in Simulated
            Trading](index.html#get-history-plan-orders-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get History Plan Orders in Simulated Trading"}
        -   [Get Order Details in Simulated
            Trading](index.html#get-order-details-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get Order Details in Simulated Trading"}
        -   [Get Order fill detail in Stimualted
            Trading](index.html#get-order-fill-detail-in-stimualted-trading){.toc-h3
            .toc-link
            data-title="Get Order fill detail in Stimualted Trading"}
        -   [Cancel Order in Simulated
            Trading](index.html#cancel-order-in-simulated-trading){.toc-h3
            .toc-link data-title="Cancel Order in Simulated Trading"}
        -   [Cancel All Order in Simulated
            Trading](index.html#cancel-all-order-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Cancel All Order in Simulated Trading"}
        -   [Close All Position in Simulated
            Trading](index.html#close-all-position-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Close All Position in Simulated Trading"}
        -   [Get All Open Order in Simulated
            Trading](index.html#get-all-open-order-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get All Open Order in Simulated Trading"}
        -   [Get ProductType History Orders in Simulated
            Trading](index.html#get-producttype-history-orders-in-simulated-trading){.toc-h3
            .toc-link
            data-title="Get ProductType History Orders in Simulated Trading"}
    -   [Websocket in Simulated
        Trading](index.html#websocket-in-simulated-trading){.toc-h2
        .toc-link data-title="Websocket in Simulated Trading"}
        -   [Tickers Channel: Retrieve the latest traded price, bid
            price, ask price and 24-hour trading volume of the
            instruments. Data will be pushed every 150
            ms.](index.html#tickers-channel-retrieve-the-latest-traded-price-bid-price-ask-price-and-24-hour-trading-volume-of-the-instruments-data-will-be-pushed-every-150-ms){.toc-h3
            .toc-link
            data-title="Tickers Channel: Retrieve the latest traded price, bid price, ask price and 24-hour trading volume of the instruments. Data will be pushed every 150 ms."}
        -   [Order Book Channel: Get Detph
            data](index.html#order-book-channel-get-detph-data){.toc-h3
            .toc-link data-title="Order Book Channel: Get Detph data"}
-   [RestAPI](index.html#restapi){.toc-h1 .toc-link
    data-title="RestAPI"}
    -   [Market](index.html#market){.toc-h2 .toc-link
        data-title="Market"}
        -   [Get All Symbols](index.html#get-all-symbols){.toc-h3
            .toc-link data-title="Get All Symbols"}
        -   [Get merged depth
            data](index.html#get-merged-depth-data){.toc-h3 .toc-link
            data-title="Get merged depth data"}
        -   [Get Depth](index.html#get-depth){.toc-h3 .toc-link
            data-title="Get Depth"}
        -   [Get Single Symbol
            Ticker](index.html#get-single-symbol-ticker){.toc-h3
            .toc-link data-title="Get Single Symbol Ticker"}
        -   [Get All Symbol
            Ticker](index.html#get-all-symbol-ticker){.toc-h3 .toc-link
            data-title="Get All Symbol Ticker"}
        -   [VIP fee rate](index.html#vip-fee-rate){.toc-h3 .toc-link
            data-title="VIP fee rate"}
        -   [Get Recent Fills](index.html#get-recent-fills){.toc-h3
            .toc-link data-title="Get Recent Fills"}
        -   [Get Fills](index.html#get-fills){.toc-h3 .toc-link
            data-title="Get Fills"}
        -   [Get Candle Data](index.html#get-candle-data){.toc-h3
            .toc-link data-title="Get Candle Data"}
        -   [Get History Candle
            Data](index.html#get-history-candle-data){.toc-h3 .toc-link
            data-title="Get History Candle Data"}
        -   [Get History Index Candle
            Data](index.html#get-history-index-candle-data){.toc-h3
            .toc-link data-title="Get History Index Candle Data"}
        -   [Get History Mark Candle
            Data](index.html#get-history-mark-candle-data){.toc-h3
            .toc-link data-title="Get History Mark Candle Data"}
        -   [Get Symbol Index
            Price](index.html#get-symbol-index-price){.toc-h3 .toc-link
            data-title="Get Symbol Index Price"}
        -   [Get Symbol Next Funding
            Time](index.html#get-symbol-next-funding-time){.toc-h3
            .toc-link data-title="Get Symbol Next Funding Time"}
        -   [Get History Funding
            Rate](index.html#get-history-funding-rate){.toc-h3 .toc-link
            data-title="Get History Funding Rate"}
        -   [Get Current Funding
            Rate](index.html#get-current-funding-rate){.toc-h3 .toc-link
            data-title="Get Current Funding Rate"}
        -   [Get Open Interest](index.html#get-open-interest){.toc-h3
            .toc-link data-title="Get Open Interest"}
        -   [Get Symbol Mark
            Price](index.html#get-symbol-mark-price){.toc-h3 .toc-link
            data-title="Get Symbol Mark Price"}
        -   [Get Symbol
            Leverage](index.html#get-symbol-leverage){.toc-h3 .toc-link
            data-title="Get Symbol Leverage"}
        -   [Get Position Tier](index.html#get-position-tier){.toc-h3
            .toc-link data-title="Get Position Tier"}
        -   [Get Risk Position
            Limit](index.html#get-risk-position-limit){.toc-h3 .toc-link
            data-title="Get Risk Position Limit"}
    -   [Account](index.html#account){.toc-h2 .toc-link
        data-title="Account"}
        -   [Get Single Account](index.html#get-single-account){.toc-h3
            .toc-link data-title="Get Single Account"}
        -   [Get Account List](index.html#get-account-list){.toc-h3
            .toc-link data-title="Get Account List"}
        -   [Get sub Account Contract
            Assets](index.html#get-sub-account-contract-assets){.toc-h3
            .toc-link data-title="Get sub Account Contract Assets"}
        -   [Get Open Count](index.html#get-open-count){.toc-h3
            .toc-link data-title="Get Open Count"}
        -   [Change Leverage](index.html#change-leverage){.toc-h3
            .toc-link data-title="Change Leverage"}
        -   [Change Margin](index.html#change-margin){.toc-h3 .toc-link
            data-title="Change Margin"}
        -   [Change Margin Mode](index.html#change-margin-mode){.toc-h3
            .toc-link data-title="Change Margin Mode"}
        -   [Set Auto Margin](index.html#set-auto-margin){.toc-h3
            .toc-link data-title="Set Auto Margin"}
        -   [Change Hold Mode](index.html#change-hold-mode){.toc-h3
            .toc-link data-title="Change Hold Mode"}
        -   [Get Symbol
            Position](index.html#get-symbol-position){.toc-h3 .toc-link
            data-title="Get Symbol Position"}
        -   [Get Symbol Position
            V2](index.html#get-symbol-position-v2){.toc-h3 .toc-link
            data-title="Get Symbol Position V2"}
        -   [Get All Position](index.html#get-all-position){.toc-h3
            .toc-link data-title="Get All Position"}
        -   [Get All Position
            V2](index.html#get-all-position-v2){.toc-h3 .toc-link
            data-title="Get All Position V2"}
        -   [Get History
            Position](index.html#get-history-position){.toc-h3 .toc-link
            data-title="Get History Position"}
        -   [Get Account Bill](index.html#get-account-bill){.toc-h3
            .toc-link data-title="Get Account Bill"}
        -   [Get Business Account
            Bill](index.html#get-business-account-bill){.toc-h3
            .toc-link data-title="Get Business Account Bill"}
    -   [Trade](index.html#trade){.toc-h2 .toc-link data-title="Trade"}
        -   [Place Order](index.html#place-order){.toc-h3 .toc-link
            data-title="Place Order"}
        -   [Reversal](index.html#reversal){.toc-h3 .toc-link
            data-title="Reversal"}
        -   [Batch Order](index.html#batch-order){.toc-h3 .toc-link
            data-title="Batch Order"}
        -   [Cancel Order](index.html#cancel-order){.toc-h3 .toc-link
            data-title="Cancel Order"}
        -   [Batch Cancel Order](index.html#batch-cancel-order){.toc-h3
            .toc-link data-title="Batch Cancel Order"}
        -   [Modify Order](index.html#modify-order){.toc-h3 .toc-link
            data-title="Modify Order"}
        -   [Cancel Order By
            Symbol](index.html#cancel-order-by-symbol){.toc-h3 .toc-link
            data-title="Cancel Order By Symbol"}
        -   [Cancel All Order](index.html#cancel-all-order){.toc-h3
            .toc-link data-title="Cancel All Order"}
        -   [Close All Position](index.html#close-all-position){.toc-h3
            .toc-link data-title="Close All Position"}
        -   [Get Open Order](index.html#get-open-order){.toc-h3
            .toc-link data-title="Get Open Order"}
        -   [Get All Open Order](index.html#get-all-open-order){.toc-h3
            .toc-link data-title="Get All Open Order"}
        -   [Get History Orders](index.html#get-history-orders){.toc-h3
            .toc-link data-title="Get History Orders"}
        -   [Get ProductType History
            Orders](index.html#get-producttype-history-orders){.toc-h3
            .toc-link data-title="Get ProductType History Orders"}
        -   [Get Order Details](index.html#get-order-details){.toc-h3
            .toc-link data-title="Get Order Details"}
        -   [Get Order fill
            detail](index.html#get-order-fill-detail){.toc-h3 .toc-link
            data-title="Get Order fill detail"}
        -   [Get ProductType Order fill
            detail](index.html#get-producttype-order-fill-detail){.toc-h3
            .toc-link data-title="Get ProductType Order fill detail"}
        -   [Place Plan order](index.html#place-plan-order){.toc-h3
            .toc-link data-title="Place Plan order"}
        -   [Modify Plan Order](index.html#modify-plan-order){.toc-h3
            .toc-link data-title="Modify Plan Order"}
        -   [Modify Plan Order
            TPSL](index.html#modify-plan-order-tpsl){.toc-h3 .toc-link
            data-title="Modify Plan Order TPSL"}
        -   [Place Stop Order](index.html#place-stop-order){.toc-h3
            .toc-link data-title="Place Stop Order"}
        -   [Place Trailing Stop
            Order](index.html#place-trailing-stop-order){.toc-h3
            .toc-link data-title="Place Trailing Stop Order"}
        -   [Place Position
            TPSL](index.html#place-position-tpsl){.toc-h3 .toc-link
            data-title="Place Position TPSL"}
        -   [Modify Stop Order](index.html#modify-stop-order){.toc-h3
            .toc-link data-title="Modify Stop Order"}
        -   [Cancel Plan Order
            (TPSL)](index.html#cancel-plan-order-tpsl){.toc-h3 .toc-link
            data-title="Cancel Plan Order (TPSL)"}
        -   [Cancel Plan Order (TPSL) By
            Symbol](index.html#cancel-plan-order-tpsl-by-symbol){.toc-h3
            .toc-link data-title="Cancel Plan Order (TPSL) By Symbol"}
        -   [Cancel All trigger Order
            (TPSL)](index.html#cancel-all-trigger-order-tpsl){.toc-h3
            .toc-link data-title="Cancel All trigger Order (TPSL)"}
        -   [Get Plan Order (TPSL)
            List](index.html#get-plan-order-tpsl-list){.toc-h3 .toc-link
            data-title="Get Plan Order (TPSL) List"}
        -   [Get History Plan Orders
            (TPSL)](index.html#get-history-plan-orders-tpsl){.toc-h3
            .toc-link data-title="Get History Plan Orders (TPSL)"}
-   [WebSocketAPI](index.html#websocketapi){.toc-h1 .toc-link
    data-title="WebSocketAPI"}
    -   [Overview](index.html#overview){.toc-h2 .toc-link
        data-title="Overview"}
    -   [Connect](index.html#connect){.toc-h2 .toc-link
        data-title="Connect"}
    -   [Login](index.html#login){.toc-h2 .toc-link data-title="Login"}
    -   [Subscribe](index.html#subscribe){.toc-h2 .toc-link
        data-title="Subscribe"}
    -   [Unsubscribe](index.html#unsubscribe){.toc-h2 .toc-link
        data-title="Unsubscribe"}
    -   [Checksum](index.html#checksum){.toc-h2 .toc-link
        data-title="Checksum"}
        -   [Merging update data into
            snapshot](index.html#merging-update-data-into-snapshot){.toc-h3
            .toc-link data-title="Merging update data into snapshot"}
        -   [Calculate Checksum](index.html#calculate-checksum){.toc-h3
            .toc-link data-title="Calculate Checksum"}
    -   [Public Channels](index.html#public-channels){.toc-h2 .toc-link
        data-title="Public Channels"}
        -   [Tickers Channel](index.html#tickers-channel){.toc-h3
            .toc-link data-title="Tickers Channel"}
        -   [Candlesticks
            Channel](index.html#candlesticks-channel){.toc-h3 .toc-link
            data-title="Candlesticks Channel"}
        -   [Order Book Channel](index.html#order-book-channel){.toc-h3
            .toc-link data-title="Order Book Channel"}
        -   [Trades Channel](index.html#trades-channel){.toc-h3
            .toc-link data-title="Trades Channel"}
        -   [New Trades Channel](index.html#new-trades-channel){.toc-h3
            .toc-link data-title="New Trades Channel"}
    -   [Private Channels](index.html#private-channels){.toc-h2
        .toc-link data-title="Private Channels"}
        -   [Account Channel](index.html#account-channel){.toc-h3
            .toc-link data-title="Account Channel"}
        -   [Positions Channel](index.html#positions-channel){.toc-h3
            .toc-link data-title="Positions Channel"}
        -   [Order Channel](index.html#order-channel){.toc-h3 .toc-link
            data-title="Order Channel"}
        -   [Plan Order Channel](index.html#plan-order-channel){.toc-h3
            .toc-link data-title="Plan Order Channel"}
-   [RestAPI error codes](index.html#restapi-error-codes){.toc-h1
    .toc-link data-title="RestAPI error codes"}
-   [WebSocket error codes](index.html#websocket-error-codes){.toc-h1
    .toc-link data-title="WebSocket error codes"}
:::
...
Welcome to Bitget ApiDoc! Click [here](index.html#introduction) for
quick start
...
[/api/mix/v1/account/account](index.html#get-single-account) response
\'crossedUnrealizedPL\' \'isolatedUnrealizedPL\'

# Update log

**Oct 30, 2023**

[Place Order](index.html#place-order) logic update forecast:

-   Current logic: \'single_hold\' mode + \"reduceOnly\":true, API will
    return \'40757-Not enough position is available.\' when \'order
    size\' is greater than the \'position size\'
-   New logic: \'single_hold\' mode + \"reduceOnly\":true,
    -   If position size = 0 (was fully closed), a new error will throw:
        `45006-Insufficient position`
    -   If closing size \> position size (over size), original error
        will throw: `40757-Not enough position is available.`
-   Logic in \'double_hold\' mode remains the same

**Sep 21, 2023**

New response field \'uTime\' added:
[/api/mix/v1/position/allPosition-v2](index.html#get-all-position-v2)

**Sep 05, 2023**

-   New interface [Get merged depth
    data](index.html#get-merged-depth-data)

**Aug 31, 2023**

-   new response field \'symbol\' on interface [Close All
    Position](index.html#close-all-position)
-   new response field \'fail_infos\'.\'symbol\' on interface [Cancel
    All Order](index.html#cancel-all-order)

**Aug 29, 2023**

-   New response field on Websocket [Positions
    Channel](index.html#positions-channel): `autoMargin`: auto
    suppliment margin, value: on/off
...
  \"event\":\"error\",\
  \"code\":30003,\
  \"msg\":\"instType:MC,channel:ticker,instId:BTC-USDT Symbol not
exists\"\
}
...
-   Added [Set Auto Margin](index.html#set-auto-margin)

**Aug 21, 2023**

-   New response field on below APIs: `autoMargin`: auto suppliment
    margin, value: on/off
    -   [/api/mix/v1/position/singlePosition](index.html#get-symbol-position)
    -   [/api/mix/v1/position/singlePosition-v2](index.html#get-symbol-position-v2)
    -   [/api/mix/v1/position/allPosition](index.html#get-all-position)
    -   [/api/mix/v1/position/allPosition-v2](index.html#get-all-position-v2)

**Aug 11, 2023**

-   New feature to support RSA signature: [RSA Signature Demo
    Code](index.html#rsa-signature-demo-code)

**July 25, 2023**

-   Added [get history position](index.html#get-history-position)

**July 03, 2023**

-   Added [get history candle data](index.html#get-history-candle-data)
-   Added [get history index candle
    data](index.html#get-history-index-candle-data)
-   Added [get history mark candle
    data](index.html#get-history-mark-candle-data)

**Jun 30, 2023**

-   Added [get risk position limit](index.html#get-risk-position-limit)

**Jun 28, 2023**

-   Added [Demo Coin Test on Simulated
    Trading](index.html#demo-coin-test-on-simulated-trading)
-   Added [Websocket in Simulated
    Trading](index.html#websocket-in-simulated-trading)

**Jun 15, 2023**

-   [symbolStatus](index.html#symbolstatus) added new enum:
    \'restrictedAPI\'
-   [Get History Plan Orders
    (TPSL)](index.html#get-history-plan-orders-tpsl) added param
    \'productType\'

**Jun 05, 2023**

-   Update description on response field: \'orderId\' of [Place
    order](index.html#place-order)

**May 26, 2023**

-   Add new interface
    [Close All Position](index.html#close-all-position)

**May 22, 2023**

-   Add new interface [Modify Order](index.html#modify-order)
-   [Get Account Bill](index.html#get-aaccount-bill) and
    [Get Business Account Bill](index.html#get-business-account-bill)
    add request parameter `business`

**May 20, 2023**

-   [Get Open Order](index.html#get-open-order), [Get All Open
    Order](index.html#get-all-open-order), [Get History
    Orders](index.html#get-history-orders), [Get ProductType History
    Orders](index.html#get-producttype-history-orders), and
    [get Order Detail](index.html#get-order-details) added response
    field `orderSource`

**May 12, 2023**

-   [Get Tader List](index.html#get-trader-list) add parameter:
    `traderUid` trader uid and `traderNickName` trader nickname

May 08, 2023\*\*

-   [Get Candle Data](index.html#get-candle-data) add parameter:
    \'kLineType\' support index/mark price k-line
-   [Get Trader Open order](index.html#get-trader-open-order) parameter:
    \'symbol\' changed to non-mandatory

**May 6, 2023**

-   New interface [Cancel Follower
    Trader](index.html#cancel-follower-trader)

**Apr 21, 2023**

-   New interface [Get Symbol Position
    V2](index.html#get-symbol-position-v2)
-   New interface [Get All Position V2](index.html#get-all-position-v2)

**Mar 28, 2023**

-   New interface [Get Position Tier](index.html#get-position-tier)
-   New interface [Get Trader List](index.html#get-trader-list)
-   New interface [Follower query Trace
    Config](index.html#follower-query-trace-config)
-   New interface [Follower Set copyTrade
    Config](index.html#follower-set-copytrade-config)
-   New interface [Follower Close Position By Tracking
    Number](index.html#follower-close-position-by-tracking-number)
-   New interface [Follower Close Position By Symbol, MarginCoin,
    MarginMode,
    HoldSide](index.html#follower-close-position-by-symbol-margincoin-marginmode-holdside)
-   New interface [Follower Set Tpsl](index.html#follower-set-tpsl)

**Mar 17, 2023**

-   New interface [Get Fills](index.html#get-fills)
-   New interface [Cancel Order By
    Symbol](index.html#cancel-order-by-symbol)
-   New interface [Cancel Plan Order (TPSL) By
    Symbol](index.html#cancel-plan-order-tpsl-by-symbol)

**Mar 15, 2023**

-   [/api/mix/v1/market/ticker](index.html#get-single-symbol-ticker) and
    [/api/mix/v1/market/tickers](index.html##get-all-symbol-ticker)
    added new response fields: \'indexPrice\', \'fundingRate\',
    \'holdingAmount\'
-   [/api/mix/v1/market/candles](index.html#get-candle-data) request
    param \'limit\' max value: 1000
-   [/api/mix/v1/account/account](index.html#get-single-account) and
    [/api/mix/v1/account/accounts](index.html#get-account-list) added
    response field \'unrealizedPL\', \'bonus\'
-   [/api/mix/v1/account/sub-account-contract-assets](index.html#get-sub-account-contract-assets)
    added response field \'bonus\'
-   [/api/mix/v1/order/cancel-order](index.html#cancel-order) added
    request param \'clientOid\'
-   [/api/mix/v1/order/cancel-batch-orders](index.html#batch-cancel-order)
    added request param \'clientOids\', added response field:
    \'client_order_ids\'
-   [/api/mix/v1/order/current](index.html#get-open-order) added
    response field \'priceAvg\', \'filledAmount\', \'leverage\',
    \'marginMode\', \'reduceOnly\', \'enterPointSource\', \'tradeSide\',
    \'holdMode\', \'uTime\'
-   [/api/mix/v1/order/history](index.html#get-history-orders) and
    [/api/mix/v1/order/historyProductType](index.html#get-producttype-history-orders)
    added request param \'clientOid\'; added response fields:
    reduceOnly\', \'enterPointSource\', \'tradeSide\', \'holdMode\'
-   [/api/mix/v1/order/detail](index.html#get-order-details) added
    response fields: \'leverage\', \'marginMode\', \'reduceOnly\',
    \'enterPointSource\', \'tradeSide\', \'holdMode\'
-   [/api/mix/v1/order/fills](index.html#get-order-fill-detail) and
    [/api/mix/v1/order/allFills](index.html#get-producttype-order-fill-detail)
    added response fields: \'enterPointSource\', \'tradeSide\',
    \'holdMode\',\'takerMakerFlag\'
-   [/api/mix/v1/plan/modifyPlan](index.html#modify-plan-order),
    [/api/mix/v1/plan/modifyPlanPreset](index.html#modify-plan-order-tpsl),
    [/api/mix/v1/plan/placeTPSL](index.html#place-stop-order),
    [/api/mix/v1/plan/placeTrailStop](index.html#place-trailing-stop-order),
    [/api/mix/v1/plan/placePositionsTPSL](index.html#place-position-tpsl),
    [/api/mix/v1/plan/modifyTPSLPlan](index.html#modify-stop-order),
    [/api/mix/v1/plan/cancelPlan](index.html#cancel-plan-order-tpsl),
    added param \'clientOid\'
-   [/api/mix/v1/plan/currentPlan](index.html#get-plan-order-tpsl-list)
    and
    [/api/mix/v1/plan/historyPlan](index.html#get-history-plan-orders-tpsl)
    added response fields: \'clientOid\', \'rangeRate\',
    \'enterPointSource\', \'tradeSide\', \'holdMode\'
-   [Order Channel](index.html#order-channel) added push data fields
    \'hM\', \'eps\', \'tS\', \'low\',
-   [Plan Order Channel](index.html#plan-order-channel) added push data
    fields \'hM\', \'eps\', \'triggerTime\', \'userId\', \'version\',
    \'triggerPxType\', \'key\'
-   [RestAPI error codes](index.html#restapi-error-codes) and [WebSocket
    error codes](index.html#websocket-error-codes) added new error code

**Feb 28, 2023**

-   [business](index.html#business) added new value:
    \'contract_settle_fee\': settle funding fee

**Feb 13, 2023**

-   Added new interface RestAPI -\> Market -\> [VIP fee
    rate](index.html#vip-fee-rate)
-   Interface /api/mix/v1/order/fills /api/mix/v1/order/allFills added
    response field: profit/fillAmount

**Jan 30, 2023**

-   /api/mix/v1/plan/placePlan add param: \'reduceOnly\'
-   /api/mix/v1/plan/modifyTPSLPlan param \'triggerPrice\' is required
-   /api/mix/v1/trace/modifyTPSL desc update on param
    \'stopProfitPrice\' & \'stopLossPrice\'

**Jan 27, 2023**

-   [Get sub Account Contract
    Assets](index.html#get-sub-account-contract-assets) add response
    field: unrealizedPL
-   [Place Stop Order](index.html#place-stop-order) triggerType
    desciption updated

**Jan 11, 2023**

-   [Place Order](index.html#place-order) add parameter: reduceOnly
-   [Get All Symbols](index.html#get-all-symbols) add response fields
    symbolStatus\|offTime\|limitOpenTime

**Dec 28, 2022**

-   Provide brand new telegram group for Openapi technical support
-   business added \'burst_long_loss_query\' and
    \'b\'urst_short_loss_query\'
-   websocket -\> account channel -\> push data：delete
    \'crossMaxAvailable\' and \'fixedMaxAvailable\', added
    \'maxOpenPosAvailable\'
...
-   RestAPI -\> Account -\> added [Get sub Account Contract
    Assets](index.html#get-sub-account-contract-assets)
-   WebsocketAPI -\> Private Channel -\> Order Channel -\> Push data
    parameters -\> \'status\' supplement enum: \'init\'
-   WebsocketAPI -\> Public Channel -\> Ticker Channel -\> Push data
    parameters -\> Added \'bidSz\', \'askSz\'

**Nov, 23, 2022**

-   Added new interface RestAPI -\> `trade` -\> [Cancel All trigger
    order](index.html#cancel-all-trigger-order-tpsl) \| [Place trailing
    stop order](index.html#place-trailing-stop-order)
-   Account -\> [Change Hold Mode](index.html#change-hold-mode) change
    request parameter `productType`

**Nov, 11, 2022**

-   Add new interface RestAPI -\> Account -\> [Change Hold
    Mode](index.html#change-hold-mode)
-   Supplementary clause on the [Place Order](index.html#place-order)
    logic with single_hold mode
-   Supplementary clause on the [Reversal](index.html#reversal) logic
    with single_hold mode
-   Add \'init\' to [order status](index.html#state)
-   New values added to [side](index.html#side), added [trade
    side](index.html#tradeside)

**October, 27, 2022**

-   Added channel on WebSocketAPI -\> Public Channels -\> [New Trades
    Channel](index.html#new-trades-channel)
-   WebSocketAPI -\> Public Channels -\> [Order Book
    Channel](index.html#order-book-channel) added channel value：books1
-   WebSocketAPI -\> Private Channels -\> [Plan Order
    Channel](index.html#plan-order-channel) added new push field:
    [websocket plantype](index.html#websocket-plantype)

**October, 14, 2022**

-   Add new interface RestAPI -\> Trade -\>
    [Reversal](index.html#reversal)
...
-   `Market` -\> `Get Sinle Symbol Ticker`, `Get All Symbol Ticker`
    response `openUtc` `chgUtc` UTC0 data
...
-   GET request It is forbidden to transmit parameters in the
    `Request Body`, please pass the parameters in `QueryString`
    **August, 11, 2022**

-   `CopyTrade` -\> `Get CopyTrade Symbols` add response parameter
    `minOpenCount`
...
-   /api/mix/v1/account/accountBusinessBill Added query flow based on
    business line
...
-   /api/mix/v1/order/allFills add new interface get order fill by
    productType

**July, 21, 2022**

-   Websocket connection addition rules, please refer to the
...
-   Add Take Profit and Stop Loss order to place an order based on
    quantity `size` optional
-   Get all transaction details and add `lastEndId` query pagination

**February 12, 2022**

-   add new interface get symbol supported leverage [get symbol
    supported leverage](index.html#get%20symbol%20supported%20leverage)
-   Get transaction details Support query all details [Check Transaction
    Details](index.html#Check%20Transaction%20Details)

**January 05, 2022【Modification of frequency limit rules to add a new
domain name】**
...
-   The interface for traders to view the information of closing and
    copy trading pairs
...
-   The position interface adds a field for liquidation price
    `/singlePosition` `/allPosition`

**September 08, 2021【Contract List and Ticker Quotes】**

-   Get the list of all contracts and get all the ticker quotations
    interface requires the `productType` parameter to be passed in to
    support simulated trading

**September 06, 2021【New account list query】**

-   Account interface New account list query, query all account
    information according to product type
...
This document is the only official document of Bitget API. We will
constantly update the functionalities of Bitget API here. Please pay
attention to it regularly.

You can switch to access different APIs business line by clicking the
upper menu, and you can switch the document language by clicking the
language button on the upper right.

On the right side of the document usually displays example of request
parameters and response results.

## Updates

Regarding API additions, updates, and offline information, Bitget will
issue announcements in advance to notify you. It is recommended that you
follow and subscribe to our announcements to obtain relevant information
in time.

You can click
[here](https://www.bitget.com/en/support/categories/360002621832-Latest-Announcements)
...
A : Traders should use [Trader Close
Position](index.html#trader-close-position)

-   Q2: Order parameter `Symbol` What should I pass? For example,
...
If you need to use the API, please log in to the [web
page](https://www.bitget.com), then apply the API key application and
complete the permission configuration, and then develop and trade
according to the details of this document.

You can click [here](https://www.bitget.com/en/account/newapi) to create
an API Key after login.

Each user can create 10 sets of Api Keys, and each Api Key can set
permissions for reading and trading.

The permissions are described as follows:

-   Read-Only permission: Read permission authorized to query data, such
    as market data.
-   Trade permission: Transaction permission authorized to call the
    interface of placing and cancelling orders.
-   Transfer permission: With this permission it authorized to transfer
    coins between accounts inside Bitget.
-   Withdraw permission: Authorized to withdraw assets from Bitget
    account,
...
-   `APIKey` The identity of API transactions, generated by a random
    algorithm.
-   `SecretKey` The private key is randomly generated by the system and
    used for [Signature](index.html#signature) generation.
-   `Passphrase` The password is set by the user. It should be noted
    that if you forgot the Passphrase, it cannot be retrieved back, and
    the APIKey needs to be recreated.

When creating an APIKey, you can bind to an IP address. For security
reasons, it is strongly recommended that you bind to an IP address。

**Risk Warning** ：These three keys are highly related to account
security. Please keep in mind DO NOT DISCLOSE **Secretkey and
Passphrase** to anyone at any circumstances, even with BitGet employees.
Leaking any one of these three keys may cause the loss of your assets.
If you find by any chance that the APIKey is compromized, please delete
the APIKey as soon as possible.
...
\| [NodeJs](https://www.npmjs.com/package/bitget-api) \|
[PHP](https://github.com/BitgetLimited/v3-bitget-api-sdk/tree/master/bitget-php-sdk-api)

**PostMan（Demo）**
[PostMan](https://bitgetlimited.github.io/apidoc/sdk/Bitget_Mix.postman_collection.json)

You should first try to config the **APIKey, Secretkey and Passphrase**
in the `Environments` tab on left of the PostMan
...
The public interface can be used to obtain configuration information and
market data. Public requests can be used without authentication.

**Private Interface**

The private interface can be used for order management and account
management. Every private request must be
[Signed](index.html#signature).
...
-   Rest API will return 429 status when the access exceeds the
    frequency limit: the request is too frequent.

**Rest API**

If the APIKey is valid, we will use the APIKey to limit the frequency;
if not, the public IP will be used to limit the frequency.

Frequency limit rules: There are separate instructions on each
interface. If the limitation is not specified , the default frequency
limit is 10 times per second.

Special note: When place orders in batch, 10 orders per currency pair
will be counted as one request.
...
The header of all REST requests must contain the following http
headers：

-   ACCESS-KEY：API KEY as a string
-   ACCESS-SIGN：Sign with base64 encoding (see
    [Signature](index.html#signature)).
-   ACCESS-TIMESTAMP：Timestamp of your request. Value equals to
...
::: highlight
``` {.highlight .javascript .tab-javascript}
//Javascript
Math.round(new Date())
```
:::
...
method.toUpperCase() + requestPath + \"?\" + queryString + body** string
(+ means string concat) by **HMAC SHA256** algorithm with **secretKey**.
and encode the encrypted result through **BASE64**.
...
-   queryString：The query string in the request URL (the request
    parameter after the ?).
-   body：The request body in string format. If the request body is
    empty (usually a GET request), the body can be omitted.
...
-   body =
    {\"symbol\":\"BTCUSDT_UMCBL\",\"size\":\"8\",\"side\":\"open_long\",\"orderType\":\"limit\",\"client_oid\":\"bitget#123456\"}
...
Step 1. Use the private key **secretkey** to encrypt the string to be
...
Step 1. Use the RSA privateKey **privateKey** to encrypt the string to
be signed with SHA-256
...
For more demo code on other development languages, please refer to
[SDK](index.html#sdk/code-example)
...
the POST request header should set to:\'application/json\'.

**Request Interaction Description**

-   Request parameters: Encapsulate parameters according to the
    interface request parameters.
-   Submit request parameters: Submit the encapsulated request
    parameters to the server through GET/POST.
-   Server Response：The server first performs parameter security
    verification on the user request data, and returns the response data
    to the user in JSON format according to the business logic after
    passing the verification.
-   Data processing：Process the server response data.

**Success**

HTTP status code 200 indicates a successful response and may contain
content. If the response contains content, it will be displayed in the
...
-   429 Too Many Requests -- Requests are too frequent and are limited
    by the system
...
The unit of ACCESS-TIMESTAMP in the HTTP request signature is
milliseconds. The timestamp of the request must be within 30 seconds of
the API server time, otherwise the request will be considered expired
and rejected. If there is a large deviation between the local server
time and the API server time, we recommend that you compare the
timestamp by querying the [API server
time](../spot/index.html#get-server-time).

**Frequency Limiting Rules**

If the request is too frequent, the system will automatically limit the
request and return the 429 too many requests status code.

-   Public interface：For the [market](index.html#market) information
    interfaces, the unified rate limit is a maximum of 20 requests per
    second.
-   Authorization interface：apikey is used to restrict the calling of
    authorization interfaces, refer to the frequency restriction rules
    of each interface for frequency restriction.

**Request Format**

There are currently only two supported request methods: GET and POST

-   GET: The parameters are transmitted to the server in the path
    through queryString.
...
-   contract_main_settle_fee Funding fee for \'crossed\'. deprecated,
    please don\'t use in query
-   contract_margin_settle_fee Funding fee for \'isolated\'. deprecated,
    please don\'t use in query
...
-   close_long
-   close_short
-   buy_single buy under [single_hold](index.html#holdside) mode
-   sell_single sell under [single_hold](index.html#holdside) mode

### tradeSide

Values for [double_hold](index.html#holdmode)
...
Values for [single_hold](index.html#holdmode)
...
-   pl: default, push data whenever a [plan
    order](index.html#place-plan-order) is
    created/cancelled/modified/triggered
-   tp: take profit event, push data when a [take profit
    order](index.html#place-stop-order)(partial position) is
    created/cancelled/modified/triggered
-   sl: stop loss event, push data when a [stop loss
    order](index.html#place-stop-order)(partial position) is
    created/cancelled/modified/triggered
-   ptp: position take profit event, push data when a [position take
    profit order](index.html#place-position-tpsl)(whole position) is
    created/cancelled/modified/triggered
-   psl: position stop loss event, push data when a [position stop loss
    order](index.html#place-position-tpsl)(whole position) is
    created/cancelled/modified/triggered
...
-   percent Set the ratio of the copy amount to the trader\'s opening
    amount, for example, 1 means the same amount as the trader\'s
    opening amount, 2 means the opening amount is twice the trader\'s
    opening amount
...
Demo coins include ：SUSDT, SBTC, SETH, SEOS, SUSDC, demo Coin does not
have actual value it is only for users to do the simulated trading, demo
coin will be in your account after account registeration : Futures
Account - USDT_M Futures Demo

Simulated trading does not support to use sub-account in most of
interfaces, please use main account
...
productType - sumcbl `USDT simulation perpetual contract` - sdmcbl
`Universal margin simulation perpetual contract` - scmcbl
...
HTTP
Request：/api/mix/v1/account/account?symbol=SBTCSUSDT_SUMCBL&marginCoin=SUSDT
...
HTTP Request：
/api/mix/v1/position/singlePosition?symbol=SBTCSUSDT_SUMCBL&marginCoin=SUSDT
...
planType - profit_plan - normal_plan - loss_plan - pos_profit -
pos_loss - track_plan `Trailing Stop` - moving_plan `Trailing TP/SL`
...
HTTP Request：
/api/mix/v1/plan/currentPlan?symbol=SBTCSUSDT_SUMCBL&isPlan=plan
...
HTTP Request：
/api/mix/v1/plan/historyPlan?symbol=SBTCSUSDT_SUMCBL&startTime=1659406928000&endTime=1659414128000&pageSize=20
...
HTTP Request：
/api/mix/v1/order/detail?symbol=SBTCSUSDT_SUMCBL&orderId=1627293504612
...
HTTP Request：
/api/mix/v1/order/fills?symbol=SBTCSUSDT_SUMCBL&orderId=802382049422487552
...
HTTP Request：
/api/mix/v1/order/marginCoinCurrent?productType=SUMCBL&marginCoin=SUSDT
...
HTTP Request：
/api/mix/v1/order/historyProductType?productType=SUMCB&startTime=1659403328000&endTime=1659410528000&pageSize=20
...
### Tickers Channel: Retrieve the latest traded price, bid price, ask price and 24-hour trading volume of the instruments. Data will be pushed every 150 ms. {#tickers-channel-retrieve-the-latest-traded-price-bid-price-ask-price-and-24-hour-trading-volume-of-the-instruments-data-will-be-pushed-every-150-ms}

Request Example：
`Json { "op":"subscribe", "args":[ { "instType":"MC", "channel":"ticker", "instId":"SBTCSUSDT" } ] } `

Successful Response Example:
`Json { "event":"subscribe", "arg":{ "instType":"MC", "channel":"ticker", "instId":"SBTCSUSDT" } } `
...
Request Example：
`Json { "op":"subscribe", "args":[ { "instType":"mc", "channel":"books5", "instId":"SBTCSUSDT" } ] } `

Successful Response Example:
`Json { "event":"subscribe", "arg":{ "instType":"mc", "channel":"books5", "instId":"SBTCSUSDT" } } `
...
**Request Parameter**
  ...
  ---------------- ---------------- ---------- ----------------------------------------
  productType      String              Yes      [product type](index.html#producttype)
...
**Response Description**
  ...
  symbolStatus           [Symbol Status](index.html#symbolstatus)
...
The price & volume pair would return values in scientific notation
expression
...
Fetch trade history within 30 days, response will be cached with same
param for 10 minutes, please revise \'endTime\' to get the latest
records
...
Could only get data within 30 days for \'1m\' data, default return 100
rows
...
**Request Parameter**
  ...
  ---------------- ---------------- ---------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  symbol           String              Yes                                                                                          Symbol Id (Must be capitalized)
  granularity      String              Yes                                                                          Types of [candlestick interval](index.html#candlestick-interval)
...
**Response Description**
  ...
  Highest price                                                                                                                                                             2
  Lowest price                                                                                                                                                              3
  Closing price, value of the latest candle stick might change, please try subscribe the websocket [candlestick channel](index.html#candlesticks-channel) for the updates   4
...
**Response Description**
  ...
  crossMaxAvailable      The maximum available balance for crossed [margin mode](index.html#marginmode)(margin currency)
  fixedMaxAvailable      The maximum available balance for fixed [margin mode](index.html#marginmode)(margin currency)
  ...
  crossRiskRate          Risk ratio at crossed [margin mode](index.html#marginmode)
  crossMarginLeverage    Leverage level for crossed [margin mode](index.html#marginmode)
  fixedLongLeverage      Long leverage with isolated(fixed) [margin mode](index.html#marginmode)
  fixedShortLeverage     Short leverage with isolated(fixed) [margin mode](index.html#marginmode)
  marginMode             [Margin mode](index.html#marginmode)
  holdMode               [Hold mode](index.html#holdmode)
  unrealizedPL           unrealized profit and loss at crossed [margin mode](index.html#marginmode), unit in USDT
  crossedUnrealizedPL    current symbol unrealized profit and loss at crossed [margin mode](index.html#marginmode), unit in USDT
  isolatedUnrealizedPL   current symbol unrealized profit and loss at isolated [margin mode](index.html#marginmode), unit in USDT
  bonus                  coupon
...
**Response Description**
  ...
  available           Available balance(margin currency)
  crossMaxAvailable   The maximum available balance for crossed [margin mode](index.html#marginmode)(margin currency)
  fixedMaxAvailable   The maximum available balance for isolated(fixed) [margin mode](index.html#marginmode)(margin currency)
  maxTransferOut      Maximum transferable
  equity              Account equity (margin currency), includes uPnL (calculated by mark price)
  usdtEquity          Account equity convert to USDT
  btcEquity           Account equity convert to BTC
...
This interface is only used to calculate the maximum number of positions
that can be opened when the user does not hold a position by the
specified leverage. The result does not represent the actual number of
positions opened.
...
**Request Parameter(Request Body)**
  ...
  holdSide         String               No      Position [direction](index.html#holdside) (ignore this field if [marginMode](index.html#change-margin-mode) is crossed）

The leverage could set to different number in fixed margin mode(holdSide
is required)
...
Server will return error if you call this interface with any exists
position/order
  ...
  symbol           String              Yes         Symbol Id (Must be capitalized)
  marginCoin       String              Yes      Margin currency (Must be capitalized)
  marginMode       String              Yes      [Margin mode](index.html#marginmode)
...
Please DO NOT change the hold mode with existing position/order under
any symbols within the \'productType\'
...
**Request Parameter(Request Body)**
  ...
  holdMode         String              Yes      [Hold mode](index.html#holdmode)

Might fail if intended to change hold mode when the \"symbol\" has
positions/orders on any side
...
**Response Description**
  ...
  symbol              Symbol Id
  marginCoin          Margin currency
  holdSide            Position [direction](index.html#holdside)
  ...
  leverage            [Leverage](index.html#change-leverage)
  achievedProfits     Realized profit and loss
  averageOpenPrice    Average opening price
  marginMode          [Margin mode](index.html#marginmode)
  holdMode            [Position mode](index.html#holdmode)
...
Only return the position information of the position, and return the
liquidation price
...
**Request (Request Param)**
  ...
  Parameter     type      required                                        description
  ------------- -------- ---------- ---------------------------------------------------------------------------------------
  productType   String       No      [Product Type](index.html#producttype), choose one in: \'symbol\' and \'productType\'
...
**Response params**
  ...
  feeCoin       fee coin
  business      [business](index.html#business)
  cTime         create time
...
**Response params**
  ...
  feeByCoupon   fee deduction coupon
  feeCoin       fee coin
  business      [business](index.html#business) type
  cTime         create time
  lastEndId     last end Id, will return when `next` set to true
...
If you are a trader, you can only use this interface to open a position.
To close a position, you need to call `CopyTrade` -\> [Trader close
Position](index.html#trader-close-position)

For trader, if multiple limit order/plan order triggers at the same
second, then the first order will become CopyTrade order, while the rest
will become normal orders (As a result: no one could follow)

The price and quantity of the order need to meet `pricePlace` and
`priceEndStep` `volumePlace`, those fields could be found from the
response of `Market` -\> [Get All Symbols](index.html#get-all-symbols)

for example:

`pricePlace` of `BTCUSDT_UMCBL` is 1 and `priceEndStep` is 5, then the
order price needs to satisfy a multiple of 0.5, for example, the price
should be 23455.0, 23455.5, 23446.0

`pricePlace` of `ETHUSDT_UMCBL` is 2 and `priceEndStep` is 1, then the
order price needs to satisfy a multiple of 0.01, for example, the price
should be 1325.00, 1325.01, 1325.02

If the position quantity is less than the minimum order quantity, the
position can be closed by entering the order quantity into the remaining
quantity of the position when closing the position. However, if the
position quantity is greater than the minimum order quantity, the
minimum order quantity must be met when placing an order.

**Note** if this error occurs when placing an order\
{ \"code\":\"40762\", \"msg\":\"The order size is greater than the max
open size\", \"requestTime\":1627293504612 }

-   There are two scenarios where this error would return

    -   Insufficient account balance
    -   The current maximum openable leverage tier of the current
        trading pair is full, please refer to the specific tier position
        [here](https://www.bitget.com/mix/introduction/positionLevel?code=BTCUSDT_UMCBL?business=USDT_MIX_CONTRACT_BL)

High frequency error when close position：

**Note** if this error occurs when closing an order\
{ \"code\": \"40757\", \"msg\": \"Not enough position is available.\",
\"requestTime\": 1666268894074, \"data\": null }

There are two scenarios where this error would happen

-   0 position
-   Position exists，but specify a wrong `side` param when closing. For
    example: you have a `long` position, and try to close it with
    `side=close_short`

Hold mode = double_hold - if specify a `size` greater than the
`position size` when closing position, the order will success with
`actual position size`, that is, reduceOnly.
...
-   place order interface return success, 1.0 long position will be
    closed, and 2.0 short position will be opened
...
-   place order interface return success, position changes to 0.5 long
    BTCUSDT
-   try to close the long BTCUSDT with size: 0.5 in market price
...
**Note** if below error occurs when operating an order, please DO query
order detail with the clientOid to get the final status\
{ \"code\": \"40010\", \"msg\": \"Request timed out\", \"requestTime\":
1666268894074, \"data\": null }\
{ \"code\": \"40725\", \"msg\": \"service return an error\",
\"requestTime\": 1666268894071, \"data\": null }\
{ \"code\": \"45001\", \"msg\": \"Unknown error\", \"requestTime\":
1666268894071, \"data\": null }
...
**Request Parameter(Request Body)**
  ...
  side                    String              Yes                                                                           [Order direction](index.html#side)
  orderType               String              Yes                                                                           [Order type](index.html#ordertype)
  timeInForceValue        String               No                                                                      [Time in force](index.html#timeinforcevalue)
...
[Order direction](index.html#side) could be either buy_single or
sell_single, the position could ONLY exists on one side: long or short
For example\
Assumed you\'re holding buy_single BTCUSDT_UMCBL size=0.1, follow below
instructions step by step to placeOrder:\
1) first time sell_single + reduceOnly=false size=0.05: 0.05 position
will be closed, you still have buy_single size=0.05\
2) seconds order: sell_single + reduceOnly=false size=0.1: remain
position 0.05 will be closed, buy_single size=0, sell_single size=0.05
will be opened\
3) final order: sell_single + reduceOnly=false size=0.15: sell_single
position size will increase 0.15, at the end sell_single size=0.2\

If receive a response like below:\
{\
\"code\":\"45116\",\
\"msg\":\"The count of positions hold by the account exceeds the maximum
count 150\",\
\"requestTime\":1669910904315,\
\"data\":null\
}\
\
Please noted that for a business line like: USDT perpetual contract, if
counted existing positions + open orders \> 150, you will get above
response\
PS: USDC perpetual contract will be counted separately, same as
universal margin perpetual contract The limitation would change with
time, please be alert with our notifications
...
If client does not pass `clientOid` , the user should be awared that the
order might be duplicated, as this is the only idempotent promise field
...
Reversal logic is different under \"double_hold\"/\"single_hold\" hold
mode:

double_hold: 1) You could usually specify a size(size \> 0 and size \<=
position size), which the size will be closed from your current position
and a same size will be opened on the opposite side 2) \"side\" value:
close_short or close_long

single_hold: 1) The size parameter is omitted, that means you could only
close the whole position, then try to open on the opposite side with
market price, the open position might fail due to margin condition 2)
\"side\" value: sell_single when position side is buy_single, buy_single
when position side is sell_single

Note: Your position will be closed at **market price** and open in
reverse [side](index.html#side) for the specific amount.

If the close position settled amount + available balance are
insufficient to open the specific size of positions, or the reverse
order value is less than 5 USDT, the specified size position will be
closed and the position open will fail.

Your operation may not be 100% successful due to margin, market
conditions and other factors.

You must have an exists position to trigger a reversal operation, or
server will return error \"Not enough position is available.\"
...
The reverse order size usually should be same as the original size. For
example: original position size 100, in reversal request you should set
the size to 100, Server will then close your original position 100, and
open extra 100 in reversal side in market price with the best efforts.
...
-   Reversal - 1 times size
    ...
    -   ideally the 1 long BTCUSDT will be closed, and 1 short BTCUSDT
        will be opened

The reverse order size could also be set to 1.5 or 3 times of the
original size(or even more), in reversal it will first close all of your
position in market price, then try to open reverse position with the
original size (that is: if reversal size is bigger than the original
position size, the reversal size will be treated as the original
position size)
...
The reverse order size could also be set to a number between 0 to 1
times of the original position size, in reversal it will first close
your position with specific reversal size in market price, then try to
open reverse position with the specific size

-   Reversal - 0.5 times size
    -   original position size: 1 long BTCUSDT
    -   reverse order size: 0.5 close_long BTCUSDT
    -   ideally the 0.5 long BTCUSDT will be closed, and 0.5 short
        BTCUSDT will be opened; So at the end you should be holding 0.5
        long BTCUSDT, and 0.5 short BTCUSDT

`orderType` must be market price, a limit price order will be treated as
market price order in reversal
...
If originally `side` is open_long, then in reversal you should set the
`side` to close_long; If originally `side` is open_short, then in
reversal you should set the `side` to close_short; Use `sell_single`
when original position `side` is `buy_single`, Use `buy_single` when
original position `side` is `sell_single`;

Samples on the right side demonstrate a reversal operation. Ideally at
the end you should be holding `100 TRXUSDT short` position
...
**Request Parameter(Request Body)**
  ...
  side               String              Yes      [Order direction](index.html#side), set to close_long or close_short in double_hold mode; set to buy_single or sell_single in single_hold mode
  orderType          String              Yes                                                                    Order type: market
  clientOid          String               No                                                                     Unique Client ID
  timeInForceValue   String               No                                                                    set to \'normal\'
  reverse            Boolean              No                                      Default `false`: [place order](index.html#place-order); `true`: reversal order
...
-   Modify `size` and `price` to only allow Hedge mode, and One-way mode
    are not allowed

-   Modifying `size` and `price` will cancel the old order; then create
    a new order asynchronously, modify the preset TPSL will not cancel
    the old order.

-   Modifying `size` and `price`, please pass in both, not just one of
    them

-   Modify the order `price`, `size` and preset TPSL according to
    `orderId` or `clientOId`

-   It is only allowed to modify the `new` status limit order. If
    the`price` and `size` of the order are modified, the old order will
    be canceled and a new order will be created. Set TPSL will not be
    changed

-   Modify the limit order `price` and `size`, please be sure to provide
    `newClientOid` because the `orderId` of the new order cannot be
    returned synchronously, so you need to use `newClientOid` to help
    you query order information

-   Modifying the order size needs to meet the minimum order quantity

-   If you only modify the TPSL, please do not pass `price` and `size`,
    if you only pass TP or SL , the other one will be canceled
...
Note that for the history order please refer to [Get History
Orders](index.html#get-history-orders)

For the TPSL order please refer to [Get Plan Order (TPSL)
List](index.html#get-plan-order-tpsl-list)
...
**Response Description**
  ...
  state              [Order state](index.html#state)
  side               [Order direction](index.html#tradeside)
  timeInForce        [Time In Force](index.html#timeinforcevalue)
  totalProfits       Total profit and loss
  posSide            [Position direction](index.html#holdside)
  marginCoin         Margin currency
  filledAmount       Filled Amount, quote coin
  leverage           leverage
  marginMode         [Margin mode](index.html#marginmode)
  reduceOnly         Is reduce only
  enterPointSource   [enterPointSource](index.html#enterpointsource)
  tradeSide          [Trade Side](index.html#tradeside)
  holdMode           [Hold mode](index.html#holdmode)
  orderType          [Order type](index.html#ordertype)
  orderSource        [orderSource](index.html#ordersource)
...
**Response Description**
  ...
  leverage                leverage
  marginMode              [marginMode](index.html#marginmode)
  reduceOnly              reduceOnly
  enterPointSource        [enterPointSource](index.html#enterpointsource)
  tradeSide               [tradeSide](index.html#tradeside)
  holdMode                [holdMode](index.html#holdmode)
  orderSource             [orderSource](index.html#ordersource)
  cTime                   Created time
  uTime                   Last update time
...
**Response Description**
  ...
  marginCoin         Margin currency
  leverage           order leverage
  marginMode         account [Margin mode](index.html#marginmode)
  orderType          [Order type](index.html#ordertype)
  reduceOnly         is reduce only
  enterPointSource   [enterPointSource](index.html#enterpointsource)
  tradeSide          [Trade Side](index.html#tradeside)
...
**Response Description**
  ...
  fee                Transaction fee
  side               [Trade side](index.html#tradeside)
...
**Request Parameter (Request Body)**
  ...
  side                    String              Yes                                                                             [Order side](index.html#side)
  orderType               String              Yes                                                                          [Order type](index.html#ordertype)
  triggerType             String              Yes                                                                        [Trigger type](index.html#triggertype)
...
At present, take-profit and stop-loss orders are only supported at
market price, and the trigger type is transaction trigger price
...
**Request Parameter(Request Body)**
  ...
  marginCoin       String              Yes                                    Margin currency (Must be capitalized)
  symbol           String              Yes                                       Symbol Id (Must be capitalized)
  planType         String              Yes       [plan type](index.html#plantype), please use \"profit_plan\", \"loss_plan\" and \"moving_plan\"
  triggerPrice     String              Yes                                                Trigger price
  triggerType      String               No                        [Trigger Type](index.html#triggertype) default \'fill_price\'
  holdSide         String              Yes                   [Hold Side](index.html#holdside), Whether this position is long or short
...
**Request Parameter(Request Body)**
  ...
  symbol           String              Yes                           Symbol Id (Must be capitalized)
  triggerPrice     String              Yes                                    Trigger price
  triggerType      String               No                        [Trigger Type](index.html#triggertype)
...
When the position take profit and stop loss are triggered, the full
amount of the position will be entrusted at the market price by default
...
**Request Parameter(Request Body)**
  ...
  marginCoin       String              Yes                        Margin currency (Must be capitalized)
  symbol           String              Yes                           Symbol Id (Must be capitalized)
  planType         String              Yes      [plan type](index.html#plantype), please use \"pos_profit\", \"pos_loss\"
  triggerPrice     String              Yes                                    Trigger price
  triggerType      String              Yes                       [Trigger type](index.html#triggertype)
...
**Request Parameter(Request Body)**
  ...
  symbol           String              Yes                                            Symbol Id (Must be capitalized)
  triggerPrice     String              Yes                                                     Trigger price
  planType         String              Yes      Refer to [plan type](index.html#plantype): \"pos_profit\" or \"profit_plan\"; \"pos_loss\" or \"loss_plan\"
...
**Request Parameter(Request Body)**
  ...
  symbol           String              Yes                    Symbol Id (Must be capitalized)
  marginCoin       String              Yes                              Margin Coin
  planType         String              Yes                   [plan type](index.html#plantype)
...
Final cancel result should be confirmed via websocket or
[/api/mix/v1/plan/currentPlan](index.html#get-plan-order-tpsl-list)
...
**Request Parameter(Request Body)**
  ...
  ---------------- ---------------- ---------- ----------------------------------------------------
  productType      String              Yes            [product type](index.html#producttype)
  planType         String              Yes      [plan type](index.html#plantype), default \'plan\'
...
**Request Parameter**
  ...
  isPlan           String               No                                  [Is plan](index.html#isplan)
  productType      String               No      [product type](index.html#producttype), \'productType\' and \'symbol\' must have one
...
**Response Description**
  ...
  status                  [Plan order status](index.html#planstatus)
  orderType               [Order type](index.html#ordertype)
  planType                [plan type](index.html#plantype)
  side                    [Trade side](index.html#tradeside)
  triggerType             [Trigger type](index.html#triggertype)
  presetTakeProfitPrice   Preset take profit price
...
**Request Parameter (Request Param)**
  ...
  Parameter Name   Parameter Type    Required                                                  Description
  ---------------- ---------------- ---------- -----------------------------------------------------------------------------------------------------------
  productType      String               No                                        [productType](index.html#producttype)
...
**Response Description**
  ...
  orderType               [Order type](index.html#ordertype)
  planType                [Plan type](index.html#plantype)
  side                    [Side](index.html#tradeside)
  triggerType             [Trigger type](index.html#triggertype)
  presetTakeProfitPrice   Preset take profit price
  presetTakeLossPrice     Preset stop loss price
  rangeRate               planType is \"moving_plan\", \"1\" means 1.0% price correction, two decimal places
...
WebSocket is a new HTML5 protocol that achieves full-duplex data
transmission between the client and server, allowing data to be
transferred effectively in both directions. A connection between the
client and server can be established with just one handshake. The server
will then be able to push data to the client according to preset rules.
Its advantages include:

-   The WebSocket request header size for data transmission between
    client and server is only 2 bytes.
-   Either the client or server can initiate data transmission.
-   There\'s no need to repeatedly create and delete TCP connections,
    saving resources on bandwidth and server.

It is strongly recommended that developers use WebSocket API to obtain
market information and transaction depth.
...
If there's a network problem, the system will automatically disconnect
the connection.
...
3.  Expect a \'pong\' as a response. If the response message is not
    received within 30 seconds, please raise an error and/or reconnect.
4.  The Websocket server accepts up to 10 messages per second. The
    message includes:
5.  PING frame
6.  Messages in JSON format, such as subscribe, unsubscribe.
7.  If the user sends more messages than the limit, the connection will
    be disconnected. IPs that are repeatedly disconnected may be blocked
    by the server;
...
[apply](https://www.bitget.com/en/account/newapi) one manually.

**passphrase**: APIKey password

**timestamp**: the Unix Epoch time, the unit is seconds(\--different
from the signature timestamp of restAPI\--)

**secretKey**: The security key generated when the user applies for
APIKey, e.g. : 22582BD0CFF14C41EDBF1AB98506286D
...
First concatenate `timestamp`, `method`, `requestPath`, then use HMAC
SHA256 method to encrypt the concatenated string with SecretKey, and
then perform Base64 encoding.

The request will expire 30 seconds after the timestamp. If your server
time differs from the API server time, we recommended using the REST API
to query the [API server
time](https://bitgetlimited.github.io/en/spot/#get-server-time) and then
...
[Tickers channel](index.html#tickers-channel)

[Candlesticks channel](index.html#candlesticks-channel)

[Order book channel](index.html#order-book-channel)

[Trades channel](index.html#trades-channel)

etc \-- do not require log in.

`Private channels` \-- include

[Account channel](index.html#account-channels)

[Positions channel](index.html#positions-channel)

[Order channel](index.html#order-channel)

[Plan order channel](index.html#plan-order-channel)

-   `instId` from [Get All Symbols](index.html#get-all-symbols)
    `baseCoin + quoteCoin`

Users can choose to subscribe to one or more channels, and the total
length of multiple channels cannot exceed 4096 bytes.
...
This mechanism can assist users in checking the accuracy of depth(order
book) data.

### Merging update data into snapshot

After subscribe to the channel (such as `books` 400 levels) of [Order
book](index.html#order-book-channel) , user first receive the initial
snapshot of market depth. Afterwards the incremental update is
subsequently received, user are responsible to update the snapshot from
client side.

1.  If there are any levels with same price from the updates, compare
    the amount with the snapshot order book:

    If the amount is 0, delete this depth data.

    If the amount changes, replace the depth data.

2.  If there is no level in the snapshot with same price from the
    update, insert the update depth information into the snapshot sort
    by price (bid in descending order, ask in ascending order).

### Calculate Checksum

Use the first 25 bids and asks in the local snapshot to build a string
(where a colon connects the price and amount in an ask or a bid), and
then calculate the CRC32 value (32-bit signed integer).
...
1.  When the bid and ask depth data exceeds 25 levels, each of them will
    intercept 25 levels of data, and the string to be checked is queued
    in a way that the bid and ask depth data are alternately arranged.
    Such as:
    `bid1[price:amount]`:`ask1[price:amount]`:`bid2[price:amount]`:`ask2[price:amount]`\...
2.  When the bid or ask depth data is less than 25 levels, the missing
    depth data will be ignored. Such as:
    `bid1[price:amount]`:`ask1[price:amount]`:`ask2[price:amount]`:`ask3[price:amount]`\...
3.  If price is \'0.5000\', DO NOT calculate the checksum by \'0.5\',
    please DO use the original value

## Public Channels

### Tickers Channel

Retrieve the latest traded price, bid price, ask price and 24-hour
trading volume of the instruments. Data will be pushed every 150 ms.
...
**Request parameters**
  ...
  \> instId     String   Yes        Instrument ID, value refer to [Get All Symbols](index.html#get-all-symbols) on response field: \'symbolName\'
...
Retrieve the candlesticks data of an instrument. Data will be pushed
every 500 ms.

The channel will push a snapshot after successful subscribed, later on
the updates will be pushed

If intended to query history data in a customized time range, please
refer to [Get Candle Data](index.html#get-candle-data)
...
Use `books` for snapshot data, `book5` for 5 depth levels, ` book15` for
15 depth levels

-   `books`: Push the full `snapshot` data for the first time, push
    `update` afterwards, that is, if there is a change in depth, the
    depth data that has changed will be pushed.
-   `books1`: 1 depth levels will be pushed every time(all snapshot, no
    update).
-   `books5`: 5 depth levels will be pushed every time(all snapshot, no
    update).
-   `books15`: 15 depth levels will be pushed every time(all snapshot,
    no update). Data will be pushed every 100 \~ 200 ms when there is
...
Noted that bids are in descending order, while asks are in ascending
order
...
where \"411.8\" is the depth price, \"10\" is the size**

### Trades Channel

Retrieve the recent trades data. Data will be pushed whenever there is a
trade.
...
Retrieve the recent trades data. The first snapshot will push 50 trade
records. Data will be pushed whenever there is a trade.
...
Retrieve account information. Data will be pushed when triggered by
events such as placing/canceling order, and will also be pushed in
regular interval according to subscription granularity.
...
Retrieve position information. Initial snapshot will be pushed once
subscribed. Data will be pushed when triggered by events such as
...
Retrieve order information. Data will not be pushed when first
subscribed. Data will only be pushed when triggered by events such as
placing/canceling/force liquidate order.
...
**Push Data Parameter**
  ...
  **Parameter**        **Type**   **Description**
  ...
  \> hM                String     [Hold Mode](index.html#holdmode)
  \> eps               String     [enterPointSource](index.html#enterpointsource)
  \> tS                String     [Trade Side](index.html#tradeside)
...
**Push Data**
  ...
  **Parameter**      **Type**   **Description**
  ...
  \> planType        String     [Websocket planType](index.html#websocket-plantype), null means \'pl\'
