...
-   [Quick start](index.html#quick-start){.toc-h1 .toc-link
    ...
    -   [API Public
        ...
        -   [loanType](index.html#loantype){.toc-h3 .toc-link
            data-title="loanType"}
        -   [force](index.html#force){.toc-h3 .toc-link
            data-title="force"}
        -   [status(订单状态)](index.html#status){.toc-h3 .toc-link
            data-title="status(订单状态)"}
        -   [marginType](index.html#margintype){.toc-h3 .toc-link
            data-title="marginType"}
        -   [source](index.html#source){.toc-h3 .toc-link
            data-title="source"}
        -   [Flash repay status](index.html#flash-repay-status){.toc-h3
            .toc-link data-title="Flash repay  status"}
...
-   [RestAPI](index.html#restapi){.toc-h1 .toc-link
    ...
    -   [Public](index.html#public){.toc-h2 .toc-link
        data-title="Public"}
        -   [Get cross margin interest rate and
            borrowable](index.html#get-cross-margin-interest-rate-and-borrowable){.toc-h3
            .toc-link
            data-title="Get cross margin interest rate and borrowable"}
        -   [GET isolated margin interest rate and max borrowable
            amount](index.html#get-isolated-margin-interest-rate-and-max-borrowable-amount){.toc-h3
            .toc-link
            data-title="GET isolated margin interest rate and max borrowable amount"}
        -   [GET cross tier
            data](index.html#get-cross-tier-data){.toc-h3 .toc-link
            data-title="GET cross tier data"}
        -   [Get isolated tier
            data](index.html#get-isolated-tier-data){.toc-h3 .toc-link
            data-title="Get isolated  tier data"}
        -   [Get support
            currencies](index.html#get-support-currencies){.toc-h3
            .toc-link data-title="Get support currencies"}
    -   [account](index.html#account){.toc-h2 .toc-link
        data-title="account"}
        -   [Get Cross assets](index.html#get-cross-assets){.toc-h3
            .toc-link data-title="Get Cross assets"}
        -   [Get isolated
            assets](index.html#get-isolated-assets){.toc-h3 .toc-link
            data-title="Get isolated assets"}
        -   [cross borrow](index.html#cross-borrow){.toc-h3 .toc-link
            data-title="cross borrow"}
        -   [isolated borrow](index.html#isolated-borrow){.toc-h3
            .toc-link data-title="isolated borrow"}
        -   [cross repay](index.html#cross-repay){.toc-h3 .toc-link
            data-title="cross repay"}
        -   [isolated repay](index.html#isolated-repay){.toc-h3
            .toc-link data-title="isolated repay"}
        -   [Get cross risk
            rate](index.html#get-cross-risk-rate){.toc-h3 .toc-link
            data-title="Get cross risk rate"}
        -   [isolated riskRate](index.html#isolated-riskrate){.toc-h3
            .toc-link data-title="isolated riskRate"}
        -   [cross max borrowable
            amount](index.html#cross-max-borrowable-amount){.toc-h3
            .toc-link data-title="cross max borrowable amount"}
        -   [isolated max borrowable
            amount](index.html#isolated-max-borrowable-amount){.toc-h3
            .toc-link data-title="isolated max borrowable amount"}
        -   [Get cross max transfer out
            amount](index.html#get-cross-max-transfer-out-amount){.toc-h3
            .toc-link data-title="Get cross max transfer out amount"}
        -   [Get isolated max transfer out
            amount](index.html#get-isolated-max-transfer-out-amount){.toc-h3
            .toc-link data-title="Get isolated max transfer out amount"}
        -   [Isolated Flash
            Repay](index.html#isolated-flash-repay){.toc-h3 .toc-link
            data-title="Isolated Flash Repay"}
        -   [Query Isolated Flash Repay
            Status](index.html#query-isolated-flash-repay-status){.toc-h3
            .toc-link data-title="Query Isolated Flash Repay Status"}
        -   [Cross Flash Repay](index.html#cross-flash-repay){.toc-h3
            .toc-link data-title="Cross Flash Repay"}
        -   [Query Cross Flash Repay
            Status](index.html#query-cross-flash-repay-status){.toc-h3
            .toc-link data-title="Query Cross Flash Repay Status"}
    -   [isolated margin orders and
        trades](index.html#isolated-margin-orders-and-trades){.toc-h2
        .toc-link data-title="isolated margin orders and trades"}
        -   [isolated place
            order](index.html#isolated-place-order){.toc-h3 .toc-link
            data-title="isolated place order"}
        -   [isolated batch
            order](index.html#isolated-batch-order){.toc-h3 .toc-link
            data-title="isolated batch order"}
        -   [isolated cancel
            order](index.html#isolated-cancel-order){.toc-h3 .toc-link
            data-title="isolated cancel order"}
        -   [isolated batch cancel
            orders](index.html#isolated-batch-cancel-orders){.toc-h3
            .toc-link data-title="isolated batch cancel orders"}
        -   [isolated open
            orders](index.html#isolated-open-orders){.toc-h3 .toc-link
            data-title="isolated open orders"}
        -   [Get isolated order
            history](index.html#get-isolated-order-history){.toc-h3
            .toc-link data-title="Get isolated order history"}
        -   [Get isolated transaction
            details](index.html#get-isolated-transaction-details){.toc-h3
            .toc-link data-title="Get isolated transaction details"}
        -   [Get isolated loan
            records](index.html#get-isolated-loan-records){.toc-h3
            .toc-link data-title="Get isolated loan records"}
        -   [Get isolated repay
            history](index.html#get-isolated-repay-history){.toc-h3
            .toc-link data-title="Get isolated repay history"}
        -   [Get isolated interest
            records](index.html#get-isolated-interest-records){.toc-h3
            .toc-link data-title="Get isolated interest records"}
        -   [Get isolated liquidation
            records](index.html#get-isolated-liquidation-records){.toc-h3
            .toc-link data-title="Get isolated liquidation records"}
        -   [Get isolated finance
            history](index.html#get-isolated-finance-history){.toc-h3
            .toc-link data-title="Get isolated finance history"}
    -   [cross margin orders and
        trades](index.html#cross-margin-orders-and-trades){.toc-h2
        .toc-link data-title="cross margin orders and trades"}
        -   [cross place order](index.html#cross-place-order){.toc-h3
            .toc-link data-title="cross place order"}
        -   [cross batch order](index.html#cross-batch-order){.toc-h3
            .toc-link data-title="cross batch order"}
        -   [cross cancel order](index.html#cross-cancel-order){.toc-h3
            .toc-link data-title="cross cancel order"}
        -   [cross batch cancel
            order](index.html#cross-batch-cancel-order){.toc-h3
            .toc-link data-title="cross batch cancel order"}
        -   [Get cross open
            orders](index.html#get-cross-open-orders){.toc-h3 .toc-link
            data-title="Get cross open orders"}
        -   [Get cross order
            history](index.html#get-cross-order-history){.toc-h3
            .toc-link data-title="Get cross order history"}
        -   [Get cross order
            fills](index.html#get-cross-order-fills){.toc-h3 .toc-link
            data-title="Get cross order fills"}
        -   [Get cross loan
            records](index.html#get-cross-loan-records){.toc-h3
            .toc-link data-title="Get cross loan records"}
        -   [Get cross repay
            history](index.html#get-cross-repay-history){.toc-h3
            .toc-link data-title="Get cross repay history"}
        -   [Get cross interest
            records](index.html#get-cross-interest-records){.toc-h3
            .toc-link data-title="Get cross interest records"}
        -   [Get cross liquidation
            records](index.html#get-cross-liquidation-records){.toc-h3
            .toc-link data-title="Get cross liquidation records"}
        -   [Get cross finance flow
            history](index.html#get-cross-finance-flow-history){.toc-h3
            .toc-link data-title="Get cross finance flow history"}
-   [WebSocketAPI](index.html#websocketapi){.toc-h1 .toc-link
    ...
    -   [public](index.html#public-2){.toc-h2 .toc-link
        data-title="public"}
        -   [margin index price](index.html#margin-index-price){.toc-h3
            .toc-link data-title="margin index price"}
    -   [private](index.html#private){.toc-h2 .toc-link
        data-title="private"}
        -   [margin cross account
            assets](index.html#margin-cross-account-assets){.toc-h3
            .toc-link data-title="margin cross account assets"}
        -   [Margin isolated account
            assets](index.html#margin-isolated-account-assets){.toc-h3
            .toc-link data-title="Margin isolated account assets"}
        -   [cross orders](index.html#cross-orders){.toc-h3 .toc-link
            data-title="cross orders"}
        -   [isolate orders](index.html#isolate-orders){.toc-h3
            .toc-link data-title="isolate orders"}
...
-   New interfaces:
    -   [Isolated Flash Repay](index.html#isolated-flash-repay)
    -   [Query Isolated Flash Repay
        status](index.html#query-isolated-flash-repay-status)
    -   [Cross Flash Repay](index.html#cross-flash-repay)
    -   [Query Cross Flash Repay
        status](index.html#query-cross-flash-repay-status)
-   Search criteria changes:
    -   [Get Cross assets](index.html#get-cross-assets) \'coin\'
        required changed to false
    -   [Get isolated assets](index.html#get-isolated-assets) \'symbol\'
        required changed to false

**11/04/2023**

-   add [SDK](index.html#sdk-code-example)

**28/03/2023**

-   add public API for Spot Margin
-   add cross account, isolated account
-   add cross order, cross order history
-   add isolated order, isolated order history
-   add websocket channel: indexPrice, cross_account, isolate_account,
    cross_orders, isolate_orders
...
-   Telegram [Join](https://t.me/bitgetapi)
...
\`\`\`html User can bind IP address when he creates APIKey, It is
strongly recommended to bind IP for security reason. \`\`\`

\`\`\`Html     ** risk warning** ：These three keys are highly related
to account security, please keep in mind DO NOT DISCLOSE **Secretkey and
...
[Java](https://github.com/BitgetLimited/v3-bitget-api-sdk/tree/master/bitget-java-sdk-open-api)
\|
[Python](https://github.com/BitgetLimited/v3-bitget-api-sdk/tree/master/bitget-python-sdk-open-api)
\|
[GoLang](https://github.com/BitgetLimited/v3-bitget-api-sdk/tree/master/bitget-goland-sdk-open-api)
\|
[NodeJs](https://github.com/BitgetLimited/v3-bitget-api-sdk/tree/master/bitget-node-sdk-open-api)
\|
[PHP](https://github.com/BitgetLimited/v3-bitget-api-sdk/tree/master/bitget-php-sdk-open-api)

**PostMan Demo**

[PostMan](https://bitgetlimited.github.io/apidoc/sdk/Biget_Margin.postman_collection.json)
...
-   method = \"GET\"
-   requestPath = \"/api/margin/v1/cross/account/maxTransferOutAmount\"
...
-   Method = \"POST\"
-   requestPath = \"/api/margin/v1/cross/account/borrow\"
-   body = {\"coin\":\"USDT\",\"borrowAmount\":\"1\"}
...
the request header information needs to be standardized
as:\'application/json\'.
...
{ \"code\":\"00000\", \"msg\":\"success\", \"requestTime\":163123213132,
\"data\": \[ { \"id\":\"13423423\", \"status\":\"FINISH\"
...
**Request Parameter**
  ...
  orderType        String              Yes                         limit/market [orderType](index.html#ordertype)
  price            String               No                                             Price
  loanType         String              Yes                       Margin Order Type [loanType](index.html#loantype)
  timeInForce      String              Yes                                force [force](index.html#force)
  ...
  side             String              Yes                        Trade side: buy or sell [side](index.html#side)
...
**Response Description**
  ...
  timeInForce       [force](index.html#force)
  price             Order price
  source            [source](index.html#source)
  status            Order [status](index.html#status)
  side              Trade [side](index.html#side)
  baseQuantity      base coin quantity
  quoteAmount       quote coin amount
  orderType         [orderType](index.html#ordertype)
  cTime             Create time
  loanType          [loanType](index.html#loantype)
...
**Request Parameter**
  ...
  symbol           String              Yes                                                            Symbol
  orderId          String               No                                                           Order ID
  source           String               No                                                  [source](index.html#source)
  clientOid        String               No                                                           custom ID
...
**Response Description**
  ...
  side              [Side](index.html#side)
  feeCcy            fee currency
  orderType         [orderType](index.html#ordertype): (limit/market )
  cTime             create time, ms
  fees              fees
...
**Response Description**
  ...
  coin        Coin
  amount      loan amount
  type        [loan type](index.html#loantype), \'autoLoan\': Auto loan; \'manualLoan\': manual loan
  cTime       create time, ms
...
**Request Parameter**
  ...
  ---------------- ---------------- ---------- ------------------------------------------------------------------------------------------------------------------
  symbol           String              Yes                                                           Symbol
  marginType       String               No                                      Margin Type [marginType](index.html#margintype)
  coin             String               No                                                            Coin
  startTime        String              Yes                                                       start time, ms
  endTime          String               No                                                        end time, ms
  pageSize         String               No                                                         Page Size
...
**Response Description**
  ...
  marginId     ID
  coin         Coin
  marginType   [marginType](index.html#margintype)
  amount       amount
  fee          fee
...
**Request Parameter**
  ...
  ---------------- ---------------- ---------- --------------------------------------------------------------------------------
  symbol           String              Yes                                   Symbol, \'BTCUSDT\'
  orderType        String              Yes                      [orderType](index.html#ordertype):limit/market
  price            String               No                                          Price
  loanType         String              Yes                             [loanType](index.html#loantype)
  timeInForce      String              Yes                                [force](index.html#force)
  ...
  clientOid        String               No                                Custom id, max length: 40
  side             String              Yes                        Trade [side](index.html#side): buy or sell
...
**orderList**
  ...
  orderType        String              Yes                     [orderType](index.html#ordertype): limit/market
  price            String               No                                          Price
  loanType         String              Yes                          Margin [loanType](index.html#loantype)
  timeInForce      String              Yes                                [force](index.html#force)
  baseQuantity     String               No      limit order is required, market order and sell is required, base coin quantity
  quoteAmount      String               No                   market order and buy is required, quote coin amount
  clientOid        String               No                                Custom id, max length: 40
...
**Response Description**
  ...
  orderType         [orderType](index.html#ordertype)
  cTime             Create time, ms
  loanType          margin [loanType](index.html#loantype)
...
**Response Description**
  ...
  fillPrice         Transaction price
  fillTotalAmount   Total transaction volume
  timeInForce       force [force](index.html#force)
  price             Order price
  source            [source](index.html#source)
  status            Order [status](index.html#status)
  side              Trade [side](index.html#side)
...
**Request Parameter**
  ...
  Parameter Name   Parameter Type    Required                                                     Description
  ---------------- ---------------- ---------- ------------------------------------------------------------------------------------------------------------------
  marginType       String               No                                            [marginType](index.html#margintype)
  coin             String               No                                                            Coin
  startTime        String              Yes                                                       start time, ms
  endTime          String               No                                                        end time, ms
  pageSize         String               No                                              Page Size, default 100, max 500
...
**Response Description**
  ...
  marginId     ID
  coin         Coin
  marginType   margin type [marginType](index.html#margintype)
  amount       amount
  fee          fee
  balance      account balance
  cTime        create time
...
3.  Expect a \'pong\' as a response. If the response message is not
    received within N seconds, please raise an error or reconnect.
4.  The Websocket server accepts up to 10 messages per second. The
    message includes:
5.  PING frame
6.  Messages in JSON format, such as subscribe, unsubscribe.
7.  If the user sends more messages than the limitation, the connection
...
[IndexPrice channel](index.html#indexPrice)

etc \-- do not require log in.

`Private channels` \-- including

[Cross Account Channel](index.html#margin_index_price) [Isolate_account
Channel](index.html#isolated_account) [Cross Orders
Channel](index.html#cross_orders) [Isolate Orders
Channel](index.html#isolate_orders)
...
**Request parameters**
  ...
  \> instType   String   Yes        Instrument type`mabl`
...
**Return parameters**
  ...
  \> instType     String   No         Instrument type`mabl`
...
Whenever an account balance changes, a push is sent containing assets
that may be changed due to events that generate balance changes, as
described below.
...
-   Transfers between trading accounts (e.g., transfers from spot to
    margin accounts)
...
Subscribe order channel. There will be no data push For the first
subscription. Snapshot data will be pushed only when events such as
order placement, cancellation, or transaction are triggered.
...
**Return parameters**
  ...
  \> key               String   YES        key
  \> loanType          String   YES        loan type [loanType](index.html#loantype)
  \> orderId           String   YES        order ID
  \> orderType         String   YES        order type [orderType](index.html#ordertype)
  \> price             String   YES        order price
  \> quoteAmount       String   YES        quote amount
  \> side              String   YES        side (buy,sell) [side](index.html#side)
  \> status            String   YES        order status [status](index.html#status)
  \> symbol            String   YES        symbol ID
  \> source            String   YES        source [source](index.html#source)
  \> timeInForce       String   YES        normal [force](index.html#force)
  \> version           String   YES        version
  code                 String   NO         error code
  msg                  String   NO         error message
