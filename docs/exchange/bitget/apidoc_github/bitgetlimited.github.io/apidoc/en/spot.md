...
-   [Introduction](index.html#introduction){.toc-h1 .toc-link
    ...
    -   [Update follow-up](index.html#update-follow-up){.toc-h2
        .toc-link data-title="Update follow-up"}
...
-   [Quick start](index.html#quick-start){.toc-h1 .toc-link
    ...
    -   [Prepare to integrate](index.html#prepare-to-integrate){.toc-h2
        .toc-link data-title="Prepare to integrate"}
    ...
    -   [API domain](index.html#api-domain){.toc-h2 .toc-link
        data-title="API domain"}
    -   [API Public
        parameters](index.html#api-public-parameters){.toc-h2 .toc-link
        data-title="API Public parameters"}
        -   [side](index.html#side){.toc-h3 .toc-link data-title="side"}
        -   [orderType](index.html#ordertype){.toc-h3 .toc-link
            data-title="orderType"}
        -   [force](index.html#force){.toc-h3 .toc-link
            data-title="force"}
        -   [status](index.html#status){.toc-h3 .toc-link
            data-title="status"}
        -   [groupType](index.html#grouptype){.toc-h3 .toc-link
            data-title="groupType"}
        -   [bizType](index.html#biztype){.toc-h3 .toc-link
            data-title="bizType"}
        -   [deposit withdrawal order
            status](index.html#deposit-withdrawal-order-status){.toc-h3
            .toc-link data-title="deposit withdrawal order status"}
        -   [withdrawal type](index.html#withdrawal-type){.toc-h3
            .toc-link data-title="withdrawal type"}
        -   [triggerType](index.html#triggertype){.toc-h3 .toc-link
            data-title="triggerType"}
        -   [accountType](index.html#accounttype){.toc-h3 .toc-link
            data-title="accountType"}
        -   [Candlestick line
            timeframe](index.html#candlestick-line-timeframe){.toc-h3
            .toc-link data-title="Candlestick line timeframe"}
        -   [fromType,toType(transfer in type，transfer out
            type)](index.html#fromtype-totype-transfer-in-type-transfer-out-type){.toc-h3
            .toc-link
            data-title="fromType,toType(transfer in type，transfer out type)"}
        -   [enterPointSource](index.html#enterpointsource){.toc-h3
            .toc-link data-title="enterPointSource"}
        -   [p2pAdvertisementStatus](index.html#p2padvertisementstatus){.toc-h3
            .toc-link data-title="p2pAdvertisementStatus"}
        -   [p2pOrderStatus](index.html#p2porderstatus){.toc-h3
            .toc-link data-title="p2pOrderStatus"}
        -   [orderSource](index.html#ordersource){.toc-h3 .toc-link
            data-title="orderSource"}
        -   [noticeType](index.html#noticetype){.toc-h3 .toc-link
            data-title="noticeType"}
        -   [tax type spot](index.html#tax-type-spot){.toc-h3 .toc-link
            data-title="tax type spot"}
        -   [tax type future and
            margin](index.html#tax-type-future-and-margin){.toc-h3
            .toc-link data-title="tax type future and margin"}
        -   [tax type p2p](index.html#tax-type-p2p){.toc-h3 .toc-link
            data-title="tax type p2p"}
    ...
    -   [HMAC Signature Demo
        Code](index.html#hmac-signature-demo-code){.toc-h2 .toc-link
        data-title="HMAC Signature Demo Code"}
    -   [RSA Signature Demo
...
-   [RestAPI](index.html#restapi){.toc-h1 .toc-link
    data-title="RestAPI"}
    -   [Notice](index.html#notice){.toc-h2 .toc-link
        data-title="Notice"}
        -   [Get All Notices](index.html#get-all-notices){.toc-h3
            .toc-link data-title="Get All Notices"}
    -   [Public](index.html#public){.toc-h2 .toc-link
        data-title="Public"}
        -   [Get Server Time](index.html#get-server-time){.toc-h3
            .toc-link data-title="Get Server Time"}
        -   [Get Coin List](index.html#get-coin-list){.toc-h3 .toc-link
            data-title="Get Coin List"}
        -   [Get Symbols](index.html#get-symbols){.toc-h3 .toc-link
            data-title="Get Symbols"}
        -   [Get Single Symbol](index.html#get-single-symbol){.toc-h3
            .toc-link data-title="Get Single Symbol"}
    -   [Market](index.html#market){.toc-h2 .toc-link
        data-title="Market"}
        -   [Get Single Ticker](index.html#get-single-ticker){.toc-h3
            .toc-link data-title="Get Single Ticker"}
        -   [Get All Tickers](index.html#get-all-tickers){.toc-h3
            .toc-link data-title="Get All Tickers"}
        -   [Get Recent Trades](index.html#get-recent-trades){.toc-h3
            .toc-link data-title="Get Recent Trades"}
        -   [Get Market Trades](index.html#get-market-trades){.toc-h3
            .toc-link data-title="Get Market Trades"}
    ...
    -   [Wallet](index.html#wallet){.toc-h2 .toc-link
        data-title="Wallet"}
        -   [Transfer](index.html#transfer){.toc-h3 .toc-link
            data-title="Transfer"}
        -   [Transfer V2](index.html#transfer-v2){.toc-h3 .toc-link
            data-title="Transfer V2"}
        -   [Sub Transfer](index.html#sub-transfer){.toc-h3 .toc-link
            data-title="Sub Transfer"}
        -   [Get Coin Address](index.html#get-coin-address){.toc-h3
            .toc-link data-title="Get Coin Address"}
        -   [Withdraw](index.html#withdraw){.toc-h3 .toc-link
            data-title="Withdraw"}
        -   [Withdraw V2](index.html#withdraw-v2){.toc-h3 .toc-link
            data-title="Withdraw V2"}
        -   [Inner Withdraw](index.html#inner-withdraw){.toc-h3
            .toc-link data-title="Inner Withdraw"}
        -   [Inner Withdraw v2](index.html#inner-withdraw-v2){.toc-h3
            .toc-link data-title="Inner Withdraw v2"}
        -   [Get Withdraw list](index.html#get-withdraw-list){.toc-h3
            .toc-link data-title="Get Withdraw list"}
        -   [Get Deposit List](index.html#get-deposit-list){.toc-h3
            .toc-link data-title="Get Deposit List"}
        -   [Get User Fee Ratio](index.html#get-user-fee-ratio){.toc-h3
            .toc-link data-title="Get User Fee Ratio"}
    -   [Account](index.html#account){.toc-h2 .toc-link
        data-title="Account"}
        -   [Get ApiKey Info](index.html#get-apikey-info){.toc-h3
            .toc-link data-title="Get ApiKey Info"}
        -   [Get Account Assets](index.html#get-account-assets){.toc-h3
            .toc-link data-title="Get Account Assets"}
        -   [Get Account Assets
            Lite](index.html#get-account-assets-lite){.toc-h3 .toc-link
            data-title="Get Account Assets Lite"}
        -   [Get sub Account Spot
            Assets](index.html#get-sub-account-spot-assets){.toc-h3
            .toc-link data-title="Get sub Account Spot Assets"}
        -   [Get Bills](index.html#get-bills){.toc-h3 .toc-link
            data-title="Get Bills"}
        -   [Get Transfer List](index.html#get-transfer-list){.toc-h3
            .toc-link data-title="Get Transfer List"}
    -   [Trade](index.html#trade){.toc-h2 .toc-link data-title="Trade"}
        ...
        -   [Cancel order V2](index.html#cancel-order-v2){.toc-h3
            .toc-link data-title="Cancel order V2"}
        -   [Cancel order By
            Symbol](index.html#cancel-order-by-symbol){.toc-h3 .toc-link
            data-title="Cancel order By Symbol"}
        -   [Cancel order in batch (single
            instruments)](index.html#cancel-order-in-batch-single-instruments){.toc-h3
            .toc-link
            data-title="Cancel order in batch (single instruments)"}
        -   [Cancel order in batch V2 (single
            instruments)](index.html#cancel-order-in-batch-v2-single-instruments){.toc-h3
            .toc-link
            data-title="Cancel order in batch V2 (single instruments)"}
        -   [Get order details](index.html#get-order-details){.toc-h3
            .toc-link data-title="Get order details"}
        -   [Get order List](index.html#get-order-list){.toc-h3
            .toc-link data-title="Get order List"}
        -   [Get order history](index.html#get-order-history){.toc-h3
            .toc-link data-title="Get order history"}
        -   [Get transaction
            details](index.html#get-transaction-details){.toc-h3
            .toc-link data-title="Get transaction details"}
        ...
        -   [Cancel plan order](index.html#cancel-plan-order){.toc-h3
            .toc-link data-title="Cancel plan order"}
        -   [Get current plan
            orders](index.html#get-current-plan-orders){.toc-h3
            .toc-link data-title="Get current plan orders"}
        -   [Get history plan
            orders](index.html#get-history-plan-orders){.toc-h3
            .toc-link data-title="Get history plan orders"}
        -   [batch cancel plan
            orders](index.html#batch-cancel-plan-orders){.toc-h3
            .toc-link data-title="batch cancel plan orders"}
    -   [P2P endpoint](index.html#p2p-endpoint){.toc-h2 .toc-link
        data-title="P2P endpoint"}
        -   [P2P merchant list](index.html#p2p-merchant-list){.toc-h3
            .toc-link data-title="P2P merchant list"}
        -   [get merchant
            information](index.html#get-merchant-information){.toc-h3
            .toc-link data-title="get merchant information"}
        -   [get advertisement
            list](index.html#get-advertisement-list){.toc-h3 .toc-link
            data-title="get advertisement list"}
        -   [merchant get P2P order
            list](index.html#merchant-get-p2p-order-list){.toc-h3
            .toc-link data-title="merchant get P2P order list"}
    -   [Sub-Account
        Endpoints](index.html#sub-account-endpoints){.toc-h2 .toc-link
        data-title="Sub-Account Endpoints"}
        -   [Create Virtual Sub
            Account](index.html#create-virtual-sub-account){.toc-h3
            .toc-link data-title="Create Virtual Sub Account"}
        -   [Modify Virtual
            Account](index.html#modify-virtual-account){.toc-h3
            .toc-link data-title="Modify Virtual Account"}
        -   [Batch Create Virtual Account And
            ApiKey](index.html#batch-create-virtual-account-and-apikey){.toc-h3
            .toc-link
            data-title="Batch Create Virtual Account And ApiKey"}
        -   [Get Virtual Account
            List](index.html#get-virtual-account-list){.toc-h3 .toc-link
            data-title="Get Virtual Account List"}
        -   [Create Virtual Account
            ApiKey](index.html#create-virtual-account-apikey){.toc-h3
            .toc-link data-title="Create Virtual Account ApiKey"}
        -   [Modify Virtual Account
            ApiKey](index.html#modify-virtual-account-apikey){.toc-h3
            .toc-link data-title="Modify Virtual Account ApiKey"}
        -   [Get Virtual Sub ApiKey
            List](index.html#get-virtual-sub-apikey-list){.toc-h3
            .toc-link data-title="Get Virtual Sub  ApiKey List"}
    -   [Convert](index.html#convert){.toc-h2 .toc-link
        data-title="Convert"}
        -   [Get Convert Coins](index.html#get-convert-coins){.toc-h3
            .toc-link data-title="Get Convert Coins"}
        -   [Get Quoted Price](index.html#get-quoted-price){.toc-h3
            .toc-link data-title="Get Quoted Price"}
        -   [Convert](index.html#convert-2){.toc-h3 .toc-link
            data-title="Convert"}
        -   [Convert History](index.html#convert-history){.toc-h3
            .toc-link data-title="Convert History"}
    -   [Tax](index.html#tax){.toc-h2 .toc-link data-title="Tax"}
        -   [Spot Account
            Record](index.html#spot-account-record){.toc-h3 .toc-link
            data-title="Spot Account Record"}
        -   [Future Account
            Record](index.html#future-account-record){.toc-h3 .toc-link
            data-title="Future Account Record"}
        -   [Margin Account
            Record](index.html#margin-account-record){.toc-h3 .toc-link
            data-title="Margin Account Record"}
        -   [P2P Account Record](index.html#p2p-account-record){.toc-h3
            .toc-link data-title="P2P Account Record"}
    -   [Loans](index.html#loans){.toc-h2 .toc-link data-title="Loans"}
        -   [Query currency data
            list](index.html#query-currency-data-list){.toc-h3 .toc-link
            data-title="Query currency data list"}
        -   [Query hourly estimated interest and loan
            amount](index.html#query-hourly-estimated-interest-and-loan-amount){.toc-h3
            .toc-link
            data-title="Query hourly estimated interest and loan amount"}
        -   [Borrow coin](index.html#borrow-coin){.toc-h3 .toc-link
            data-title="Borrow coin"}
        -   [Query the list of loan
            orders](index.html#query-the-list-of-loan-orders){.toc-h3
            .toc-link data-title="Query the list of loan orders"}
        -   [Repay Loan Orders](index.html#repay-loan-orders){.toc-h3
            .toc-link data-title="Repay Loan Orders"}
        -   [Query the repayment history
            list](index.html#query-the-repayment-history-list){.toc-h3
            .toc-link data-title="Query the repayment history list"}
        -   [Adjust pledge rate](index.html#adjust-pledge-rate){.toc-h3
            .toc-link data-title="Adjust pledge rate"}
        -   [Query the historical list of adjusted pledge
            ratios](index.html#query-the-historical-list-of-adjusted-pledge-ratios){.toc-h3
            .toc-link
            data-title="Query the historical list of adjusted pledge ratios"}
        -   [Query loan history
            list](index.html#query-loan-history-list){.toc-h3 .toc-link
            data-title="Query loan history list"}
        -   [Query the list of assets and
            liabilities](index.html#query-the-list-of-assets-and-liabilities){.toc-h3
            .toc-link
            data-title="Query the list of assets and liabilities"}
        -   [Query the list of forced liquidation
            records](index.html#query-the-list-of-forced-liquidation-records){.toc-h3
            .toc-link
            data-title="Query the list of forced liquidation records"}
-   [WebSocketAPI](index.html#websocketapi){.toc-h1 .toc-link
    ...
    -   [Checksum](index.html#checksum){.toc-h2 .toc-link
        data-title="Checksum"}
        -   [Merging incremental data into full
            data](index.html#merging-incremental-data-into-full-data){.toc-h3
            .toc-link
            data-title="Merging incremental data into full data"}
    ...
    -   [Public Channels](index.html#public-channels){.toc-h2 .toc-link
        ...
        -   [Depth channel](index.html#depth-channel){.toc-h3 .toc-link
            data-title="Depth channel"}
        -   [Trades Channel](index.html#trades-channel){.toc-h3
            .toc-link data-title="Trades Channel"}
    -   [Private Channel](index.html#private-channel){.toc-h2 .toc-link
        data-title="Private Channel"}
...
-   [RestAPI  error code](index.html#restapi-error-code){.toc-h1
    .toc-link data-title="RestAPI  error code"}
-   [WebSocket error code](index.html#websocket-error-code){.toc-h1
    .toc-link data-title="WebSocket error code"}
:::
...
**ETA Sep 06, 2023** - Forecast
[/api/spot/v1/public/products](index.html#get-symbols) added response
field：`maxOrderNum`
[/api/spot/v1/public/product](index.html#get-single-symbol) added
response field：`maxOrderNum`

# Update Log

**Oct 10, 2023**

-   [Get order history](index.html#get-order-history) and [Get order
    detail](index.html#get-order-details) added new field on response:
    \'feeDetail.newFees\'

\"feeDetail\":
\"{\\\"BGB\\\":{\\\"deduction\\\":true,\\\"feeCoinCode\\\":\\\"BGB\\\",
\\\"totalDeductionFee\\\":-0.017118519726,
\\\"totalFee\\\":-0.017118519726,\\\"newFees\\\":{\\\"t\\\":1,\\\"d\\\":1,\\\"r\\\":1,\\\"c\\\":1}}}\"

-   Validation logic changes on [withdraw](index.html#get-order-history)
    and [withdraw-v2](index.html#get-order-history)
    -   There are 3 types of withdrawal address: \'Normal\',
        \'Universal\' and \'EVM address\'
    -   Change only apply to for \'Normal\' address:
    -   Old logic: Withdraw will only validate the \'address\' (withdraw
        with a wrong \'address + coin\' will fail in a later steps)
    -   New logic: Withdraw will validate the \'address + coin\'
        (withdraw with a wrong \'address + coin\' will fail right away)
...
  \"event\":\"error\",\
  \"code\":30003,\
  \"msg\":\"instType:SP,channel:ticker,instId:BTC-USDT Symbol not
exists\"\
}
...
-   New feature: [Loans](index.html#loans)
...
-   Interface [Inner Withdraw v2](index.html#inner-withdraw-v2) supports
    uid/mobile/email

**18/07/2023**

-   New interface [Convert](index.html#convert)

**06/07/2023**

-   New interface [Get All Notices](index.html#get-all-notices)

**03/07/2023**

-   New interface [Get History Candles
    Data](index.html#get-history-candles-data)

**20/06/2023**

-   New interface [Tax](index.html#tax)

**16/06/2023**

-   New interface [Get Account Assets
    Lite](index.html##get-account-assets-lite)

**20/05/2023**

-   [Get order details](index.html#get-order-detail) added response
    fields: \'feeDetail\' and `orderSource`
-   [Get order history](index.html#get-order-history) added response
    fields: \'feeDetail\' and `orderSource`

**12/05/2023**

-   New interface [Get User Fee Ratio](index.html#get-user-fee-ratio)

**21/04/2023**

-   New interface [P2P endpoint](index.html#p2p-endpoint)

**28/03/2023**

-   [Transfer](index.html#transfer) support \'Spot Margin Account\'

**17/03/2023**

-   New interface [Get Market Trades](index.html#get-market-trades)
-   New interface [Cancel order By
    Symbol](index.html#cancel-order-by-symbol)

**15/03/2023**

-   [Get Symbols](index.html#get-symbols) and [Get Single
    Symbol](index.html#get-single-symbol) added response fields:
    \'buyLimitPriceRatio\', \'sellLimitPriceRatio\'
-   [Get Candle Data](index.html#get-candle-data) request field
    \'limit\': max 1000
-   New interface [Transfer V2](index.html#transfer-v2), [Withdraw
    V2](index.html#withdraw-v2), [Inner Withdraw
    v2](index.html#inner-withdraw-v2) to support \'clientOid\'
-   [Get Withdraw list](index.html#get-withdraw-list) added request
    field: \'clientOid\', added response fields: \'clientOid\', \'tag\'
-   [Get Deposit list](index.html#get-deposit-list) added response
    fields: \'tag\'
-   [Get Transfer List](index.html#get-transfer-list) added response
    fields: \'clientOid\', \'transferId\', added request param:
    \'clientOid\'
-   New interface [Cancel order V2](index.html#cancel-order-v2) cancel
    by \'clientOid\'
-   New interface [Cancel order in batch V2 (single
    instruments)](index.html#cancel-order-in-batch-single-instruments)
    cancel by \'clientOids\'
-   [Get order details](index.html#get-order-details), [Get order
    List](index.html#get-order-list), [Get order
    history](index.html#get-order-history) added response fields:
    \'enterPointSource\'
-   [Get Symbols](index.html#modify-plan-order) added request fields:
    \'clientOid\'
-   [Cancel plan order](index.html#cancel-plan-order) added request
    fields: \'clientOid\'
-   [Get current plan orders](index.html#get-current-plan-orders) [Get
    history plan orders](index.html#get-history-plan-orders) added
    request/response fields: \'clientOid\', added response fields:
    \'enterPointSource\'
-   [Order Channel](index.html#order-channel) push data added field:
    \'eps\'
-   [WebSocket error codes](index.html#websocket-error-codes) added new
    error code

**13/02/2023**

-   RestAPI -\> Market -\> added [VIP fee rate](index.html#vip-fee-rate)
-   RestAPI -\> Account -\> [Get Bills](index.html#get-bills) modify
    param \'coinId\' to non-required
...
-   RestAPI -\> Account -\> added [Get sub Account Spot
    Assets](index.html#get-sub-account-spot-assets)
-   RestAPI -\> Public -\> added [Get Coin
    List](index.html#get-coin-list) rateLimit updated to 3/s(IP)
-   RestAPI -\> Public -\> added [Get Single
    Ticker](index.html#get-single-ticker) add response parameter:
    \'bidSz\', \'askSz\'
...
-   RestAPI -\> Trade -\> added
    -   [Place plan order](index.html#place-plan-order)
    -   [Modify plan order](index.html#modify-plan-order)
    -   [Cancel plan order](index.html#cancel-plan-order)
    -   [Get current plan orders](index.html#get-current-plan-orders)
    -   [Get history plan orders](index.html#get-history-plan-orders)

**18/10/2022**

-   `Wallet` -\> add [Sub Transfer](index.html#sub-transfer)
...
-   `Market` -\> `Get All Tickers` , `Get Single Ticker` add response
    `openUtc0`
...
This document is the only official document of Bitget API. The
capabilities provided by Bitget API will be continuously updated here.
Please pay attention to it in time.

You can switch to access different business APIs by clicking the upper
menu, and you can switch the document language by clicking the language
button on the upper right.

On the right side of the document is an example of request parameters
and response results.

## Update follow-up

Regarding API additions, updates, and offline information, Bitget will
issue announcements in advance. It is recommended that users follow and
subscribe to our announcements to obtain relevant information in a
timely manner.

You can click
[here](https://bitget.zendesk.com/hc/en-us/categories/360002621832-Latest-Announcements)
to subscribe to the announcement.
...
page](https://www.bitget.com), then apply the API key and complete the
permission configuration, and then develop and trade according to the
details of this document.

You can click [here](https://www.bitget.com/en/account/newapi) to create
the API Key after login.
...
-   `APIKey` The identity of API transactions, it is generated by a
    random algorithm.
-   `Secretkey` The private key is randomly generated by the system and
    used for [Signature](index.html#signature) generation.
-   `Passphrase` Passphrase is set by the user. It should be noted that
    if the Passphrase is forgotten, it cannot be retrieved, and the API
    Key needs to be recreated.

User can bind IP address when he creates APIKey, It is strongly
recommended to bind IP for security reason.

**risk warning：**\
These three keys are highly related to account security, please keep in
mind DO NOT DISCLOSE **Secretkey and Passphrase** to anyone at any
circumstances, even with BitGet employees.\
Leaking any of these three keys may cause loss of your assets. If you
find by any chance that the APIKey is compromised, please delete the
APIKey as soon as possible.
...
\| [Node Js](https://www.npmjs.com/package/bitget-api) \|
...
[PostMan](https://bitgetlimited.github.io/apidoc/sdk/Biget_Spot.postman_collection.json)

You should first try to config the APIKey, Secretkey and Passphrase in
the `Environments` tab on left of the PostMan

## Interface Type

This chapter is consist of the following two aspects for the interface
types:
...
market data. Public requests can be called without authentication.

**Private interface**

The private interface can be used for order management and account
management. Every private request must be
[Signatured](index.html#signature).

The private interface will be verified from server side with your
APIKey.
...
-   Rest API when the access exceeds the frequency limit, it will return
    the 429 status: the request is too frequent.

**Rest API**

If a valid APIKey is passed with the request, We will use APIKey to
limit the frequency; if not, the public IP Address will be used to limit
the frequency.

Frequency limit rules: There are separate instructions on each
interface. If there is no specific instruction, the frequency limit of
general interface is 10 times per second.

Special note: When place orders in batches, 10 orders per currency pair
will be counted as one request. For example, a batch order like: 1 order
with ETHUSDT, 10 order with BTCUSDT, then the rate-limit will count this
batch order as 2 requests.
...
### fromType,toType(transfer in type，transfer out type) {#fromtype-totype-transfer-in-type-transfer-out-type}
...
-   ACCESS-TIMESTAMP： The timestamp of your request. Value equals to
...
-   locale: Support multiple languages, such as: Chinese (zh-CN),
    English (en-US)
...
The request header of ACCESS-SIGN is obtained by encrypting
**timestamp + method.toUpperCase() + requestPath + \"?\" + queryString +
body \*\*string (+ means string concat) encrypt by \*\*HMAC SHA256
\*\*algorithm, and encode the encrypted result through \*\*BASE64**.
...
-   queryString：The query string in the request URL (the request
    parameter after the ?).
-   body： The string corresponding to the request body. If the request
    has no body (usually a GET request), the body can be omitted.
...
-   body =
    {\"symbol\":\"btcusdt_spbl\",\"quantity\":\"8\",\"side\":\"buy\",\"price\":\"1\",\"orderType\":\"limit\",\"clientOrderId\":\"bitget#123456\"}
...
For more demo code on other languages, please refer to [SDK/Code
Example](index.html#sdk-code-example)
...
the POST request header information needs to be standardized
as:\'application/json\'.
...
-   Server response: the server first performs parameter security
    verification on the user\'s requested data, and then returns the
    response data to the user in JSON format according to the business
    logic after passing the verification.
...
-   429 Too Many Requests - Requests are too frequent and are limited by
    the system
...
The unit of ACCESS-TIMESTAMP in the request signature is milliseconds.
The timestamp of the request must be within 30 seconds of the API
service time, otherwise the request will be considered expired and
rejected. If there is a large deviation between the local server time
and the API server time, we recommend that you update the timestamp by
query and compare the time difference between [API server
time](index.html#get-server-time) and the time in your code.

**Frequency limiting rules**

If the request is too frequent, the system will automatically limit the
request and return the "429 too many requests" status code in the http
header.

· Public interface: For the [market](index.html#market) information
interfaces, the global rate limit is 2 seconds with max. 20 requests.

· Authorization interface: restrict the call of the authorization
interface through apikey, refer to the [frequency
limitation](index.html#07-1-2022) rule of each interface for frequency
limitation.
...
**Response Parameter**
  ...
  takerFeeRate          Default taker transaction fee rate, could be overwritten by [personal fee rate](index.html#get-user-fee-ratio)
  makerFeeRate          Default maker transaction fee rate, could be overwritten by [personal fee rate](index.html#get-user-fee-ratio)
...
**Response Parameter**
  ...
  minTradeAmount        Min. trading amount
  maxTradeAmount        Max. trading amount
  takerFeeRate          Taker transaction fee rate, could be overwritten by [personal fee rate](index.html#get-user-fee-ratio)
  makerFeeRate          Maker transaction fee rate, could be overwritten by [personal fee rate](index.html#get-user-fee-ratio)
  priceScale            Pricing scale
  quantityScale         Quantity scale
  status                Status
  minTradeUSDT          Min trade USDT amount
...
**请求参数**
  ...
  ----------------- ----------------- ----------------- ------------------------------
  symbol            String                   Yes                      \
                                                            Trading pair name, for
                                                            example: BTCUSDT_SPBL

  precision         String                   No          Price accuracy, according to
                                                         the selected accuracy as the
                                                           step size to return the
                                                        cumulative depth, enumeration
                                                                    value:
                                                         scale0/scale1/scale2/scale3,
                                                          scale0 is not merged, the
                                                          default value, in general,
                                                        scale1 is the merged depth of
                                                            the transaction pair's
                                                           quotation accuracy\*10,
                                                        generally In this case, scale2
                                                          is the quotation precision
                                                        \*100, scale3 is the quotation
                                                          precision \*1000, and the
                                                          precision corresponding to
                                                          0/1/2/3 is subject to the
                                                           actual return parameter
                                                           \"scale\". The quotation
                                                        precision of each trading pair
                                                            is different, and some
                                                         currencies The pair does not
                                                         have scale2, and the request
                                                          for a scale that does not
                                                         exist for the currency pair
                                                        will be processed according to
                                                        the maximum scale. Example: A
                                                        certain trading pair only has
                                                        scale 0/1, and when scale2 is
                                                            requested, it will be
                                                           automatically reduced to
                                                                   scale1.

  limit             String                   No         Fixed gear enumeration value:
                                                          1/5/15/50/max, the default
                                                         gear is 100. When the actual
                                                        depth does not meet the limit,
                                                        it will be returned according
                                                        to the actual gear. Passing in
                                                         max will return the maximum
                                                          gear of the trading pair.
  ------------------------------------------------------------------------------------
...
2). Transfer between fromUserId and toUserId should have direct/brother
relationship

3). Note the risk may increase when transfer out from account with cross
margin mode
...
Withdraw money directly in the form of uid, without going on the chain,
...
-   status
    ...
    -   recharge_fail_risk_wait_to_system risk control failed, to be
        system recharge
...
**Request parameter**
  ...
  groupType        String           No         Transaction group type [groupType](index.html#grouptype)
  bizType          String           No         Business type [bizType](index.html#biztype)
...
**Response Parameter**
  ...
  toType       Transfer in account type [accountType](index.html#accounttype)
  toSymbol     Transfer to account Symbol
  fromType     Transfer out account type [accountType](index.html#accounttype)
...
**Request Body**
  ...
  force            String           Yes        [force](index.html#force)
...
-   orderList
  ...
  orderType        String              Yes              Order type limit/market
  force            String              Yes        order time [force](index.html#force)
...
User could query cancelled/filled order details within 24 hours; Noted
that after 24 hours should query via
[history](index.html#get-order-history) interface
...
**Response Parameter**
  ...
  status                 [Order status](index.html#status)
...
**Request Parameter**
  ...
  status           String               no                              [advertisement status](index.html#p2padvertisementstatus)
...
**Response Description**
  ...
  \> status                    [advertisement status](index.html#p2padvertisementstatus)
...
**Request Parameter**
  ...
  status           String               No                                    [p2p order status](index.html#p2porderstatus)
...
**Response Description**
  ...
  \> status            [p2p order status](index.html#p2porderstatus)
...
-   The endpoints documented in this section are for Main-Account, and
    **only allowed to create/modify virtual sub-accounts**
...
This interface can create a virtual sub-account and a sub-account apikey
together. The created virtual sub-account has contract and spot
...
Get the quote price and request the convert interface within 8 seconds,
and it cannot be converted if it expires

Get a quote of the toCoin amount when the fromCoin amount is consumed

Get a quote of the consumed amount of fromCoin when getting the amount
of toCoin
...
**Response Description**
  ...
  coin        coin name
  type        [biz type spot](index.html#tax-type-spot)
...
**Response Description**
  ...
  id          record id lastEndId
  coin        Coin name
  type        [biz type future](index.html#tax-type-future-and-margin)
  amount      account change
  fee         fee
  timestamp   record create time (timestamp ms)
...
**Response Description**
  ...
  id          record id lastEndId
  coin        coin name
  type        [biz type margin](index.html#tax-type-future-and-margin)
  amount      Account change
  fee         fee
  total       account total
  timestamp   record create time (timestamp ms)
...
**Response Description**
  ...
  id          record id lastEndId
  coin        coin name
  type        [biz type p2p](index.html#tax-type-p2p)
  total       account total
  timestamp   record create time (timestamp ms)
...
When subscribing to a private channel, MUST [login](index.html#login)
before subscribe to any channel(s)

**Subscription limit**: 240 times per hour

If there's a network problem, the system will automatically close the
connection.

The connection will be closed automatically if the subscription is not
established or, no data pushed from server for more than 30 seconds.

Client should keep ping the server in every 30 seconds. Server will
close the connections which has no ping over 120 seconds(even when the
client is still receiving data from the server)
...
5.  If the user sends more messages than the limitation, the connection
    will be disconnected. IPs that are repeatedly disconnected may be
...
**api_key**: Unique identification for invoking API. Requires user to
apply one manually.
...
to query the [server time](index.html#get-server-time)(noted it return
milliseconds, while in websocket login you should use seconds) and then
set the timestamp.

For the description of the signature method, refer to the verification
section in the API overview
...
WebSocket channels are divided into two categories: `public` and
`private` channels.
...
[Depth channel](index.html#depth-channel)

[Trades Channel](index.html#trades-channel)

etc \-- do not require log in.

-   `instId` refer to [Get Symbols](index.html#get-symbols) in response
    field: `symbolName`

`Private channels` \-- including

[Account Channel](index.html#account-channel)

[Order Channel](index.html#order-channel)

etc \-- require [login](index.html#login).

-   User account channel `instId` is `default` : Get all currency assets

User can choose to subscribe to one or more channels, and the total
...
**Request parameters**
  ...
  \> instType   String   No         Instrument type`SP`: Spot public channel `SPBL` Spot private channel
  \> channel    String   Yes        Channel name, please refer to each examples below
  \> instId     String   No         refer to [Get Symbols](index.html#get-symbols) in response field: `symbolName`; at some cases \'default\'
...
**Request parameters**
  ...
  \> instType   String   Yes        Instrument type`SP`: Spot public channel `SPBL` Spot private channel
  \> channel    String   Yes        Channel name, please refer to each examples below
  \> instId     String   Yes        refer to [Get Symbols](index.html#get-symbols) in response field: `symbolName`; at some cases \'default\'
...
After subscribing to the incremental push channel (such as `books` 400
levels) of Order Book Channel, users first receive the initial snapshot
of the market depth. Afterwards the incremental data is subsequently
received, you are responsible to update the snapshot locally.

1.  If there is a same price, compare the amount. If the amount is 0,
    delete this depth data. If the amount changes, replace the original
    data.
2.  If there is no same price, sort by price (**bids** in descending
    order, **asks** in ascending order), and insert the depth
    information into the local snapshot.

### Calculate Checksum

Use the first 25 bids and asks in the local snapshot to build a string
(where a **colon** connects the price and amount in an ask or a bid),
and then calculate the CRC32 value (32-bit signed integer).
...
Retrieve the last traded price, bid price, ask price and 24-hour trading
volume of the instruments. Data will be pushed every 200 ms.
...
**Request parameters**
  ...
  \> instType   String   Yes        Instrument type`SP`: Spot public channel; `MC`: Contract/future channel
  \> channel    String   Yes        Channel name, `ticker`
  \> instId     String   Yes        Instrument ID, refer to [Get Symbols](index.html#get-symbols) in response field: `symbolName`, a sample value could be like `BTCUSDT`
...
incrementally later, that is, if there is a change in depth, the depth
data that has changed will be pushed
...
channel books5 return 5 bids and 5 asks, bids return from index 15 to
19(index 19 is bid1), asks return from index 0 to index 4

channel books15 return 15 bids index from 5 to 19(index 19 is bid1), and
return 12 asks index from 0 to 11
...
**Push data parameters**
  ...
  **Parameter**   **Type**   Description
  ...
  \> checksum     Integer    [Checksum](index.html#checksum), calculate and compare the checksum, re-subscribe if mis-match

**An example of the array of asks and bids values: \[\"411.8\", \"10\"\]
\"411.8\" is the depth price, \"10\" is the size**

### Trades Channel

Retrieve the recent trading data. Data will be pushed whenever there is
a trade.
...
Subscribe account information. Data will be pushed when triggered by
events such as placing/canceling order, and will also be pushed when
transfer in/out or withdraw/deposit.
...
**Push data parameters**
  ...
  \> force        String   Category`normal``twap``adl``full_liquidation``partial_liquidation`
