# FAQ &mdash; Python Binance 0.2.0 documentation

> **Source:** https://python-binance.readthedocs.io/en/latest/faqs.html
...
Check that your system time is in sync. See [this issue] for some sample code to check the difference between your local
...
See the Logging section in the [Getting Started guide] for more details.
[ Previous]
[Next ]
---
