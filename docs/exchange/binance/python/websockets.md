# Websockets &mdash; Python Binance 0.2.0 documentation
...
ThreadedWebsocketManager takes similar parameters to the [Client] class as it
...
Valid depth values are 5, 10 and 20 and [defined as enums].
```python
# depth diff response
...
Valid interval values are [defined as enums].
```python
