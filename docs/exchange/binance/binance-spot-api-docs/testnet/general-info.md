...
<!doctype html>
<html lang="en" dir="ltr" class="docs-wrapper plugin-docs plugin-id-default docs-version-current docs-doc-page docs-doc-id-binance-spot-api-docs/testnet/general-info" data-has-hydrated="false">
<head>
<meta charset="UTF-8">
<meta name="generator" content="Docusaurus v3.4.0">
<title data-rh="true">General Info | Binance Open Platform</title><meta data-rh="true" name="viewport" content="width=device-width,initial-scale=1"><meta data-rh="true" name="twitter:card" content="summary_large_image"><meta data-rh="true" property="og:url" content="https://developers.binance.com/docs/binance-spot-api-docs/testnet/general-info"><meta data-rh="true" property="og:locale" content="en"><meta data-rh="true" property="og:locale:alternate" content="zh_CN"><meta data-rh="true" name="docusaurus_locale" content="en"><meta data-rh="true" name="docsearch:language" content="en"><meta data-rh="true" name="docusaurus_version" content="current"><meta data-rh="true" name="docusaurus_tag" content="docs-default-current"><meta data-rh="true" name="docsearch:version" content="current"><meta data-rh="true" name="docsearch:docusaurus_tag" content="docs-default-current"><meta data-rh="true" property="og:title" content="General Info | Binance Open Platform"><meta data-rh="true" name="description" content="How can I use the Spot Test Network?"><meta data-rh="true" property="og:description" content="How can I use the Spot Test Network?"><link data-rh="true" rel="icon" href="/docs/img/favicon.png"><link data-rh="true" rel="canonical" href="https://developers.binance.com/docs/binance-spot-api-docs/testnet/general-info"><link data-rh="true" rel="alternate" href="https://developers.binance.com/docs/binance-spot-api-docs/testnet/general-info" hreflang="en"><link data-rh="true" rel="alternate" href="https://developers.binance.com/docs/zh-CN/binance-spot-api-docs/testnet/general-info" hreflang="zh-CN"><link data-rh="true" rel="alternate" href="https://developers.binance.com/docs/binance-spot-api-docs/testnet/general-info" hreflang="x-default"><link data-rh="true" rel="preconnect" href="https://9I0UZOBSWT-dsn.algolia.net" crossorigin="anonymous"><link rel="preconnect" href="https://www.googletagmanager.com">
...
<p></p>
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-supported-endpoints">
        Can I use the <code>/sapi</code> endpoints on the Spot Test Network?
<a class="hash-link" aria-label="Direct link to faq-supported-endpoints" title="Direct link to faq-supported-endpoints" href="/docs/binance-spot-api-docs/testnet/general-info#faq-supported-endpoints">​</a></h3>
<p>
        No, only the <code>/api</code> endpoints are available on the Spot Test Network:
    </p><ul>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/rest-api/market-data-endpoints" target="_blank" rel="noopener noreferrer">Market Data Endpoints (REST API)</a></li>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/websocket-api/market-data-requests" target="_blank" rel="noopener noreferrer">Market Data Requests (WebSocket API)</a></li>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams" target="_blank" rel="noopener noreferrer">Websocket Market Streams</a></li>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/rest-api/trading-endpoints" target="_blank" rel="noopener noreferrer">Trading Endpoints (REST API)</a></li>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/rest-api/account-endpoints" target="_blank" rel="noopener noreferrer">Account Endpoints (REST API)</a></li>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/websocket-api/trading-requests" target="_blank" rel="noopener noreferrer">Trading Requests (WebSocket API)</a></li>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/websocket-api/account-requests" target="_blank" rel="noopener noreferrer">Account Requests (WebSocket API)</a></li>
            <li><a href="https://developers.binance.com/docs/binance-spot-api-docs/user-data-stream" target="_blank" rel="noopener noreferrer">User Data Streams</a></li>
        </ul>
<p></p>
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-funds-transfer">
        How to get funds in/out of the Spot Test Network?
<a class="hash-link" aria-label="Direct link to 
        How to get funds in/out of the Spot Test Network?
" title="Direct link to 
        How to get funds in/out of the Spot Test Network?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-funds-transfer">​</a></h3>
<p>
...
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-restrictions">
        What are the restrictions on the Spot Test Network?
<a class="hash-link" aria-label="Direct link to 
        What are the restrictions on the Spot Test Network?
" title="Direct link to 
        What are the restrictions on the Spot Test Network?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-restrictions">​</a></h3>
<p>
...
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-periodic-reset">
        All my data has disappeared! What happened?
<a class="hash-link" aria-label="Direct link to 
        All my data has disappeared! What happened?
" title="Direct link to 
        All my data has disappeared! What happened?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-periodic-reset">​</a></h3>
<p>
...
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="ui-klines">
        What is the difference between <code>klines</code> and <code>uiKlines</code>?
<a class="hash-link" aria-label="Direct link to ui-klines" title="Direct link to ui-klines" href="/docs/binance-spot-api-docs/testnet/general-info#ui-klines">​</a></h3>
<p>
        On the Spot Test Network, these 2 requests always return the same data.
</p>
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-rsa-keys">
        What are RSA API Keys?
<a class="hash-link" aria-label="Direct link to 
        What are RSA API Keys?
" title="Direct link to 
        What are RSA API Keys?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-rsa-keys">​</a></h3>
<p>
...
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-rsa-types">
        What type of RSA keys are supported?
<a class="hash-link" aria-label="Direct link to 
        What type of RSA keys are supported?
" title="Direct link to 
        What type of RSA keys are supported?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-rsa-types">​</a></h3>
<p>
...
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-rsa-how-to">
        How can I use RSA API Keys?
<a class="hash-link" aria-label="Direct link to 
        How can I use RSA API Keys?
" title="Direct link to 
        How can I use RSA API Keys?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-rsa-how-to">​</a></h3>
<p>
...
<div class="codeBlockContainer_zbXh theme-code-block" style="--prism-color:#393A34;--prism-background-color:#f6f8fa"><div class="codeBlockContent_RFcP"><pre tabindex="0" class="prism-code language-text codeBlock_hldk thin-scrollbar" style="color:#393A34;background-color:#f6f8fa"><code class="codeBlockLines_aHhF"><span class="token-line" style="color:#393A34"><span class="token plain">-----BEGIN PUBLIC KEY-----</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">bL4DUXwR3ijFSXzcecQtVFU1zVWcSQd0Meztl3DLX42l/8EALJx3LSz9YKS0PMQW</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">MIICIjANBgkqhkiG9w0BAQEFAAOCAg8AMIICCgKCAgEAv9ij99RAJM4JLl8Rg47b</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">dJXMrv84WL1OK/gid4hCnxo083LYLXUpIqMmL+O6fmXAvsvkyMyT520Cw0ZNCrUk</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">WoCjGE4JZZGF4wOkWdF37JFWbDnE/GF5mAykKj+OMaECBlZ207KleQqgVzHjKuCb</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">hPMuBVVD3IhjBfIc7EEM438LbtayMDx4dviPWwm127jwn8qd9H3kv5JBoDfsdYMB</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">3k39r724CljqlAfX33GpbV2LvEkL6Da3OFk+grfN98X2pCBRz5+1N95I2cRD7o+j</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">wtCr+65E+Gqjo4OI60F9Gq5GDcrnudnUw13a4zwlU6W+Cy8gJ4R0CcKTc4+VhYVX</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">5wW2tzLVnDqvjIN8hjhgtmUv8hr19Wn+42ev+5sNtO5QAS6sJMJG5D+cpxCNhei1</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">Xm+1zXliaA1fvVYRqon2MdHcedFeAjzVtX38+Xweytowydcq2V/9pUUNZIzUqX7t</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">Zr3F+Ao3QOb/CuWbUBpUcbXfGv7AI1ozP8LRByyu6O8Z1dZNdkdjWVt83maUrIJH</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">jjc7jlZY9JbH6EyYV5TenjJaupvdlx72vA7Fcgevx87seog2JALAJqZQNT+t9/tm</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">rTUSEp3t4aINKUC1QC0CYKECAwEAAQ==</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">-----END PUBLIC KEY-----</span><br></span></code></pre><div class="buttonGroup_oDVH"><button type="button" aria-label="Copy code to clipboard" title="Copy" class="clean-btn"><span class="copyButtonIcons_hTZm" aria-hidden="true"><svg viewBox="0 0 24 24" class="copyButtonIcon_xA0c"><path fill="currentColor" d="M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z"></path></svg><svg viewBox="0 0 24 24" class="copyButtonSuccessIcon_ZIiU"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z"></path></svg></span></button></div></div></div>
<p>
        Step 3:
...
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-ed25519-vs-rsa">
        Why use Ed25519 instead of RSA API keys?
<a class="hash-link" aria-label="Direct link to 
        Why use Ed25519 instead of RSA API keys?
" title="Direct link to 
        Why use Ed25519 instead of RSA API keys?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-ed25519-vs-rsa">​</a></h3>
<p>
...
<hr>
<h3 class="anchor anchorWithStickyNavbar_fMI7" id="faq-ed25519-how-to">
        How can I use Ed25519 API keys?
<a class="hash-link" aria-label="Direct link to 
        How can I use Ed25519 API keys?
" title="Direct link to 
        How can I use Ed25519 API keys?
" href="/docs/binance-spot-api-docs/testnet/general-info#faq-ed25519-how-to">​</a></h3>
<p>
        Step 1: Generate the private key <code>test-prv-key.pem</code>.
        <strong>Do not share this file with anyone!</strong>
</p>
...
<div class="codeBlockContainer_zbXh theme-code-block" style="--prism-color:#393A34;--prism-background-color:#f6f8fa"><div class="codeBlockContent_RFcP"><pre tabindex="0" class="prism-code language-text codeBlock_hldk thin-scrollbar" style="color:#393A34;background-color:#f6f8fa"><code class="codeBlockLines_aHhF"><span class="token-line" style="color:#393A34"><span class="token plain">-----BEGIN PUBLIC KEY-----</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">MCowBQYDK2VwAyEACeCSz7VJkh3Bb+NF794hLMU8fLB9Zr+/tGMdVKCC2eo=</span><br></span><span class="token-line" style="color:#393A34"><span class="token plain">-----END PUBLIC KEY-----</span><br></span></code></pre><div class="buttonGroup_oDVH"><button type="button" aria-label="Copy code to clipboard" title="Copy" class="clean-btn"><span class="copyButtonIcons_hTZm" aria-hidden="true"><svg viewBox="0 0 24 24" class="copyButtonIcon_xA0c"><path fill="currentColor" d="M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z"></path></svg><svg viewBox="0 0 24 24" class="copyButtonSuccessIcon_ZIiU"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z"></path></svg></span></button></div></div></div>
<p>
        Step 3:
        Register your public key
        on the Spot Test Network.
