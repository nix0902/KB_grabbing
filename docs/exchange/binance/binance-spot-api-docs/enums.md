...
<!doctype html>
<html lang="en" dir="ltr" class="docs-wrapper plugin-docs plugin-id-default docs-version-current docs-doc-page docs-doc-id-binance-spot-api-docs/enums" data-has-hydrated="false">
<head>
<meta charset="UTF-8">
<meta name="generator" content="Docusaurus v3.4.0">
<title data-rh="true">Enums | Binance Open Platform</title><meta data-rh="true" name="viewport" content="width=device-width,initial-scale=1"><meta data-rh="true" name="twitter:card" content="summary_large_image"><meta data-rh="true" property="og:url" content="https://developers.binance.com/docs/binance-spot-api-docs/enums"><meta data-rh="true" property="og:locale" content="en"><meta data-rh="true" property="og:locale:alternate" content="zh_CN"><meta data-rh="true" name="docusaurus_locale" content="en"><meta data-rh="true" name="docsearch:language" content="en"><meta data-rh="true" name="docusaurus_version" content="current"><meta data-rh="true" name="docusaurus_tag" content="docs-default-current"><meta data-rh="true" name="docsearch:version" content="current"><meta data-rh="true" name="docsearch:docusaurus_tag" content="docs-default-current"><meta data-rh="true" property="og:title" content="Enums | Binance Open Platform"><meta data-rh="true" name="description" content="This will apply for both REST API and WebSocket API."><meta data-rh="true" property="og:description" content="This will apply for both REST API and WebSocket API."><link data-rh="true" rel="icon" href="/docs/img/favicon.png"><link data-rh="true" rel="canonical" href="https://developers.binance.com/docs/binance-spot-api-docs/enums"><link data-rh="true" rel="alternate" href="https://developers.binance.com/docs/binance-spot-api-docs/enums" hreflang="en"><link data-rh="true" rel="alternate" href="https://developers.binance.com/docs/zh-CN/binance-spot-api-docs/enums" hreflang="zh-CN"><link data-rh="true" rel="alternate" href="https://developers.binance.com/docs/binance-spot-api-docs/enums" hreflang="x-default"><link data-rh="true" rel="preconnect" href="https://9I0UZOBSWT-dsn.algolia.net" crossorigin="anonymous"><link rel="preconnect" href="https://www.googletagmanager.com">
...
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="account-and-symbol-permissions-permissions">Account and Symbol Permissions (permissions)<a class="hash-link" aria-label="Direct link to Account and Symbol Permissions (permissions)" title="Direct link to Account and Symbol Permissions (permissions)" href="/docs/binance-spot-api-docs/enums#account-and-symbol-permissions-permissions">​</a></h2>
<ul>
<li><code>SPOT</code></li>
<li><code>MARGIN</code></li>
<li><code>LEVERAGED</code></li>
<li><code>TRD_GRP_002</code></li>
<li><code>TRD_GRP_003</code></li>
<li><code>TRD_GRP_004</code></li>
<li><code>TRD_GRP_005</code></li>
<li><code>TRD_GRP_006</code></li>
<li><code>TRD_GRP_007</code></li>
<li><code>TRD_GRP_008</code></li>
<li><code>TRD_GRP_009</code></li>
<li><code>TRD_GRP_010</code></li>
<li><code>TRD_GRP_011</code></li>
<li><code>TRD_GRP_012</code></li>
<li><code>TRD_GRP_013</code></li>
<li><code>TRD_GRP_014</code></li>
<li><code>TRD_GRP_015</code></li>
<li><code>TRD_GRP_016</code></li>
<li><code>TRD_GRP_017</code></li>
<li><code>TRD_GRP_018</code></li>
<li><code>TRD_GRP_019</code></li>
<li><code>TRD_GRP_020</code></li>
<li><code>TRD_GRP_021</code></li>
<li><code>TRD_GRP_022</code></li>
<li><code>TRD_GRP_023</code></li>
<li><code>TRD_GRP_024</code></li>
<li><code>TRD_GRP_025</code></li>
</ul>
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="order-status-status">Order status (status)<a class="hash-link" aria-label="Direct link to Order status (status)" title="Direct link to Order status (status)" href="/docs/binance-spot-api-docs/enums#order-status-status">​</a></h2>
...
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="order-list-status-liststatustype">Order List Status (listStatusType)<a class="hash-link" aria-label="Direct link to Order List Status (listStatusType)" title="Direct link to Order List Status (listStatusType)" href="/docs/binance-spot-api-docs/enums#order-list-status-liststatustype">​</a></h2>
...
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="order-list-order-status-listorderstatus">Order List Order Status (listOrderStatus)<a class="hash-link" aria-label="Direct link to Order List Order Status (listOrderStatus)" title="Direct link to Order List Order Status (listOrderStatus)" href="/docs/binance-spot-api-docs/enums#order-list-order-status-listorderstatus">​</a></h2>
...
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="contingencytype">ContingencyType<a class="hash-link" aria-label="Direct link to ContingencyType" title="Direct link to ContingencyType" href="/docs/binance-spot-api-docs/enums#contingencytype">​</a></h2>
<ul>
<li><code>OCO</code></li>
<li><code>OTO</code></li>
</ul>
<p><a id="allocationtype"></a></p>
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="allocationtype">AllocationType<a class="hash-link" aria-label="Direct link to AllocationType" title="Direct link to AllocationType" href="/docs/binance-spot-api-docs/enums#allocationtype">​</a></h2>
<ul>
<li><code>SOR</code></li>
</ul>
<p><a id="ordertypes"></a></p>
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="order-types-ordertypes-type">Order types (orderTypes, type)<a class="hash-link" aria-label="Direct link to Order types (orderTypes, type)" title="Direct link to Order types (orderTypes, type)" href="/docs/binance-spot-api-docs/enums#order-types-ordertypes-type">​</a></h2>
<ul>
...
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="order-response-type-neworderresptype">Order Response Type (newOrderRespType)<a class="hash-link" aria-label="Direct link to Order Response Type (newOrderRespType)" title="Direct link to Order Response Type (newOrderRespType)" href="/docs/binance-spot-api-docs/enums#order-response-type-neworderresptype">​</a></h2>
<ul>
<li><code>ACK</code></li>
<li><code>RESULT</code></li>
<li><code>FULL</code></li>
</ul>
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="working-floor">Working Floor<a class="hash-link" aria-label="Direct link to Working Floor" title="Direct link to Working Floor" href="/docs/binance-spot-api-docs/enums#working-floor">​</a></h2>
<ul>
<li><code>EXCHANGE</code></li>
<li><code>SOR</code></li>
</ul>
<p><a id="side"></a></p>
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="order-side-side">Order side (side)<a class="hash-link" aria-label="Direct link to Order side (side)" title="Direct link to Order side (side)" href="/docs/binance-spot-api-docs/enums#order-side-side">​</a></h2>
<ul>
<li><code>BUY</code></li>
<li><code>SELL</code></li>
</ul>
<p><a id="timeinforce"></a></p>
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="time-in-force-timeinforce">Time in force (timeInForce)<a class="hash-link" aria-label="Direct link to Time in force (timeInForce)" title="Direct link to Time in force (timeInForce)" href="/docs/binance-spot-api-docs/enums#time-in-force-timeinforce">​</a></h2>
...
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="rate-limiters-ratelimittype">Rate limiters (rateLimitType)<a class="hash-link" aria-label="Direct link to Rate limiters (rateLimitType)" title="Direct link to Rate limiters (rateLimitType)" href="/docs/binance-spot-api-docs/enums#rate-limiters-ratelimittype">​</a></h2>
<ul>
...
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="rate-limit-intervals-interval">Rate limit intervals (interval)<a class="hash-link" aria-label="Direct link to Rate limit intervals (interval)" title="Direct link to Rate limit intervals (interval)" href="/docs/binance-spot-api-docs/enums#rate-limit-intervals-interval">​</a></h2>
<ul>
<li>SECOND</li>
<li>MINUTE</li>
<li>DAY</li>
...
<p><a id="stpmodes"></a></p>
<h2 class="anchor anchorWithStickyNavbar_fMI7" id="stp-modes">STP Modes<a class="hash-link" aria-label="Direct link to STP Modes" title="Direct link to STP Modes" href="/docs/binance-spot-api-docs/enums#stp-modes">​</a></h2>
...
</ul></div></article><nav class="pagination-nav docusaurus-mt-lg" aria-label="Docs pages"><a class="pagination-nav__link pagination-nav__link--prev" href="/docs/binance-spot-api-docs/filters"><div class="pagination-nav__sublabel">Previous</div><div class="pagination-nav__label">Filters</div></a><a class="pagination-nav__link pagination-nav__link--next" href="/docs/binance-spot-api-docs/rest-api/general-api-information"><div class="pagination-nav__sublabel">Next</div><div class="pagination-nav__label">General API Information</div></a></nav></div></div><div class="col col--3"><div class="tableOfContents_zXaw thin-scrollbar theme-doc-toc-desktop"><ul class="table-of-contents table-of-contents__left-border"><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#symbol-status-status">Symbol status (status)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#account-and-symbol-permissions-permissions">Account and Symbol Permissions (permissions)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#order-status-status">Order status (status)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#order-list-status-liststatustype">Order List Status (listStatusType)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#order-list-order-status-listorderstatus">Order List Order Status (listOrderStatus)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#contingencytype">ContingencyType</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#allocationtype">AllocationType</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#order-types-ordertypes-type">Order types (orderTypes, type)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#order-response-type-neworderresptype">Order Response Type (newOrderRespType)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#working-floor">Working Floor</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#order-side-side">Order side (side)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#time-in-force-timeinforce">Time in force (timeInForce)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#rate-limiters-ratelimittype">Rate limiters (rateLimitType)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#rate-limit-intervals-interval">Rate limit intervals (interval)</a></li><li><a class="table-of-contents__link toc-highlight" href="/docs/binance-spot-api-docs/enums#stp-modes">STP Modes</a></li></ul></div></div></div></div></main></div></div></div><footer class="footer footer--dark"><div class="container container-fluid"><div class="footer__bottom text--center"><div class="footer__copyright">Copyright © 2026 Binance.</div></div></div></footer></div>
</body>
</html>
