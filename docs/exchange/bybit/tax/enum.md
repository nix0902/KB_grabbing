...
url: "https://bybit-exchange.github.io/docs/tax/enum"
...
Source: [https://bybit-exchange.github.io/docs/tax/enum](https://bybit-exchange.github.io/docs/tax/enum)
...
-   [English](/docs/tax/enum){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/tax/enum){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Enums Definitions](/docs/tax/enum){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
### ReportType[​](#reporttype "Direct link to heading"){.hash-link} 
...
### ReportNumber[​](#reportnumber "Direct link to heading"){.hash-link} 
...
[](/docs/tax/explain){.pagination-nav__link .pagination-nav__link--prev}
...
-   [ReportType](#reporttype){.table-of-contents__link .toc-highlight}
-   [ReportNumber](#reportnumber){.table-of-contents__link .toc-highlight}
