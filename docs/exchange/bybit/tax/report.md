...
url: "https://bybit-exchange.github.io/docs/tax/report"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:16+00:00"
---

# Request Export Report

Source: [https://bybit-exchange.github.io/docs/tax/report](https://bybit-exchange.github.io/docs/tax/report)
...
-   [English](/docs/tax/report){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/tax/report){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Request Export Report](/docs/tax/report){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    ...
    -   [Data Explanation](/docs/tax/explain){.menu__link tabindex="0"}
...
-   [Request Export Report]{.breadcrumbs__link itemprop="name"}
...
### Request Parameters[​](#request-parameters "Direct link to heading"){.hash-link} 
  ...
  --------------------------------------- ---------- -------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [type](/docs/tax/enum#reporttype)       **true**   string   Report Type
  [number](/docs/tax/enum#reportnumber)   **true**   string   Report Number
...
[](/docs/tax/time){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/tax/status){.pagination-nav__link .pagination-nav__link--next}
