...
url: "https://bybit-exchange.github.io/docs/tax/data-export"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:14+00:00"
---

# Retrieve Data Export

Source: [https://bybit-exchange.github.io/docs/tax/data-export](https://bybit-exchange.github.io/docs/tax/data-export)
...
-   [English](/docs/tax/data-export){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/tax/data-export){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Retrieve Data Export](/docs/tax/data-export){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Retrieve Data Export]{.breadcrumbs__link itemprop="name"}
...
### Sample Python Script[​](#sample-python-script "Direct link to heading"){.hash-link} 
...
[](/docs/tax/status){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/tax/explain){.pagination-nav__link .pagination-nav__link--next}
...
-   [Sample Python Script](#sample-python-script){.table-of-contents__link .toc-highlight}
