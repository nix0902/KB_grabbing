...
url: "https://bybit-exchange.github.io/docs/tax/status"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:17+00:00"
---

# Get Export Report Status

Source: [https://bybit-exchange.github.io/docs/tax/status](https://bybit-exchange.github.io/docs/tax/status)
...
-   [English](/docs/tax/status){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/tax/status){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Export Report Status](/docs/tax/status){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Export Report Status]{.breadcrumbs__link itemprop="name"}
...
[](/docs/tax/report){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/tax/data-export){.pagination-nav__link .pagination-nav__link--next}
