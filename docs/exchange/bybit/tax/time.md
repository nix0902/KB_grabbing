...
url: "https://bybit-exchange.github.io/docs/tax/time"
...
Source: [https://bybit-exchange.github.io/docs/tax/time](https://bybit-exchange.github.io/docs/tax/time)
...
-   [English](/docs/tax/time){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/tax/time){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get User Register Date](/docs/tax/time){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get User Register Date]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v3/intro){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/tax/report){.pagination-nav__link .pagination-nav__link--next}
