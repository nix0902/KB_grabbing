---
title: "P2P Authentication"
url: "https://bybit-exchange.github.io/docs/p2p/guide"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:03+00:00"
---

# P2P Authentication

Source: [https://bybit-exchange.github.io/docs/p2p/guide](https://bybit-exchange.github.io/docs/p2p/guide)
...
-   [English](/docs/p2p/guide){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/guide){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   [P2P Authentication](/docs/p2p/guide){.menu__link .menu__link--active aria-current="page"}
...
-   
    [Advertisement](/docs/p2p/ad/online-ad-list){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false"}
...
-   [P2P Authentication]{.breadcrumbs__link itemprop="name"}
...
## API Resources and Support Channels[​](#api-resources-and-support-channels "Direct link to heading"){.hash-link} 

-   📌 [Help Center](https://www.bybit.com/en-US/help-center/bybitHC_Guides?language=en_US){target="_blank" rel="noopener noreferrer"}
-   🎉 [Official Python P2P API SDK](https://github.com/bybit-exchange/bybit_p2p){target="_blank" rel="noopener noreferrer"}
-   ✉️ [Telegram - API Discussion Group](https://t.me/BybitAPI){target="_blank" rel="noopener noreferrer"}
-   ✉️ [Discord](https://discord.gg/3ZDjGBNvKR){target="_blank" rel="noopener noreferrer"}
...
The P2P API is only accessible by General Advertisers or above. Users without a P2P advertiser status cannot access the P2P API. You can check your account status on this page: [**P2P Advertiser Program**](https://bybit.com/en/fiat/trade/otc/identify/GA){target="_blank" rel="noopener noreferrer"}
...
Please visit Bybit\'s [**testnet**](https://testnet.bybit.com/app/user/api-management){target="_blank" rel="noopener noreferrer"} or [**mainnet**](https://www.bybit.com/app/user/api-management){target="_blank" rel="noopener noreferrer"} to generate an API key
...
### Select Your API Key Type[​](#select-your-api-key-type "Direct link to heading"){.hash-link} 
...
> Follow [HMAC sample scripts](https://github.com/bybit-exchange/api-usage-examples){target="_blank" rel="noopener noreferrer"} to complete encryption procedures.
...
> 1.  Use [api-rsa-generator](https://github.com/bybit-exchange/api-rsa-generator){target="_blank" rel="noopener noreferrer"} to create RSA private and public keys
> 2.  Follow the [RSA sample scripts](https://github.com/bybit-exchange/api-usage-examples){target="_blank" rel="noopener noreferrer"} to complete encryption procedures.

### HTTP Headers for Authenticated Endpoints[​](#http-headers-for-authenticated-endpoints "Direct link to heading"){.hash-link} 
...
### Create A Request[​](#create-a-request "Direct link to heading"){.hash-link} 
...
**Example signature algorithms can be found [here](https://github.com/bybit-exchange/api-usage-examples){target="_blank" rel="noopener noreferrer"}.**
...
## Common response parameters[​](#common-response-parameters "Direct link to heading"){.hash-link} 
...
[](/docs/p2p/all-balance){.pagination-nav__link .pagination-nav__link--next}
...
-   [API Resources and Support Channels](#api-resources-and-support-channels){.table-of-contents__link .toc-highlight}
-   [Authentication](#authentication){.table-of-contents__link .toc-highlight}
    -   [Select Your API Key Type](#select-your-api-key-type){.table-of-contents__link .toc-highlight}
    -   [HTTP Headers for Authenticated Endpoints](#http-headers-for-authenticated-endpoints){.table-of-contents__link .toc-highlight}
    -   [Create A Request](#create-a-request){.table-of-contents__link .toc-highlight}
-   [Common response parameters](#common-response-parameters){.table-of-contents__link .toc-highlight}
