---
title: "Post Ad"
url: "https://bybit-exchange.github.io/docs/p2p/ad/post-new-ad"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:01+00:00"
---

# Post Ad

Source: [https://bybit-exchange.github.io/docs/p2p/ad/post-new-ad](https://bybit-exchange.github.io/docs/p2p/ad/post-new-ad)
...
-   [English](/docs/p2p/ad/post-new-ad){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/ad/post-new-ad){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Post Ad](/docs/p2p/ad/post-new-ad){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Post Ad]{.breadcrumbs__link itemprop="name"}
...
### Request Parameters[​](#request-parameters "Direct link to heading"){.hash-link} 
  ...
  \> nationalLimit               false             string            KYC restricted countries. Format: three-letter [ISO country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3){target="_blank" rel="noopener noreferrer"}
  ...
  itemType                       **true**          string            `ORIGIN`: original P2P advertisement, generally refers to non-bulk advertisement;\
...
[](/docs/p2p/ad/online-ad-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/ad/remove-ad){.pagination-nav__link .pagination-nav__link--next}
