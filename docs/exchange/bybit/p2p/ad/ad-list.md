---
title: "Get My Ads"
url: "https://bybit-exchange.github.io/docs/p2p/ad/ad-list"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:53:59+00:00"
---

# Get My Ads

Source: [https://bybit-exchange.github.io/docs/p2p/ad/ad-list](https://bybit-exchange.github.io/docs/p2p/ad/ad-list)
...
-   [English](/docs/p2p/ad/ad-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/ad/ad-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get My Ads](/docs/p2p/ad/ad-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get My Ads]{.breadcrumbs__link itemprop="name"}
...
### Response Parameters[​](#response-parameters "Direct link to heading"){.hash-link} 
  ...
  \> itemType                      string                  `ORIGIN`: original P2P advertisement, generally refers to non-bulk advertisement;\
...
[](/docs/p2p/ad/update-list-ad){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/ad/ad-detail){.pagination-nav__link .pagination-nav__link--next}
