...
url: "https://bybit-exchange.github.io/docs/p2p/order/order-detail"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:06+00:00"
---

# Get Order Detail

Source: [https://bybit-exchange.github.io/docs/p2p/order/order-detail](https://bybit-exchange.github.io/docs/p2p/order/order-detail)
...
-   [English](/docs/p2p/order/order-detail){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/order/order-detail){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Order Detail](/docs/p2p/order/order-detail){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Order Detail]{.breadcrumbs__link itemprop="name"}
...
[](/docs/p2p/order/order-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/order/pending-order){.pagination-nav__link .pagination-nav__link--next}
