...
url: "https://bybit-exchange.github.io/docs/p2p/order/send-chat-msg"
...
Source: [https://bybit-exchange.github.io/docs/p2p/order/send-chat-msg](https://bybit-exchange.github.io/docs/p2p/order/send-chat-msg)
...
-   [English](/docs/p2p/order/send-chat-msg){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/order/send-chat-msg){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Send Chat Message](/docs/p2p/order/send-chat-msg){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Send Chat Message]{.breadcrumbs__link itemprop="name"}
...
[](/docs/p2p/order/release-digital-asset){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/order/upload-chat-file){.pagination-nav__link .pagination-nav__link--next}
