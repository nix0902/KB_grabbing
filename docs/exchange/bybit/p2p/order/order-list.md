...
url: "https://bybit-exchange.github.io/docs/p2p/order/order-list"
...
Source: [https://bybit-exchange.github.io/docs/p2p/order/order-list](https://bybit-exchange.github.io/docs/p2p/order/order-list)
...
-   [English](/docs/p2p/order/order-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/order/order-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get All Orders](/docs/p2p/order/order-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get All Orders]{.breadcrumbs__link itemprop="name"}
...
|                 |                 |                 | -   `40`: order cancelled                                                    |
|                 |                 |                 | -   `50`: order finished                                                     |
|                 |                 |                 | -   `60`: paying (only when paying online)                                   |
|                 |                 |                 | -   `70`: pay fail (only when paying online)                                 |
|                 |                 |                 | -   `80`: exception cancelled (the coin convert to other coin, only hotswap) |
...
[](/docs/p2p/ad/ad-detail){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/order/order-detail){.pagination-nav__link .pagination-nav__link--next}
