...
url: "https://bybit-exchange.github.io/docs/p2p/order/chat-msg"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:04+00:00"
---

# Get Chat Message

Source: [https://bybit-exchange.github.io/docs/p2p/order/chat-msg](https://bybit-exchange.github.io/docs/p2p/order/chat-msg)
...
-   [English](/docs/p2p/order/chat-msg){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/order/chat-msg){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Chat Message](/docs/p2p/order/chat-msg){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Chat Message]{.breadcrumbs__link itemprop="name"}
...
[](/docs/p2p/order/upload-chat-file){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/user/acct-info){.pagination-nav__link .pagination-nav__link--next}
