...
url: "https://bybit-exchange.github.io/docs/p2p/order/mark-order-as-paid"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:05+00:00"
---

# Mark Order as Paid

Source: [https://bybit-exchange.github.io/docs/p2p/order/mark-order-as-paid](https://bybit-exchange.github.io/docs/p2p/order/mark-order-as-paid)
...
-   [English](/docs/p2p/order/mark-order-as-paid){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/order/mark-order-as-paid){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Mark Order as Paid](/docs/p2p/order/mark-order-as-paid){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Mark Order as Paid]{.breadcrumbs__link itemprop="name"}
...
[](/docs/p2p/order/pending-order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/order/release-digital-asset){.pagination-nav__link .pagination-nav__link--next}
