...
url: "https://bybit-exchange.github.io/docs/p2p/order/upload-chat-file"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:09+00:00"
---

# Upload Chat File

Source: [https://bybit-exchange.github.io/docs/p2p/order/upload-chat-file](https://bybit-exchange.github.io/docs/p2p/order/upload-chat-file)
...
-   [English](/docs/p2p/order/upload-chat-file){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/order/upload-chat-file){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    [Orders](/docs/p2p/order/order-list){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true"}
    

    -   [Get All Orders](/docs/p2p/order/order-list){.menu__link tabindex="0"}
    -   [Get Order Detail](/docs/p2p/order/order-detail){.menu__link tabindex="0"}
    -   [Get Pending Orders](/docs/p2p/order/pending-order){.menu__link tabindex="0"}
    -   [Mark Order as Paid](/docs/p2p/order/mark-order-as-paid){.menu__link tabindex="0"}
    -   [Release Assets](/docs/p2p/order/release-digital-asset){.menu__link tabindex="0"}
    -   [Send Chat Message](/docs/p2p/order/send-chat-msg){.menu__link tabindex="0"}
    -   [Upload Chat File](/docs/p2p/order/upload-chat-file){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    -   [Get Chat Message](/docs/p2p/order/chat-msg){.menu__link tabindex="0"}
...
-   [Orders]{.breadcrumbs__link}
-   [Upload Chat File]{.breadcrumbs__link itemprop="name"}
...
2.  Use [**Send Chat Message**](https://bybit-exchange.github.io/docs/p2p/order/send-chat-msg){target="_blank" rel="noopener noreferrer"} with a correct `contentType`, like \"pic\", \"pdf\" or \"video\". Put URL into `message`
...
[](/docs/p2p/order/send-chat-msg){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/order/chat-msg){.pagination-nav__link .pagination-nav__link--next}
