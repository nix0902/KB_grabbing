...
url: "https://bybit-exchange.github.io/docs/p2p/order/pending-order"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:07+00:00"
---

# Get Pending Orders

Source: [https://bybit-exchange.github.io/docs/p2p/order/pending-order](https://bybit-exchange.github.io/docs/p2p/order/pending-order)
...
-   [English](/docs/p2p/order/pending-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/order/pending-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Pending Orders](/docs/p2p/order/pending-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    ...
    -   [Upload Chat File](/docs/p2p/order/upload-chat-file){.menu__link tabindex="0"}
...
-   [Get Pending Orders]{.breadcrumbs__link itemprop="name"}
...
+:================+:================+:================+=======================================================+
| status          | false           | integer         | Order status                                          |
|                 |                 |                 |                                                       |
|                 |                 |                 | -   `5`: waiting for chain (only web3)                |
|                 |                 |                 | -   `10`: waiting for buy pay                         |
|                 |                 |                 | -   `20`: waiting for seller release                  |
|                 |                 |                 | -   `30`: Appealing                                   |
...
+------------------------+-----------------------+-------------------------------------------------------+
| \> orderType           | string                | -   `ORIGIN`: normal p2p order                        |
|                        |                       | -   `SMALL_COIN`: HotSwap p2p order                   |
|                        |                       | -   `WEB3`: web3 p2p order                            |
+------------------------+-----------------------+-------------------------------------------------------+
...
[](/docs/p2p/order/order-detail){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/order/mark-order-as-paid){.pagination-nav__link .pagination-nav__link--next}
