...
url: "https://bybit-exchange.github.io/docs/p2p/user/user-payment"
...
Source: [https://bybit-exchange.github.io/docs/p2p/user/user-payment](https://bybit-exchange.github.io/docs/p2p/user/user-payment)
...
-   [English](/docs/p2p/user/user-payment){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/user/user-payment){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get User Payment](/docs/p2p/user/user-payment){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get User Payment]{.breadcrumbs__link itemprop="name"}
...
[](/docs/p2p/user/counterparty-user-info){.pagination-nav__link .pagination-nav__link--prev}
