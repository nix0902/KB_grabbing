---
title: "Rate Limit"
url: "https://bybit-exchange.github.io/docs/p2p/rate-limit"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:54:10+00:00"
---

# Rate Limit

Source: [https://bybit-exchange.github.io/docs/p2p/rate-limit](https://bybit-exchange.github.io/docs/p2p/rate-limit)
...
-   [English](/docs/p2p/rate-limit){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/p2p/rate-limit){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   [Rate Limit](/docs/p2p/rate-limit){.menu__link .menu__link--active aria-current="page"}
...
-   [Rate Limit]{.breadcrumbs__link itemprop="name"}
...
[](/docs/p2p/all-balance){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/p2p/ad/online-ad-list){.pagination-nav__link .pagination-nav__link--next}
