...
fetched: "2026-03-10T08:56:40+00:00"
---

# Set Disconnect Cancel All

Source: [https://bybit-exchange.github.io/docs/v5/order/dcp](https://bybit-exchange.github.io/docs/v5/order/dcp)
...
-   [English](/docs/v5/order/dcp){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/order/dcp){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set DCP](/docs/v5/order/dcp){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set DCP]{.breadcrumbs__link itemprop="name"}
...
## What is Disconnection Protect (DCP)?[​](#what-is-disconnection-protect-dcp "Direct link to heading"){.hash-link} 
...
## How to enable DCP[​](#how-to-enable-dcp "Direct link to heading"){.hash-link} 
...
[](/docs/v5/order/spot-borrow-quota){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/order/pre-check-order){.pagination-nav__link .pagination-nav__link--next}
