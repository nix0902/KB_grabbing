...
Source: [https://bybit-exchange.github.io/docs/v5/order/cancel-all](https://bybit-exchange.github.io/docs/v5/order/cancel-all)
...
-   [English](/docs/v5/order/cancel-all){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/order/cancel-all){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Cancel All Orders](/docs/v5/order/cancel-all){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
|                                              |                 |                 | -   Not support `spot`                                                                                                                                                                   |
+----------------------------------------------+-----------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| orderFilter                                  | false           | string          | -   category=`spot`, you can pass `Order`, `tpslOrder`, `StopOrder`, `OcoOrder`, `BidirectionalTpslOrder`\                                                                               |
...
[](/docs/v5/order/open-order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/order/order-list){.pagination-nav__link .pagination-nav__link--next}
