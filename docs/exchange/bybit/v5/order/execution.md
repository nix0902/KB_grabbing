...
fetched: "2026-03-10T08:56:41+00:00"
---

# Get Trade History

Source: [https://bybit-exchange.github.io/docs/v5/order/execution](https://bybit-exchange.github.io/docs/v5/order/execution)
...
-   [English](/docs/v5/order/execution){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/order/execution){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Trade History (2 years)](/docs/v5/order/execution){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Trade History (2 years)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/order/order-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/order/batch-place){.pagination-nav__link .pagination-nav__link--next}
