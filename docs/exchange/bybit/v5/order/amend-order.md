...
fetched: "2026-03-10T08:56:34+00:00"
---

# Amend Order

Source: [https://bybit-exchange.github.io/docs/v5/order/amend-order](https://bybit-exchange.github.io/docs/v5/order/amend-order)
...
-   [English](/docs/v5/order/amend-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/order/amend-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Amend Order](/docs/v5/order/amend-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
+----------------------------------------+-----------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| tpLimitPrice                           | false           | string          | Limit order price when take profit is triggered. Only working when original order sets partial limit tp/sl. *Option not supported*                                      |
+----------------------------------------+-----------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| slLimitPrice                           | false           | string          | Limit order price when stop loss is triggered. Only working when original order sets partial limit tp/sl. *Option not supported\`*                                      |
+----------------------------------------+-----------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
[](/docs/v5/order/create-order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/order/cancel-order){.pagination-nav__link .pagination-nav__link--next}
