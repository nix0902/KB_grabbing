...
fetched: "2026-03-10T08:56:44+00:00"
---

# Get Borrow Quota (Spot)

Source: [https://bybit-exchange.github.io/docs/v5/order/spot-borrow-quota](https://bybit-exchange.github.io/docs/v5/order/spot-borrow-quota)
...
-   [English](/docs/v5/order/spot-borrow-quota){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/order/spot-borrow-quota){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Borrow Quota (Spot)](/docs/v5/order/spot-borrow-quota){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Borrow Quota (Spot)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/order/batch-cancel){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/order/dcp){.pagination-nav__link .pagination-nav__link--next}
