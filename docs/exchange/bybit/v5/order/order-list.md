...
Source: [https://bybit-exchange.github.io/docs/v5/order/order-list](https://bybit-exchange.github.io/docs/v5/order/order-list)
...
-   [English](/docs/v5/order/order-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/order/order-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Order History (2 years)](/docs/v5/order/order-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Order History (2 years)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/order/cancel-all){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/order/execution){.pagination-nav__link .pagination-nav__link--next}
