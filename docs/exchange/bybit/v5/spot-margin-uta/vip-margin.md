...
fetched: "2026-03-10T08:57:36+00:00"
---

# Get VIP Margin Data

Source: [https://bybit-exchange.github.io/docs/v5/spot-margin-uta/vip-margin](https://bybit-exchange.github.io/docs/v5/spot-margin-uta/vip-margin)
...
-   [English](/docs/v5/spot-margin-uta/vip-margin){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spot-margin-uta/vip-margin){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get VIP Margin Data](/docs/v5/spot-margin-uta/vip-margin){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get VIP Margin Data]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/affiliate/affiliate-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spot-margin-uta/tier-collateral-ratio){.pagination-nav__link .pagination-nav__link--next}
