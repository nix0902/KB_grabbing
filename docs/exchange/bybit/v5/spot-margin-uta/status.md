...
fetched: "2026-03-10T08:57:34+00:00"
---

# Get Status And Leverage

Source: [https://bybit-exchange.github.io/docs/v5/spot-margin-uta/status](https://bybit-exchange.github.io/docs/v5/spot-margin-uta/status)
...
-   [English](/docs/v5/spot-margin-uta/status){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spot-margin-uta/status){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Status And Leverage](/docs/v5/spot-margin-uta/status){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Status And Leverage]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spot-margin-uta/set-leverage){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spot-margin-uta/max-borrowable){.pagination-nav__link .pagination-nav__link--next}
