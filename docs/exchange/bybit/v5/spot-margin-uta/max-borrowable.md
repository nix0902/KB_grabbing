...
Source: [https://bybit-exchange.github.io/docs/v5/spot-margin-uta/max-borrowable](https://bybit-exchange.github.io/docs/v5/spot-margin-uta/max-borrowable)
...
-   [English](/docs/v5/spot-margin-uta/max-borrowable){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spot-margin-uta/max-borrowable){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Max Borrowable Amount](/docs/v5/spot-margin-uta/max-borrowable){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Max Borrowable Amount]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spot-margin-uta/status){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spot-margin-uta/position-tiers){.pagination-nav__link .pagination-nav__link--next}
