...
Source: [https://bybit-exchange.github.io/docs/v5/copytrade](https://bybit-exchange.github.io/docs/v5/copytrade)
...
-   [English](/docs/v5/copytrade){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/copytrade){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   [How To Start Copy Trading](/docs/v5/copytrade){.menu__link .menu__link--active aria-current="page"}
...
-   [How To Start Copy Trading]{.breadcrumbs__link itemprop="name"}
...
## Become A Master Trader[​](#become-a-master-trader "Direct link to heading"){.hash-link} 

Please go [here](https://www.bybit.com/copyTrade/){target="_blank" rel="noopener noreferrer"} to apply to become a Master Trader

## Create The API KEY[​](#create-the-api-key "Direct link to heading"){.hash-link} 

\"Contract - Orders & Positions\" are mandatory permissions for Copy Trading orders

## Understand The Scope[​](#understand-the-scope "Direct link to heading"){.hash-link} 
...
## Place The Copy Trading Order[​](#place-the-copy-trading-order "Direct link to heading"){.hash-link} 
...
[](/docs/v5/smp){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/demo){.pagination-nav__link .pagination-nav__link--next}
...
-   [Become A Master Trader](#become-a-master-trader){.table-of-contents__link .toc-highlight}
-   [Create The API KEY](#create-the-api-key){.table-of-contents__link .toc-highlight}
-   [Understand The Scope](#understand-the-scope){.table-of-contents__link .toc-highlight}
-   [Place The Copy Trading Order](#place-the-copy-trading-order){.table-of-contents__link .toc-highlight}
