...
fetched: "2026-03-10T08:57:46+00:00"
---

# Orderbook

Source: [https://bybit-exchange.github.io/docs/v5/spread/websocket/public/orderbook](https://bybit-exchange.github.io/docs/v5/spread/websocket/public/orderbook)
...
-   [English](/docs/v5/spread/websocket/public/orderbook){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/websocket/public/orderbook){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    [Spread Trading](/docs/v5/spread/market/instrument){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true"}
    

    -   
        [Market](/docs/v5/spread/market/instrument){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
        

    -   
        [Trade](/docs/v5/spread/trade/create-order){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
        

    -   
        [Websocket Stream](/docs/v5/ws/connect){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Connect](/docs/v5/ws/connect){.menu__link tabindex="0"}

        -   
            [Public](/docs/v5/spread/websocket/public/orderbook){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
            

            -   [Orderbook](/docs/v5/spread/websocket/public/orderbook){.menu__link .menu__link--active aria-current="page" tabindex="0"}
            -   [Trade](/docs/v5/spread/websocket/public/trade){.menu__link tabindex="0"}
            -   [Ticker](/docs/v5/spread/websocket/public/ticker){.menu__link tabindex="0"}

        -   
            [Private](/docs/v5/spread/websocket/private/order){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
...
-   [Spread Trading]{.breadcrumbs__link}
-   [Websocket Stream]{.breadcrumbs__link}
-   [Public]{.breadcrumbs__link}
-   [Orderbook]{.breadcrumbs__link itemprop="name"}
...
### Depths[​](#depths "Direct link to heading"){.hash-link} 
...
### Process snapshot/delta[​](#process-snapshotdelta "Direct link to heading"){.hash-link} 
...
See working code examples of this logic in the [FAQ](https://bybit-exchange.github.io/docs/faq#how-can-i-process-websocket-snapshot-and-delta-messages){target="_blank" rel="noopener noreferrer"}.
...
### Event Example[​](#event-example "Direct link to heading"){.hash-link} 
...
[](/docs/v5/ws/connect){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/websocket/public/trade){.pagination-nav__link .pagination-nav__link--next}
...
-   [Depths](#depths){.table-of-contents__link .toc-highlight}
-   [Process snapshot/delta](#process-snapshotdelta){.table-of-contents__link .toc-highlight}
...
-   [Event Example](#event-example){.table-of-contents__link .toc-highlight}
