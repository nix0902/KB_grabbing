...
fetched: "2026-03-10T08:57:45+00:00"
---

# Execution

Source: [https://bybit-exchange.github.io/docs/v5/spread/websocket/private/execution](https://bybit-exchange.github.io/docs/v5/spread/websocket/private/execution)
...
-   [English](/docs/v5/spread/websocket/private/execution){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/websocket/private/execution){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            [Public](/docs/v5/spread/websocket/public/orderbook){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
            

        -   
            [Private](/docs/v5/spread/websocket/private/order){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
            

            -   [Order](/docs/v5/spread/websocket/private/order){.menu__link tabindex="0"}
            -   [Execution](/docs/v5/spread/websocket/private/execution){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Execution]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spread/websocket/private/order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/basic-workflow){.pagination-nav__link .pagination-nav__link--next}
