...
Source: [https://bybit-exchange.github.io/docs/v5/spread/websocket/private/order](https://bybit-exchange.github.io/docs/v5/spread/websocket/private/order)
...
-   [English](/docs/v5/spread/websocket/private/order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/websocket/private/order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            ...
            -   [Order](/docs/v5/spread/websocket/private/order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
            -   [Execution](/docs/v5/spread/websocket/private/execution){.menu__link tabindex="0"}
...
-   [Order]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spread/websocket/public/ticker){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/websocket/private/execution){.pagination-nav__link .pagination-nav__link--next}
