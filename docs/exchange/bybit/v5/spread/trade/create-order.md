...
fetched: "2026-03-10T08:57:42+00:00"
---

# Create Order

Source: [https://bybit-exchange.github.io/docs/v5/spread/trade/create-order](https://bybit-exchange.github.io/docs/v5/spread/trade/create-order)
...
-   [English](/docs/v5/spread/trade/create-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/trade/create-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        [Trade](/docs/v5/spread/trade/create-order){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Create Order](/docs/v5/spread/trade/create-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        -   [Amend Order](/docs/v5/spread/trade/amend-order){.menu__link tabindex="0"}
        -   [Cancel Order](/docs/v5/spread/trade/cancel-order){.menu__link tabindex="0"}
        -   [Cancel All Orders](/docs/v5/spread/trade/cancel-all){.menu__link tabindex="0"}
        -   [Get Open Orders](/docs/v5/spread/trade/open-order){.menu__link tabindex="0"}
        -   [Get Order History](/docs/v5/spread/trade/order-history){.menu__link tabindex="0"}
        -   [Get Trade History](/docs/v5/spread/trade/trade-history){.menu__link tabindex="0"}
...
-   [Create Order]{.breadcrumbs__link itemprop="name"}
...
### Request Parameters[​](#request-parameters "Direct link to heading"){.hash-link} 
  ...
  timeInForce   false      string   [Time in force](https://www.bybit.com/en/help-center/article/What-Are-Time-In-Force-TIF-GTC-IOC-FOK){target="_blank" rel="noopener noreferrer"}. `IOC`, `FOK`, `GTC`, `PostOnly`
...
[](/docs/v5/spread/market/recent-trade){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/trade/amend-order){.pagination-nav__link .pagination-nav__link--next}
