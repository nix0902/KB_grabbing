...
fetched: "2026-03-10T08:57:44+00:00"
---

# Get Trade History

Source: [https://bybit-exchange.github.io/docs/v5/spread/trade/trade-history](https://bybit-exchange.github.io/docs/v5/spread/trade/trade-history)
...
-   [English](/docs/v5/spread/trade/trade-history){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/trade/trade-history){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Trade History](/docs/v5/spread/trade/trade-history){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Trade History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spread/trade/order-history){.pagination-nav__link .pagination-nav__link--prev}
