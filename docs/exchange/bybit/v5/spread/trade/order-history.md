...
fetched: "2026-03-10T08:57:43+00:00"
---

# Get Order History

Source: [https://bybit-exchange.github.io/docs/v5/spread/trade/order-history](https://bybit-exchange.github.io/docs/v5/spread/trade/order-history)
...
-   [English](/docs/v5/spread/trade/order-history){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/trade/order-history){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Create Order](/docs/v5/spread/trade/create-order){.menu__link tabindex="0"}
        ...
        -   [Get Order History](/docs/v5/spread/trade/order-history){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Order History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spread/trade/open-order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/trade/trade-history){.pagination-nav__link .pagination-nav__link--next}
