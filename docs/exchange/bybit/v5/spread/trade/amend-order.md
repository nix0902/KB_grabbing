...
fetched: "2026-03-10T08:57:40+00:00"
---

# Amend Order

Source: [https://bybit-exchange.github.io/docs/v5/spread/trade/amend-order](https://bybit-exchange.github.io/docs/v5/spread/trade/amend-order)
...
-   [English](/docs/v5/spread/trade/amend-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/trade/amend-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Amend Order](/docs/v5/spread/trade/amend-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Amend Order]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spread/trade/create-order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/trade/cancel-order){.pagination-nav__link .pagination-nav__link--next}
