...
Source: [https://bybit-exchange.github.io/docs/v5/spread/trade/open-order](https://bybit-exchange.github.io/docs/v5/spread/trade/open-order)
...
-   [English](/docs/v5/spread/trade/open-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/trade/open-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Open Orders](/docs/v5/spread/trade/open-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Open Orders]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spread/trade/cancel-all){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/trade/order-history){.pagination-nav__link .pagination-nav__link--next}
