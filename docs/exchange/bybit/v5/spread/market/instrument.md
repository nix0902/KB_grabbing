...
fetched: "2026-03-10T08:57:37+00:00"
---

# Get Instruments Info

Source: [https://bybit-exchange.github.io/docs/v5/spread/market/instrument](https://bybit-exchange.github.io/docs/v5/spread/market/instrument)
...
-   [English](/docs/v5/spread/market/instrument){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/market/instrument){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Instruments Info](/docs/v5/spread/market/instrument){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Instruments Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/friend-referral){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/market/orderbook){.pagination-nav__link .pagination-nav__link--next}
