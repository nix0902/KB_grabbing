...
fetched: "2026-03-10T08:57:39+00:00"
---

# Get Recent Public Trades

Source: [https://bybit-exchange.github.io/docs/v5/spread/market/recent-trade](https://bybit-exchange.github.io/docs/v5/spread/market/recent-trade)
...
-   [English](/docs/v5/spread/market/recent-trade){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/market/recent-trade){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Orderbook](/docs/v5/spread/market/orderbook){.menu__link tabindex="0"}
        -   [Get Tickers](/docs/v5/spread/market/tickers){.menu__link tabindex="0"}
        -   [Get Recent Public Trades](/docs/v5/spread/market/recent-trade){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Recent Public Trades]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/spread/market/tickers){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/trade/create-order){.pagination-nav__link .pagination-nav__link--next}
