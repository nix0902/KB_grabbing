...
fetched: "2026-03-10T08:57:38+00:00"
---

# Get Orderbook

Source: [https://bybit-exchange.github.io/docs/v5/spread/market/orderbook](https://bybit-exchange.github.io/docs/v5/spread/market/orderbook)
...
-   [English](/docs/v5/spread/market/orderbook){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/spread/market/orderbook){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        [Market](/docs/v5/spread/market/instrument){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Get Instruments Info](/docs/v5/spread/market/instrument){.menu__link tabindex="0"}
        -   [Get Orderbook](/docs/v5/spread/market/orderbook){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        -   [Get Tickers](/docs/v5/spread/market/tickers){.menu__link tabindex="0"}
        -   [Get Recent Public Trades](/docs/v5/spread/market/recent-trade){.menu__link tabindex="0"}
...
-   [Get Orderbook]{.breadcrumbs__link itemprop="name"}
...
### Response Parameters[​](#response-parameters "Direct link to heading"){.hash-link} 
  ...
  u           integer   Update ID. Is always in sequence. Corresponds to `u` in the 25-level [WebSocket orderbook stream](https://bybit-exchange.github.io/docs/v5/spread/websocket/public/orderbook){target="_blank" rel="noopener noreferrer"}
...
[](/docs/v5/spread/market/instrument){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/market/tickers){.pagination-nav__link .pagination-nav__link--next}
