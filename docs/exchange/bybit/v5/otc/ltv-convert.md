...
fetched: "2026-03-10T08:56:46+00:00"
---

# Get LTV

Source: [https://bybit-exchange.github.io/docs/v5/otc/ltv-convert](https://bybit-exchange.github.io/docs/v5/otc/ltv-convert)
...
-   [English](/docs/v5/otc/ltv-convert){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/otc/ltv-convert){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    [Institutional Loan](/docs/v5/otc/margin-product-info){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true"}
    

    -   [Get Product Info](/docs/v5/otc/margin-product-info){.menu__link tabindex="0"}
    -   [Get Margin Coin Info](/docs/v5/otc/margin-coin-convert-info){.menu__link tabindex="0"}
    -   [Get Loan Orders](/docs/v5/otc/loan-info){.menu__link tabindex="0"}
    -   [Get Repayment Orders](/docs/v5/otc/repay-info){.menu__link tabindex="0"}
    -   [Get LTV](/docs/v5/otc/ltv-convert){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    -   [Bind Or Unbind UID](/docs/v5/otc/bind-uid){.menu__link tabindex="0"}
    -   [Repay](/docs/v5/otc/repay){.menu__link tabindex="0"}
...
-   [Institutional Loan]{.breadcrumbs__link}
-   [Get LTV]{.breadcrumbs__link itemprop="name"}
...
+-----------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| \> balance            | string                | Total asset (margin coins converted to USDT). Please read [here](https://www.bybit.com/en-US/help-center/s/article/Over-the-counter-OTC-Lending){target="_blank" rel="noopener noreferrer"} to understand the calculation. When `liqStatus` != 0, empty string is returned. |
+-----------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
[](/docs/v5/otc/repay-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/otc/bind-uid){.pagination-nav__link .pagination-nav__link--next}
