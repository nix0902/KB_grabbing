...
fetched: "2026-03-10T08:56:48+00:00"
---

# Get Product Info

Source: [https://bybit-exchange.github.io/docs/v5/otc/margin-product-info](https://bybit-exchange.github.io/docs/v5/otc/margin-product-info)
...
-   [English](/docs/v5/otc/margin-product-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/otc/margin-product-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Product Info](/docs/v5/otc/margin-product-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/crypto-loan/ltv-adjust-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/otc/margin-coin-convert-info){.pagination-nav__link .pagination-nav__link--next}
