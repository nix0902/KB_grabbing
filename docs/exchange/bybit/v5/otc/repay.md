...
Source: [https://bybit-exchange.github.io/docs/v5/otc/repay](https://bybit-exchange.github.io/docs/v5/otc/repay)
...
-   [English](/docs/v5/otc/repay){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/otc/repay){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Repay](/docs/v5/otc/repay){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/otc/bind-uid){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/broker/api-broker/guidance){.pagination-nav__link .pagination-nav__link--next}
