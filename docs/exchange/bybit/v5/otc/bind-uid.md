...
fetched: "2026-03-10T08:56:45+00:00"
---

# Bind Or Unbind UID

Source: [https://bybit-exchange.github.io/docs/v5/otc/bind-uid](https://bybit-exchange.github.io/docs/v5/otc/bind-uid)
...
-   [English](/docs/v5/otc/bind-uid){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/otc/bind-uid){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Bind Or Unbind UID](/docs/v5/otc/bind-uid){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Bind Or Unbind UID]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/otc/ltv-convert){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/otc/repay){.pagination-nav__link .pagination-nav__link--next}
