...
Source: [https://bybit-exchange.github.io/docs/v5/otc/loan-info](https://bybit-exchange.github.io/docs/v5/otc/loan-info)
...
-   [English](/docs/v5/otc/loan-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/otc/loan-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Loan Orders](/docs/v5/otc/loan-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Loan Orders]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/otc/margin-coin-convert-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/otc/repay-info){.pagination-nav__link .pagination-nav__link--next}
