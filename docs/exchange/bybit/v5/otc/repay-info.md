...
fetched: "2026-03-10T08:56:49+00:00"
---

# Get Repayment Orders

Source: [https://bybit-exchange.github.io/docs/v5/otc/repay-info](https://bybit-exchange.github.io/docs/v5/otc/repay-info)
...
-   [English](/docs/v5/otc/repay-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/otc/repay-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Repayment Orders](/docs/v5/otc/repay-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Repayment Orders]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/otc/loan-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/otc/ltv-convert){.pagination-nav__link .pagination-nav__link--next}
