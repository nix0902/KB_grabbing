...
fetched: "2026-03-10T08:58:13+00:00"
---

# System Status

Source: [https://bybit-exchange.github.io/docs/v5/websocket/system/system-status](https://bybit-exchange.github.io/docs/v5/websocket/system/system-status)
...
-   [English](/docs/v5/websocket/system/system-status){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/websocket/system/system-status){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        [System](/docs/v5/websocket/system/system-status){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [System Status](/docs/v5/websocket/system/system-status){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [System]{.breadcrumbs__link}
-   [System Status]{.breadcrumbs__link itemprop="name"}
...
-   EU users registered from \"[www.bybit.eu\"](http://www.bybit.eu%22){target="_blank" rel="noopener noreferrer"}, please use `wss://stream.bybit.eu/v5/public/misc/status`
...
[](/docs/v5/websocket/trade/guideline){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rate-limit){.pagination-nav__link .pagination-nav__link--next}
