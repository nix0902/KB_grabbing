...
Source: [https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook-rpi](https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook-rpi)
...
-   [English](/docs/v5/websocket/public/orderbook-rpi){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/websocket/public/orderbook-rpi){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [RPI Orderbook](/docs/v5/websocket/public/orderbook-rpi){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [RPI Orderbook]{.breadcrumbs__link itemprop="name"}
...
### Subscribe Success Response[​](#subscribe-success-response "Direct link to heading"){.hash-link} 
...
[](/docs/v5/websocket/public/orderbook){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/websocket/public/trade){.pagination-nav__link .pagination-nav__link--next}
...
-   [Subscribe Success Response](#subscribe-success-response){.table-of-contents__link .toc-highlight}
