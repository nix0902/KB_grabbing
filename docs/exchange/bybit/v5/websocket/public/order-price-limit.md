...
fetched: "2026-03-10T08:58:09+00:00"
---

# Order Price Limit

Source: [https://bybit-exchange.github.io/docs/v5/websocket/public/order-price-limit](https://bybit-exchange.github.io/docs/v5/websocket/public/order-price-limit)
...
-   [English](/docs/v5/websocket/public/order-price-limit){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/websocket/public/order-price-limit){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Order Price Limit](/docs/v5/websocket/public/order-price-limit){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Order Price Limit]{.breadcrumbs__link itemprop="name"}
...
For derivative trading order price limit, refer to [announcement](https://announcements.bybit.com/en/article/adjustments-to-bybit-s-derivative-trading-limit-order-mechanism-blt469228de1902fff6/){target="_blank" rel="noopener noreferrer"}\
For spot trading order price limit, refer to [announcement](https://announcements.bybit.com/en/article/title-adjustments-to-bybit-s-spot-trading-limit-order-mechanism-blt786c0c5abf865983/){target="_blank" rel="noopener noreferrer"}\
...
[](/docs/v5/websocket/public/insurance-pool){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/websocket/public/adl-alert){.pagination-nav__link .pagination-nav__link--next}
