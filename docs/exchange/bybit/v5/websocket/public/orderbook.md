...
fetched: "2026-03-10T08:58:10+00:00"
---

# Orderbook

Source: [https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook](https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook)
...
-   [English](/docs/v5/websocket/public/orderbook){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/websocket/public/orderbook){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Orderbook](/docs/v5/websocket/public/orderbook){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        ...
        -   [Ticker](/docs/v5/websocket/public/ticker){.menu__link tabindex="0"}
...
[Retail Price Improvement (RPI)](https://www.bybit.com/en/help-center/article/Retail-Price-Improvement-RPI-Order){target="_blank" rel="noopener noreferrer"} orders will not be included in the messages.
...
[](/docs/v5/websocket/public/orderbook-rpi){.pagination-nav__link .pagination-nav__link--next}
