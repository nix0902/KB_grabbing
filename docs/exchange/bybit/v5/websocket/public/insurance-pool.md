...
fetched: "2026-03-10T08:58:08+00:00"
---

# Insurance Pool

Source: [https://bybit-exchange.github.io/docs/v5/websocket/public/insurance-pool](https://bybit-exchange.github.io/docs/v5/websocket/public/insurance-pool)
...
-   [English](/docs/v5/websocket/public/insurance-pool){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/websocket/public/insurance-pool){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Insurance Pool](/docs/v5/websocket/public/insurance-pool){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Insurance Pool]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/websocket/public/all-liquidation){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/websocket/public/order-price-limit){.pagination-nav__link .pagination-nav__link--next}
