...
fetched: "2026-03-10T08:58:06+00:00"
---

# ADL Alert

Source: [https://bybit-exchange.github.io/docs/v5/websocket/public/adl-alert](https://bybit-exchange.github.io/docs/v5/websocket/public/adl-alert)
...
-   [English](/docs/v5/websocket/public/adl-alert){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/websocket/public/adl-alert){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [ADL Alert](/docs/v5/websocket/public/adl-alert){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [ADL Alert]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/websocket/public/order-price-limit){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/websocket/private/position){.pagination-nav__link .pagination-nav__link--next}
