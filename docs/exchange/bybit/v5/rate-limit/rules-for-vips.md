...
fetched: "2026-03-10T08:57:07+00:00"
---

# API Rate Limit Rules for VIPs

Source: [https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-vips](https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-vips)
...
-   [English](/docs/v5/rate-limit/rules-for-vips){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rate-limit/rules-for-vips){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [API Rate Limit Rules for VIPs](/docs/v5/rate-limit/rules-for-vips){.menu__link .menu__link--active aria-current="page" tabindex="0"}

    -   
        [API Rate Limit Rules for PROs](/docs/v5/rate-limit/rules-for-pros/introduction){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
...
-   [API Rate Limit Rules for VIPs]{.breadcrumbs__link itemprop="name"}
...
## API Rate Limit Rules for VIPs[​](#api-rate-limit-rules-for-vips "Direct link to heading"){.hash-link} 
...
[](/docs/v5/rate-limit){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rate-limit/rules-for-pros/introduction){.pagination-nav__link .pagination-nav__link--next}
...
-   [API Rate Limit Rules for VIPs](#api-rate-limit-rules-for-vips){.table-of-contents__link .toc-highlight}
