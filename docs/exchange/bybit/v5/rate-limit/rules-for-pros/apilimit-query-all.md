...
Source: [https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query-all](https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query-all)
...
-   [English](/docs/v5/rate-limit/rules-for-pros/apilimit-query-all){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rate-limit/rules-for-pros/apilimit-query-all){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get All Rate Limits](/docs/v5/rate-limit/rules-for-pros/apilimit-query-all){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get All Rate Limits]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/enum){.pagination-nav__link .pagination-nav__link--next}
