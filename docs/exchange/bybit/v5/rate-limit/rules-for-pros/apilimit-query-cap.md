...
fetched: "2026-03-10T08:57:05+00:00"
---

# Get Rate Limit Cap

Source: [https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap](https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap)
...
-   [English](/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rate-limit/rules-for-pros/apilimit-query-cap){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    [Rate Limit](/docs/v5/rate-limit){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true"}
    

    -   [Rate Limit Rules](/docs/v5/rate-limit){.menu__link tabindex="0"}

    -   [API Rate Limit Rules for VIPs](/docs/v5/rate-limit/rules-for-vips){.menu__link tabindex="0"}

    -   
        [API Rate Limit Rules for PROs](/docs/v5/rate-limit/rules-for-pros/introduction){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Introduction](/docs/v5/rate-limit/rules-for-pros/introduction){.menu__link tabindex="0"}
        -   [Set Rate Limit](/docs/v5/rate-limit/rules-for-pros/apilimit-set){.menu__link tabindex="0"}
        -   [Get Rate Limit](/docs/v5/rate-limit/rules-for-pros/apilimit-query){.menu__link tabindex="0"}
        -   [Get Rate Limit Cap](/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        -   [Get All Rate Limits](/docs/v5/rate-limit/rules-for-pros/apilimit-query-all){.menu__link tabindex="0"}
...
-   [Rate Limit]{.breadcrumbs__link}
-   [API Rate Limit Rules for PROs]{.breadcrumbs__link}
-   [Get Rate Limit Cap]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rate-limit/rules-for-pros/apilimit-query){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rate-limit/rules-for-pros/apilimit-query-all){.pagination-nav__link .pagination-nav__link--next}
