...
fetched: "2026-03-10T08:57:04+00:00"
---

# Get Rate Limit

Source: [https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query](https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query)
...
-   [English](/docs/v5/rate-limit/rules-for-pros/apilimit-query){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rate-limit/rules-for-pros/apilimit-query){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Rate Limit](/docs/v5/rate-limit/rules-for-pros/apilimit-query){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        -   [Get Rate Limit Cap](/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap){.menu__link tabindex="0"}
...
-   [Get Rate Limit]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rate-limit/rules-for-pros/apilimit-set){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap){.pagination-nav__link .pagination-nav__link--next}
