...
Source: [https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/introduction](https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/introduction)
...
-   [English](/docs/v5/rate-limit/rules-for-pros/introduction){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rate-limit/rules-for-pros/introduction){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Introduction](/docs/v5/rate-limit/rules-for-pros/introduction){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
## API Rate Limit Rules for PROs[​](#api-rate-limit-rules-for-pros "Direct link to heading"){.hash-link} 



[![](data:image/svg+xml;base64,)]{.admonitionIcon_kALy}Upcoming changes for pro account



Starting **August 13, 2025**, Bybit will roll out a new institutional API rate limit framework designed to enhance performance for high-frequency trading clients. The new system introduces a centralized institution-level rate cap with flexible per-UID configurations, enabling greater efficiency and scalability. Please refer to the [announcement](https://announcements.bybit.com/en/article/update-bybit-enhances-api-rate-limits-for-institutional-traders-bltbbbf60de757d074e/){target="_blank" rel="noopener noreferrer"} for more information.



### UID-level rate limit[​](#uid-level-rate-limit "Direct link to heading"){.hash-link} 
...
### Institutional-level rate limit[​](#institutional-level-rate-limit "Direct link to heading"){.hash-link} 
...
[](/docs/v5/rate-limit/rules-for-vips){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rate-limit/rules-for-pros/apilimit-set){.pagination-nav__link .pagination-nav__link--next}
...
-   [API Rate Limit Rules for PROs](#api-rate-limit-rules-for-pros){.table-of-contents__link .toc-highlight}
    -   [UID-level rate limit](#uid-level-rate-limit){.table-of-contents__link .toc-highlight}
    -   [Institutional-level rate limit](#institutional-level-rate-limit){.table-of-contents__link .toc-highlight}
