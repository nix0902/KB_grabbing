...
fetched: "2026-03-10T08:57:06+00:00"
---

# Set Rate Limit

Source: [https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-set](https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-set)
...
-   [English](/docs/v5/rate-limit/rules-for-pros/apilimit-set){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rate-limit/rules-for-pros/apilimit-set){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Set Rate Limit](/docs/v5/rate-limit/rules-for-pros/apilimit-set){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set Rate Limit]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rate-limit/rules-for-pros/introduction){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rate-limit/rules-for-pros/apilimit-query){.pagination-nav__link .pagination-nav__link--next}
