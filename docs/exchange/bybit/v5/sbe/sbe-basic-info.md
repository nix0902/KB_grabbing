...
fetched: "2026-03-10T08:57:26+00:00"
---

# SBE Basic Information

Source: [https://bybit-exchange.github.io/docs/v5/sbe/sbe-basic-info](https://bybit-exchange.github.io/docs/v5/sbe/sbe-basic-info)
...
-   [English](/docs/v5/sbe/sbe-basic-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/sbe/sbe-basic-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [SBE Basic Information](/docs/v5/sbe/sbe-basic-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [SBE Basic Information]{.breadcrumbs__link itemprop="name"}
...
-   **PublicTrade SBE** (not available until Spot: 26 Feb, Futures: 19 Mar, 2026)

## What is SBE?[​](#what-is-sbe "Direct link to heading"){.hash-link} 
...
## SBE Connection Limit[​](#sbe-connection-limit "Direct link to heading"){.hash-link} 
...
## Behavior Of PreLaunch Contracts[​](#behavior-of-prelaunch-contracts "Direct link to heading"){.hash-link} 

-   There is no feed until `ContinuousTrading` stage for orderbook & publicTrade

## SBE XML Template[​](#sbe-xml-template "Direct link to heading"){.hash-link} 



``` {.prism-code .language-xml .codeBlock_bY9V .thin-scrollbar tabindex="0"}
...
[](/docs/v5/earn/hourly-yield){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/sbe/bbo/sbe-bbo){.pagination-nav__link .pagination-nav__link--next}
...
-   [What is SBE?](#what-is-sbe){.table-of-contents__link .toc-highlight}
-   [SBE Connection Limit](#sbe-connection-limit){.table-of-contents__link .toc-highlight}
-   [Behavior Of PreLaunch Contracts](#behavior-of-prelaunch-contracts){.table-of-contents__link .toc-highlight}
-   [SBE XML Template](#sbe-xml-template){.table-of-contents__link .toc-highlight}
