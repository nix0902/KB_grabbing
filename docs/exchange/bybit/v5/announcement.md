...
Source: [https://bybit-exchange.github.io/docs/v5/announcement](https://bybit-exchange.github.io/docs/v5/announcement)
...
-   [English](/docs/v5/announcement){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/announcement){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   [Get Announcement](/docs/v5/announcement){.menu__link .menu__link--active aria-current="page"}
...
-   [Get Announcement]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/guide){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/smp){.pagination-nav__link .pagination-nav__link--next}
