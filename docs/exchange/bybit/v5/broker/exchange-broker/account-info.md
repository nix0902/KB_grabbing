...
fetched: "2026-03-10T08:55:28+00:00"
---

# Get Account Info

Source: [https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/account-info](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/account-info)
...
-   [English](/docs/v5/broker/exchange-broker/account-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/broker/exchange-broker/account-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Account Info](/docs/v5/broker/exchange-broker/account-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Account Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/broker/exchange-broker/exchange-earning){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/broker/exchange-broker/sub-deposit-record){.pagination-nav__link .pagination-nav__link--next}
