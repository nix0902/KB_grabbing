...
url: "https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/set"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:55:32+00:00"
---

# Set Rate Limit

Source: [https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/set](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/set)
...
-   [English](/docs/v5/broker/exchange-broker/rate-limit/set){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/broker/exchange-broker/rate-limit/set){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            ...
            -   [Set Rate Limit](/docs/v5/broker/exchange-broker/rate-limit/set){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/broker/exchange-broker/rate-limit/introduction){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/broker/exchange-broker/rate-limit/query-cap){.pagination-nav__link .pagination-nav__link--next}
