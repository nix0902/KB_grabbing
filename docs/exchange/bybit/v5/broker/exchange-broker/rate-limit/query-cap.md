...
url: "https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-cap"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:55:31+00:00"
---

# Get Rate Limit Cap

Source: [https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-cap](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-cap)
...
-   [English](/docs/v5/broker/exchange-broker/rate-limit/query-cap){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/broker/exchange-broker/rate-limit/query-cap){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            ...
            -   [Introduction](/docs/v5/broker/exchange-broker/rate-limit/introduction){.menu__link tabindex="0"}
            -   [Set Rate Limit](/docs/v5/broker/exchange-broker/rate-limit/set){.menu__link tabindex="0"}
            -   [Get Rate Limit Cap](/docs/v5/broker/exchange-broker/rate-limit/query-cap){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/broker/exchange-broker/rate-limit/set){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/broker/exchange-broker/rate-limit/query-all){.pagination-nav__link .pagination-nav__link--next}
