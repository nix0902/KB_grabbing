...
url: "https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-all"
...
Source: [https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-all](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-all)
...
-   [English](/docs/v5/broker/exchange-broker/rate-limit/query-all){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/broker/exchange-broker/rate-limit/query-all){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            ...
            -   [Get All Rate Limits](/docs/v5/broker/exchange-broker/rate-limit/query-all){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/broker/exchange-broker/rate-limit/query-cap){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/broker/reward/voucher){.pagination-nav__link .pagination-nav__link--next}
