---
title: "Introduction"
url: "https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/introduction"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:55:30+00:00"
---

# Introduction

Source: [https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/introduction](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/introduction)
...
-   [English](/docs/v5/broker/exchange-broker/rate-limit/introduction){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/broker/exchange-broker/rate-limit/introduction){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Earning](/docs/v5/broker/exchange-broker/exchange-earning){.menu__link tabindex="0"}
        ...
        -   
            [Rate Limit Setup](/docs/v5/broker/exchange-broker/rate-limit/introduction){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
            

            -   [Introduction](/docs/v5/broker/exchange-broker/rate-limit/introduction){.menu__link .menu__link--active aria-current="page" tabindex="0"}
            -   [Set Rate Limit](/docs/v5/broker/exchange-broker/rate-limit/set){.menu__link tabindex="0"}
            -   [Get Rate Limit Cap](/docs/v5/broker/exchange-broker/rate-limit/query-cap){.menu__link tabindex="0"}
            -   [Get All Rate Limits](/docs/v5/broker/exchange-broker/rate-limit/query-all){.menu__link tabindex="0"}
...
-   [Rate Limit Setup]{.breadcrumbs__link}
...
## API Rate Limit For Exchange Broker Client[​](#api-rate-limit-for-exchange-broker-client "Direct link to heading"){.hash-link} 
...
## Default Rate limit[​](#default-rate-limit "Direct link to heading"){.hash-link} 
...
[](/docs/v5/broker/exchange-broker/sub-deposit-record){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/broker/exchange-broker/rate-limit/set){.pagination-nav__link .pagination-nav__link--next}
...
-   [API Rate Limit For Exchange Broker Client](#api-rate-limit-for-exchange-broker-client){.table-of-contents__link .toc-highlight}
-   [Default Rate limit](#default-rate-limit){.table-of-contents__link .toc-highlight}
