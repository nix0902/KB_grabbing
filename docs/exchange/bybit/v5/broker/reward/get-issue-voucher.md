...
fetched: "2026-03-10T08:55:33+00:00"
---

# Get Issued Voucher

Source: [https://bybit-exchange.github.io/docs/v5/broker/reward/get-issue-voucher](https://bybit-exchange.github.io/docs/v5/broker/reward/get-issue-voucher)
...
-   [English](/docs/v5/broker/reward/get-issue-voucher){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/broker/reward/get-issue-voucher){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            [Reward](/docs/v5/broker/reward/voucher){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
            

            -   [Get Voucher Spec](/docs/v5/broker/reward/voucher){.menu__link tabindex="0"}
            -   [Issue Voucher](/docs/v5/broker/reward/issue-voucher){.menu__link tabindex="0"}
            -   [Get Issued Voucher](/docs/v5/broker/reward/get-issue-voucher){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Reward]{.breadcrumbs__link}
-   [Get Issued Voucher]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/broker/reward/issue-voucher){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/earn/product-info){.pagination-nav__link .pagination-nav__link--next}
