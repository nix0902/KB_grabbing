...
fetched: "2026-03-10T08:55:35+00:00"
---

# Get Voucher Spec

Source: [https://bybit-exchange.github.io/docs/v5/broker/reward/voucher](https://bybit-exchange.github.io/docs/v5/broker/reward/voucher)
...
-   [English](/docs/v5/broker/reward/voucher){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/broker/reward/voucher){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            ...
            -   [Get Voucher Spec](/docs/v5/broker/reward/voucher){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Voucher Spec]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/broker/exchange-broker/rate-limit/query-all){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/broker/reward/issue-voucher){.pagination-nav__link .pagination-nav__link--next}
