...
fetched: "2026-03-10T08:56:07+00:00"
---

# Get Order Price Limit

Source: [https://bybit-exchange.github.io/docs/v5/market/order-price-limit](https://bybit-exchange.github.io/docs/v5/market/order-price-limit)
...
-   [English](/docs/v5/market/order-price-limit){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/order-price-limit){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Order Price Limit](/docs/v5/market/order-price-limit){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Order Price Limit]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/market/index-components){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/adl-alert){.pagination-nav__link .pagination-nav__link--next}
