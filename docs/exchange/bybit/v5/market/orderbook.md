...
fetched: "2026-03-10T08:56:08+00:00"
---

# Get Orderbook

Source: [https://bybit-exchange.github.io/docs/v5/market/orderbook](https://bybit-exchange.github.io/docs/v5/market/orderbook)
...
-   [English](/docs/v5/market/orderbook){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/orderbook){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Orderbook](/docs/v5/market/orderbook){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    -   [Get RPI Orderbook](/docs/v5/market/rpi-orderbook){.menu__link tabindex="0"}
    -   [Get Tickers](/docs/v5/market/tickers){.menu__link tabindex="0"}
...
-   [Retail Price Improvement (RPI)](https://www.bybit.com/en/help-center/article/Retail-Price-Improvement-RPI-Order){target="_blank" rel="noopener noreferrer"} orders will not be included in the response message and will not be visible over API.
...
|                       |                       |                                                                                                                                                                                                     |
|                       |                       | -   For contract, corresponds to `u` in the 1000-level [WebSocket orderbook stream](https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook){target="_blank" rel="noopener noreferrer"} |
|                       |                       | -   For spot, corresponds to `u` in the 1000-level [WebSocket orderbook stream](https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook){target="_blank" rel="noopener noreferrer"}     |
+-----------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
[](/docs/v5/market/instrument){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/rpi-orderbook){.pagination-nav__link .pagination-nav__link--next}
