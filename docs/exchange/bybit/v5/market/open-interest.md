...
Source: [https://bybit-exchange.github.io/docs/v5/market/open-interest](https://bybit-exchange.github.io/docs/v5/market/open-interest)
...
-   [English](/docs/v5/market/open-interest){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/open-interest){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Open Interest](/docs/v5/market/open-interest){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Open Interest]{.breadcrumbs__link itemprop="name"}
...
Get the [open interest](https://www.bybit.com/en-US/help-center/s/article/Glossary-Bybit-Trading-Terms){target="_blank" rel="noopener noreferrer"} of each symbol.
...
[](/docs/v5/market/recent-trade){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/iv){.pagination-nav__link .pagination-nav__link--next}
