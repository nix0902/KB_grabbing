...
fetched: "2026-03-10T08:56:06+00:00"
---

# Get New Delivery Price

Source: [https://bybit-exchange.github.io/docs/v5/market/new-delivery-price](https://bybit-exchange.github.io/docs/v5/market/new-delivery-price)
...
-   [English](/docs/v5/market/new-delivery-price){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/new-delivery-price){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get New Delivery Price](/docs/v5/market/new-delivery-price){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get New Delivery Price]{.breadcrumbs__link itemprop="name"}
...
### Request Parameters[​](#request-parameters "Direct link to heading"){.hash-link} 
  ...
  ------------------------------------ ---------- -------- ------------------------------------------------------
  [category](/docs/v5/enum#category)   **true**   string   Product type. *Valid for `option` only*
...
[](/docs/v5/market/delivery-price){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/long-short-ratio){.pagination-nav__link .pagination-nav__link--next}
