...
Source: [https://bybit-exchange.github.io/docs/v5/market/time](https://bybit-exchange.github.io/docs/v5/market/time)
...
-   [English](/docs/v5/market/time){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/time){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Bybit Server Time](/docs/v5/market/time){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Bybit Server Time]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/system-status){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/kline){.pagination-nav__link .pagination-nav__link--next}
