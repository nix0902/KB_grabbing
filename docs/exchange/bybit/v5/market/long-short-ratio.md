...
fetched: "2026-03-10T08:56:04+00:00"
---

# Get Long Short Ratio

Source: [https://bybit-exchange.github.io/docs/v5/market/long-short-ratio](https://bybit-exchange.github.io/docs/v5/market/long-short-ratio)
...
-   [English](/docs/v5/market/long-short-ratio){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/long-short-ratio){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Long Short Ratio](/docs/v5/market/long-short-ratio){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Long Short Ratio]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/market/new-delivery-price){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/index-components){.pagination-nav__link .pagination-nav__link--next}
