...
fetched: "2026-03-10T08:55:58+00:00"
---

# Get Funding Rate History

Source: [https://bybit-exchange.github.io/docs/v5/market/history-fund-rate](https://bybit-exchange.github.io/docs/v5/market/history-fund-rate)
...
-   [English](/docs/v5/market/history-fund-rate){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/history-fund-rate){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Funding Rate History](/docs/v5/market/history-fund-rate){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Funding Rate History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/market/tickers){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/recent-trade){.pagination-nav__link .pagination-nav__link--next}
