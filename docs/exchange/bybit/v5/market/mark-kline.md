...
fetched: "2026-03-10T08:56:05+00:00"
---

# Get Mark Price Kline

Source: [https://bybit-exchange.github.io/docs/v5/market/mark-kline](https://bybit-exchange.github.io/docs/v5/market/mark-kline)
...
-   [English](/docs/v5/market/mark-kline){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/mark-kline){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Mark Price Kline](/docs/v5/market/mark-kline){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Mark Price Kline]{.breadcrumbs__link itemprop="name"}
...
Query for historical [mark price](https://www.bybit.com/en-US/help-center/s/article/Glossary-Bybit-Trading-Terms){target="_blank" rel="noopener noreferrer"} klines. Charts are returned in groups based on the requested interval.
...
[](/docs/v5/market/kline){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/index-kline){.pagination-nav__link .pagination-nav__link--next}
