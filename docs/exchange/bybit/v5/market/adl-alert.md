...
fetched: "2026-03-10T08:55:56+00:00"
---

# Get ADL Alert

Source: [https://bybit-exchange.github.io/docs/v5/market/adl-alert](https://bybit-exchange.github.io/docs/v5/market/adl-alert)
...
-   [English](/docs/v5/market/adl-alert){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/adl-alert){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get ADL Alert](/docs/v5/market/adl-alert){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get ADL Alert]{.breadcrumbs__link itemprop="name"}
...
Query for [ADL](https://www.bybit.com/en/help-center/article/Auto-Deleveraging-ADL){target="_blank" rel="noopener noreferrer"} (auto-deleveraging mechanism) alerts and insurance pool information.
...
[![](data:image/svg+xml;base64,)]{.admonitionIcon_kALy}ADL examples: Triggered by PnL Drawdown and Insurance Pool Balance
...
[](/docs/v5/market/order-price-limit){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/fee-group-info){.pagination-nav__link .pagination-nav__link--next}
