...
Source: [https://bybit-exchange.github.io/docs/v5/market/recent-trade](https://bybit-exchange.github.io/docs/v5/market/recent-trade)
...
-   [English](/docs/v5/market/recent-trade){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/recent-trade){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Recent Public Trades](/docs/v5/market/recent-trade){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
You can download archived historical trades from the [website](https://www.bybit.com/derivatives/en/history-data){target="_blank" rel="noopener noreferrer"}
...
[](/docs/v5/market/history-fund-rate){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/open-interest){.pagination-nav__link .pagination-nav__link--next}
