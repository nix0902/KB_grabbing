...
fetched: "2026-03-10T08:56:11+00:00"
---

# Get RPI Orderbook

Source: [https://bybit-exchange.github.io/docs/v5/market/rpi-orderbook](https://bybit-exchange.github.io/docs/v5/market/rpi-orderbook)
...
-   [English](/docs/v5/market/rpi-orderbook){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/rpi-orderbook){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get RPI Orderbook](/docs/v5/market/rpi-orderbook){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get RPI Orderbook]{.breadcrumbs__link itemprop="name"}
...
+-----------------------+-----------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| u                     | integer               | Update ID, is always in sequence corresponds to `u` in the 50-level [WebSocket RPI orderbook stream](https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook-rpi){target="_blank" rel="noopener noreferrer"} |
+-----------------------+-----------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
[](/docs/v5/market/orderbook){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/tickers){.pagination-nav__link .pagination-nav__link--next}
