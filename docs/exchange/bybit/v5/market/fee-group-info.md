...
Source: [https://bybit-exchange.github.io/docs/v5/market/fee-group-info](https://bybit-exchange.github.io/docs/v5/market/fee-group-info)
...
-   [English](/docs/v5/market/fee-group-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/fee-group-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Fee Group Structure](/docs/v5/market/fee-group-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Fee Group Structure]{.breadcrumbs__link itemprop="name"}
...
Query for the [group fee structure](https://www.bybit.com/en/help-center/article/Group-Fee-Structure-Symbol-Grouping){target="_blank" rel="noopener noreferrer"} and fee rates.
...
For more details please refer to the [fee structure update announcement](https://announcements.bybit.com/article/bybit-fee-structure-update-for-pro-and-market-maker-clients-blt06875b6d623e7581/){target="_blank" rel="noopener noreferrer"}.
...
### Request Parameters[​](#request-parameters "Direct link to heading"){.hash-link} 
  ...
  [groupId](/docs/v5/enum#groupid)   false      string   Group ID. `1`, `2`, `3`, `4`, `5`, `6`, `7`, `8`
...
[](/docs/v5/market/adl-alert){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/order/create-order){.pagination-nav__link .pagination-nav__link--next}
