...
fetched: "2026-03-10T08:56:00+00:00"
---

# Get Index Price Kline

Source: [https://bybit-exchange.github.io/docs/v5/market/index-kline](https://bybit-exchange.github.io/docs/v5/market/index-kline)
...
-   [English](/docs/v5/market/index-kline){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/index-kline){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Index Price Kline](/docs/v5/market/index-kline){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Index Price Kline]{.breadcrumbs__link itemprop="name"}
...
Query for historical [index price](https://www.bybit.com/en-US/help-center/s/article/Glossary-Bybit-Trading-Terms){target="_blank" rel="noopener noreferrer"} klines. Charts are returned in groups based on the requested interval.
...
[](/docs/v5/market/mark-kline){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/premium-index-kline){.pagination-nav__link .pagination-nav__link--next}
