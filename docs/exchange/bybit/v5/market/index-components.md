...
fetched: "2026-03-10T08:55:59+00:00"
---

# Get Index Price Components

Source: [https://bybit-exchange.github.io/docs/v5/market/index-components](https://bybit-exchange.github.io/docs/v5/market/index-components)
...
-   [English](/docs/v5/market/index-components){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/index-components){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Index Price Components](/docs/v5/market/index-components){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Index Price Components]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/market/long-short-ratio){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/order-price-limit){.pagination-nav__link .pagination-nav__link--next}
