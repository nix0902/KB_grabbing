...
fetched: "2026-03-10T08:56:10+00:00"
---

# Get Risk Limit

Source: [https://bybit-exchange.github.io/docs/v5/market/risk-limit](https://bybit-exchange.github.io/docs/v5/market/risk-limit)
...
-   [English](/docs/v5/market/risk-limit){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/risk-limit){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Risk Limit](/docs/v5/market/risk-limit){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Risk Limit]{.breadcrumbs__link itemprop="name"}
...
Query for the [risk limit](https://www.bybit.com/en/help-center/article/Risk-Limit-Perpetual-and-Futures){target="_blank" rel="noopener noreferrer"} margin parameters. This information is also displayed on the website [here](https://www.bybit.com/en/announcement-info/margin-parameters/){target="_blank" rel="noopener noreferrer"}.
...
-   `symbol` support `Trading` status and `PreLaunch` [Pre-Market contracts](https://www.bybit.com/en/help-center/article/Introduction-to-Pre-Market-Perpetual){target="_blank" rel="noopener noreferrer"} status trading pairs.
...
[](/docs/v5/market/insurance){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/delivery-price){.pagination-nav__link .pagination-nav__link--next}
