...
fetched: "2026-03-10T08:56:09+00:00"
---

# Get Premium Index Price Kline

Source: [https://bybit-exchange.github.io/docs/v5/market/premium-index-kline](https://bybit-exchange.github.io/docs/v5/market/premium-index-kline)
...
-   [English](/docs/v5/market/premium-index-kline){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/premium-index-kline){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Premium Index Price Kline](/docs/v5/market/premium-index-kline){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Premium Index Price Kline]{.breadcrumbs__link itemprop="name"}
...
Query for historical [premium index](https://www.bybit.com/data/basic/linear/index-price/premium-index?symbol=BTCUSDT){target="_blank" rel="noopener noreferrer"} klines. Charts are returned in groups based on the requested interval.
...
[](/docs/v5/market/index-kline){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/instrument){.pagination-nav__link .pagination-nav__link--next}
