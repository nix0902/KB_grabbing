...
fetched: "2026-03-10T08:56:02+00:00"
---

# Get Insurance Pool

Source: [https://bybit-exchange.github.io/docs/v5/market/insurance](https://bybit-exchange.github.io/docs/v5/market/insurance)
...
-   [English](/docs/v5/market/insurance){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/insurance){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Insurance Pool](/docs/v5/market/insurance){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Insurance Pool]{.breadcrumbs__link itemprop="name"}
...
Query for Bybit [insurance pool](https://www.bybit.com/en/announcement-info/insurance-fund/){target="_blank" rel="noopener noreferrer"} data (BTC/USDT/USDC etc)
...
[](/docs/v5/market/iv){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/risk-limit){.pagination-nav__link .pagination-nav__link--next}
