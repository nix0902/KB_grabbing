...
fetched: "2026-03-10T08:56:03+00:00"
---

# Get Kline

Source: [https://bybit-exchange.github.io/docs/v5/market/kline](https://bybit-exchange.github.io/docs/v5/market/kline)
...
-   [English](/docs/v5/market/kline){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/market/kline){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Kline](/docs/v5/market/kline){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Kline]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/market/time){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/mark-kline){.pagination-nav__link .pagination-nav__link--next}
