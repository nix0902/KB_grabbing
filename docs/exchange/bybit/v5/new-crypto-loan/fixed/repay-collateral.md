...
fetched: "2026-03-10T08:56:22+00:00"
---

# Collateral Repayment

Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/repay-collateral](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/repay-collateral)
...
-   [English](/docs/v5/new-crypto-loan/fixed/repay-collateral){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/fixed/repay-collateral){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    [Crypto Loan (New)](/docs/v5/new-crypto-loan/loan-coin){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true"}
    

    -   [Get Borrowable Coins](/docs/v5/new-crypto-loan/loan-coin){.menu__link tabindex="0"}

    -   [Get Collateral Coins](/docs/v5/new-crypto-loan/collateral-coin){.menu__link tabindex="0"}

    -   [Get Max. Allowed Collateral Reduction Amount](/docs/v5/new-crypto-loan/reduce-max-collateral-amt){.menu__link tabindex="0"}

    -   [Adjust Collateral Amount](/docs/v5/new-crypto-loan/adjust-collateral){.menu__link tabindex="0"}

    -   [Get Collateral Adjustment History](/docs/v5/new-crypto-loan/ltv-adjust-history){.menu__link tabindex="0"}

    -   [Get Crypto Loan Position](/docs/v5/new-crypto-loan/crypto-loan-position){.menu__link tabindex="0"}

    -   [Obtain Max Loan Amount](/docs/v5/new-crypto-loan/max-loan-amt){.menu__link tabindex="0"}

    -   
        [Flexible Loan](/docs/v5/new-crypto-loan/flexible/borrow){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
        

    -   
        [Fixed Loan](/docs/v5/new-crypto-loan/fixed/supply-market){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Get Lending Market](/docs/v5/new-crypto-loan/fixed/supply-market){.menu__link tabindex="0"}
        -   [Get Borrowing Market](/docs/v5/new-crypto-loan/fixed/borrow-market){.menu__link tabindex="0"}
        -   [Create Borrow Order](/docs/v5/new-crypto-loan/fixed/borrow){.menu__link tabindex="0"}
        -   [Renew Borrow Order](/docs/v5/new-crypto-loan/fixed/renew){.menu__link tabindex="0"}
        -   [Create Supply Order](/docs/v5/new-crypto-loan/fixed/supply){.menu__link tabindex="0"}
        -   [Cancel Borrow Order](/docs/v5/new-crypto-loan/fixed/cancel-borrow){.menu__link tabindex="0"}
        -   [Cancel Supply Order](/docs/v5/new-crypto-loan/fixed/cancel-supply){.menu__link tabindex="0"}
        -   [Get Borrow Contract Info](/docs/v5/new-crypto-loan/fixed/borrow-contract){.menu__link tabindex="0"}
        -   [Get Supply Contract Info](/docs/v5/new-crypto-loan/fixed/supply-contract%20copy){.menu__link tabindex="0"}
        -   [Get Borrow Order Info](/docs/v5/new-crypto-loan/fixed/borrow-order){.menu__link tabindex="0"}
        -   [Get Renew Order Info](/docs/v5/new-crypto-loan/fixed/renew-order){.menu__link tabindex="0"}
        -   [Get Supply Order Info](/docs/v5/new-crypto-loan/fixed/supply-order){.menu__link tabindex="0"}
        -   [Repay](/docs/v5/new-crypto-loan/fixed/repay){.menu__link tabindex="0"}
        -   [Collateral Repayment](/docs/v5/new-crypto-loan/fixed/repay-collateral){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        -   [Get Repayment History](/docs/v5/new-crypto-loan/fixed/repay-history){.menu__link tabindex="0"}
...
-   [Crypto Loan (New)]{.breadcrumbs__link}
-   [Fixed Loan]{.breadcrumbs__link}
-   [Collateral Repayment]{.breadcrumbs__link itemprop="name"}
...
There are limits on the repayment amount in a single transaction. Please read this [announcement](https://announcements.bybit.com/article/crypto-loan-manual-repayment-update-bltde33509ddde5e8fd/){target="_blank" rel="noopener noreferrer"} before repaying with collateral.\
When repaying with collateral, Bybit will charge a repayment fee. The applicable fee rate is the higher of the repayment fee rates for the collateral asset and the debt asset. You can call this endpoint: [View fee rates by asset](https://www.bybit.com/x-api/spot/api/fixed-loan/v1/coin-config){target="_blank" rel="noopener noreferrer"} to get \"reapyFee\" where \"pledgeEnable\" = 1 for coins\' repayment fee rates.
...
[](/docs/v5/new-crypto-loan/fixed/repay){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/fixed/repay-history){.pagination-nav__link .pagination-nav__link--next}
