...
Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/borrow](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/borrow)
...
-   [English](/docs/v5/new-crypto-loan/fixed/borrow){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/fixed/borrow){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Create Borrow Order](/docs/v5/new-crypto-loan/fixed/borrow){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Create Borrow Order]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/new-crypto-loan/fixed/borrow-market){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/fixed/renew){.pagination-nav__link .pagination-nav__link--next}
