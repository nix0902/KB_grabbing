...
fetched: "2026-03-10T08:56:16+00:00"
---

# Get Borrow Contract Info

Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/borrow-contract](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/borrow-contract)
...
-   [English](/docs/v5/new-crypto-loan/fixed/borrow-contract){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/fixed/borrow-contract){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Borrow Contract Info](/docs/v5/new-crypto-loan/fixed/borrow-contract){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Borrow Contract Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/new-crypto-loan/fixed/cancel-supply){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/fixed/supply-contract%20copy){.pagination-nav__link .pagination-nav__link--next}
