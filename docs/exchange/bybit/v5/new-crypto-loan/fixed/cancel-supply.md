...
fetched: "2026-03-10T08:56:19+00:00"
---

# Cancel Supply Order

Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/cancel-supply](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/cancel-supply)
...
-   [English](/docs/v5/new-crypto-loan/fixed/cancel-supply){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/fixed/cancel-supply){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Cancel Supply Order](/docs/v5/new-crypto-loan/fixed/cancel-supply){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Cancel Supply Order]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/new-crypto-loan/fixed/cancel-borrow){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/fixed/borrow-contract){.pagination-nav__link .pagination-nav__link--next}
