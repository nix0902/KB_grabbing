...
Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/cancel-borrow](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/cancel-borrow)
...
-   [English](/docs/v5/new-crypto-loan/fixed/cancel-borrow){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/fixed/cancel-borrow){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Cancel Borrow Order](/docs/v5/new-crypto-loan/fixed/cancel-borrow){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Cancel Borrow Order]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/new-crypto-loan/fixed/supply){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/fixed/cancel-supply){.pagination-nav__link .pagination-nav__link--next}
