...
fetched: "2026-03-10T08:56:18+00:00"
---

# Get Borrow Order Info

Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/borrow-order](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/borrow-order)
...
-   [English](/docs/v5/new-crypto-loan/fixed/borrow-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/fixed/borrow-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Borrow Order Info](/docs/v5/new-crypto-loan/fixed/borrow-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Borrow Order Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/new-crypto-loan/fixed/supply-contract%20copy){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/fixed/renew-order){.pagination-nav__link .pagination-nav__link--next}
