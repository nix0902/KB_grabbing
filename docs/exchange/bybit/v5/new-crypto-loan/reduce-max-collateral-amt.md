...
fetched: "2026-03-10T08:56:33+00:00"
---

# Get Max. Allowed Collateral Reduction Amount

Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/reduce-max-collateral-amt](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/reduce-max-collateral-amt)
...
-   [English](/docs/v5/new-crypto-loan/reduce-max-collateral-amt){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/reduce-max-collateral-amt){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Max. Allowed Collateral Reduction Amount](/docs/v5/new-crypto-loan/reduce-max-collateral-amt){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Max. Allowed Collateral Reduction Amount]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/new-crypto-loan/collateral-coin){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/adjust-collateral){.pagination-nav__link .pagination-nav__link--next}
