...
Source: [https://bybit-exchange.github.io/docs/v5/new-crypto-loan/max-loan-amt](https://bybit-exchange.github.io/docs/v5/new-crypto-loan/max-loan-amt)
...
-   [English](/docs/v5/new-crypto-loan/max-loan-amt){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/new-crypto-loan/max-loan-amt){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Obtain Max Loan Amount](/docs/v5/new-crypto-loan/max-loan-amt){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Obtain Max Loan Amount]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/new-crypto-loan/crypto-loan-position){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/new-crypto-loan/flexible/borrow){.pagination-nav__link .pagination-nav__link--next}
