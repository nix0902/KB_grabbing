...
Source: [https://bybit-exchange.github.io/docs/v5/earn/hourly-yield](https://bybit-exchange.github.io/docs/v5/earn/hourly-yield)
...
-   [English](/docs/v5/earn/hourly-yield){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/earn/hourly-yield){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Hourly Yield History](/docs/v5/earn/hourly-yield){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Hourly Yield History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/earn/yield-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/sbe/sbe-basic-info){.pagination-nav__link .pagination-nav__link--next}
