...
fetched: "2026-03-10T08:55:47+00:00"
---

# Get Staked Position

Source: [https://bybit-exchange.github.io/docs/v5/earn/position](https://bybit-exchange.github.io/docs/v5/earn/position)
...
-   [English](/docs/v5/earn/position){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/earn/position){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Staked Position](/docs/v5/earn/position){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Staked Position]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/earn/order-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/earn/yield-history){.pagination-nav__link .pagination-nav__link--next}
