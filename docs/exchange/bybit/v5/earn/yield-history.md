...
fetched: "2026-03-10T08:55:49+00:00"
---

# Get Yield History

Source: [https://bybit-exchange.github.io/docs/v5/earn/yield-history](https://bybit-exchange.github.io/docs/v5/earn/yield-history)
...
-   [English](/docs/v5/earn/yield-history){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/earn/yield-history){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Yield History](/docs/v5/earn/yield-history){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Yield History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/earn/position){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/earn/hourly-yield){.pagination-nav__link .pagination-nav__link--next}
