...
fetched: "2026-03-10T08:55:46+00:00"
---

# Get Stake/Redeem Order History

Source: [https://bybit-exchange.github.io/docs/v5/earn/order-history](https://bybit-exchange.github.io/docs/v5/earn/order-history)
...
-   [English](/docs/v5/earn/order-history){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/earn/order-history){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Product Info](/docs/v5/earn/product-info){.menu__link tabindex="0"}
    -   [Stake / Redeem](/docs/v5/earn/create-order){.menu__link tabindex="0"}
    -   [Get Stake/Redeem Order History](/docs/v5/earn/order-history){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Stake/Redeem Order History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/earn/create-order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/earn/position){.pagination-nav__link .pagination-nav__link--next}
