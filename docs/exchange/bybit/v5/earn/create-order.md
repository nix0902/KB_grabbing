...
fetched: "2026-03-10T08:55:45+00:00"
---

# Stake / Redeem

Source: [https://bybit-exchange.github.io/docs/v5/earn/create-order](https://bybit-exchange.github.io/docs/v5/earn/create-order)
...
-   [English](/docs/v5/earn/create-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/earn/create-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Stake / Redeem](/docs/v5/earn/create-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Stake / Redeem]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/earn/product-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/earn/order-history){.pagination-nav__link .pagination-nav__link--next}
