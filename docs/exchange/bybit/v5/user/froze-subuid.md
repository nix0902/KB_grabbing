...
Source: [https://bybit-exchange.github.io/docs/v5/user/froze-subuid](https://bybit-exchange.github.io/docs/v5/user/froze-subuid)
...
-   [English](/docs/v5/user/froze-subuid){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/froze-subuid){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Freeze Sub UID](/docs/v5/user/froze-subuid){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Freeze Sub UID]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/fund-subuid-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/apikey-info){.pagination-nav__link .pagination-nav__link--next}
