...
fetched: "2026-03-10T08:57:51+00:00"
---

# Create Sub UID API Key

Source: [https://bybit-exchange.github.io/docs/v5/user/create-subuid-apikey](https://bybit-exchange.github.io/docs/v5/user/create-subuid-apikey)
...
-   [English](/docs/v5/user/create-subuid-apikey){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/create-subuid-apikey){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Create Sub UID API Key](/docs/v5/user/create-subuid-apikey){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Create Sub UID API Key]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/create-subuid){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/subuid-list){.pagination-nav__link .pagination-nav__link--next}
