...
Source: [https://bybit-exchange.github.io/docs/v5/user/modify-sub-apikey](https://bybit-exchange.github.io/docs/v5/user/modify-sub-apikey)
...
-   [English](/docs/v5/user/modify-sub-apikey){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/modify-sub-apikey){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Modify Sub API Key](/docs/v5/user/modify-sub-apikey){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Modify Sub API Key]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/modify-master-apikey){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/rm-subuid){.pagination-nav__link .pagination-nav__link--next}
