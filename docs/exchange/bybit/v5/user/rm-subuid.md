...
Source: [https://bybit-exchange.github.io/docs/v5/user/rm-subuid](https://bybit-exchange.github.io/docs/v5/user/rm-subuid)
...
-   [English](/docs/v5/user/rm-subuid){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/rm-subuid){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Delete Sub UID](/docs/v5/user/rm-subuid){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Delete Sub UID]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/modify-sub-apikey){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/rm-master-apikey){.pagination-nav__link .pagination-nav__link--next}
