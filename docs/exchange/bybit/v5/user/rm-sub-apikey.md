...
fetched: "2026-03-10T08:57:58+00:00"
---

# Delete Sub API Key

Source: [https://bybit-exchange.github.io/docs/v5/user/rm-sub-apikey](https://bybit-exchange.github.io/docs/v5/user/rm-sub-apikey)
...
-   [English](/docs/v5/user/rm-sub-apikey){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/rm-sub-apikey){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Delete Sub API Key](/docs/v5/user/rm-sub-apikey){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Delete Sub API Key]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/rm-master-apikey){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/friend-referral){.pagination-nav__link .pagination-nav__link--next}
