...
fetched: "2026-03-10T08:57:55+00:00"
---

# Modify Master API Key

Source: [https://bybit-exchange.github.io/docs/v5/user/modify-master-apikey](https://bybit-exchange.github.io/docs/v5/user/modify-master-apikey)
...
-   [English](/docs/v5/user/modify-master-apikey){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/modify-master-apikey){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Modify Master API Key](/docs/v5/user/modify-master-apikey){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Modify Master API Key]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/wallet-type){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/modify-sub-apikey){.pagination-nav__link .pagination-nav__link--next}
