...
url: "https://bybit-exchange.github.io/docs/v5/user/sign-agreement"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:57:59+00:00"
---

# Sign Agreement

Source: [https://bybit-exchange.github.io/docs/v5/user/sign-agreement](https://bybit-exchange.github.io/docs/v5/user/sign-agreement)
...
-   [English](/docs/v5/user/sign-agreement){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/sign-agreement){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Sign Agreement](/docs/v5/user/sign-agreement){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Sign Agreement]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/fiat-convert/trade-notify){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/create-subuid){.pagination-nav__link .pagination-nav__link--next}
