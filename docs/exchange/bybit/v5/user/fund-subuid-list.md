...
fetched: "2026-03-10T08:57:53+00:00"
---

# Get Fund Custodial Sub Acct

Source: [https://bybit-exchange.github.io/docs/v5/user/fund-subuid-list](https://bybit-exchange.github.io/docs/v5/user/fund-subuid-list)
...
-   [English](/docs/v5/user/fund-subuid-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/fund-subuid-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Fund Custodial Sub Acct](/docs/v5/user/fund-subuid-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Fund Custodial Sub Acct]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/page-subuid){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/froze-subuid){.pagination-nav__link .pagination-nav__link--next}
