...
fetched: "2026-03-10T08:57:56+00:00"
---

# Get Sub UID List (Unlimited)

Source: [https://bybit-exchange.github.io/docs/v5/user/page-subuid](https://bybit-exchange.github.io/docs/v5/user/page-subuid)
...
-   [English](/docs/v5/user/page-subuid){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/page-subuid){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Create Sub UID](/docs/v5/user/create-subuid){.menu__link tabindex="0"}
    ...
    -   [Get Sub UID List (Unlimited)](/docs/v5/user/page-subuid){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Sub UID List (Unlimited)]{.breadcrumbs__link itemprop="name"}
...
+-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+
| \> memberType         | integer               | `1`: standard subaccount, `6`: [custodial subaccount](https://www.bybit.com/en/help-center/article?id=000001683){target="_blank" rel="noopener noreferrer"} |
+-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
[](/docs/v5/user/subuid-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/fund-subuid-list){.pagination-nav__link .pagination-nav__link--next}
