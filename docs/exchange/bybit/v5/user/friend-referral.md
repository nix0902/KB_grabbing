...
url: "https://bybit-exchange.github.io/docs/v5/user/friend-referral"
source: "https://bybit-exchange.github.io/docs/"
fetched: "2026-03-10T08:57:52+00:00"
---

# Get Friend Referrals

Source: [https://bybit-exchange.github.io/docs/v5/user/friend-referral](https://bybit-exchange.github.io/docs/v5/user/friend-referral)
...
-   [English](/docs/v5/user/friend-referral){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/friend-referral){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Friend Referrals](/docs/v5/user/friend-referral){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Friend Referrals]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/user/rm-sub-apikey){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/spread/market/instrument){.pagination-nav__link .pagination-nav__link--next}
