...
fetched: "2026-03-10T08:58:00+00:00"
---

# Get UID Wallet Type

Source: [https://bybit-exchange.github.io/docs/v5/user/wallet-type](https://bybit-exchange.github.io/docs/v5/user/wallet-type)
...
-   [English](/docs/v5/user/wallet-type){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/user/wallet-type){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get UID Wallet Type](/docs/v5/user/wallet-type){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get UID Wallet Type]{.breadcrumbs__link itemprop="name"}
...
+:================+:================+:================+==========================================================================================================+
| memberIds       | false           | string          | -   Query itself wallet types when not passed                                                            |
...
[](/docs/v5/user/list-sub-apikeys){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/modify-master-apikey){.pagination-nav__link .pagination-nav__link--next}
