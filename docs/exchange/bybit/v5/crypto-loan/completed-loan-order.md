...
fetched: "2026-03-10T08:55:38+00:00"
---

# Get Completed Loan History

Source: [https://bybit-exchange.github.io/docs/v5/crypto-loan/completed-loan-order](https://bybit-exchange.github.io/docs/v5/crypto-loan/completed-loan-order)
...
-   [English](/docs/v5/crypto-loan/completed-loan-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/crypto-loan/completed-loan-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Completed Loan History](/docs/v5/crypto-loan/completed-loan-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Completed Loan History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/crypto-loan/repay-transaction){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/crypto-loan/reduce-max-collateral-amt){.pagination-nav__link .pagination-nav__link--next}
