...
fetched: "2026-03-10T08:55:37+00:00"
---

# Adjust Collateral Amount

Source: [https://bybit-exchange.github.io/docs/v5/crypto-loan/adjust-collateral](https://bybit-exchange.github.io/docs/v5/crypto-loan/adjust-collateral)
...
-   [English](/docs/v5/crypto-loan/adjust-collateral){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/crypto-loan/adjust-collateral){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    [Crypto Loan (legacy)](/docs/v5/crypto-loan/collateral-coin){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true"}
    

    -   [Get Collateral Coins](/docs/v5/crypto-loan/collateral-coin){.menu__link tabindex="0"}
    -   [Get Borrowable Coins](/docs/v5/crypto-loan/loan-coin){.menu__link tabindex="0"}
    -   [Get Account Borrowable/Collateralizable Limit](/docs/v5/crypto-loan/acct-borrow-collateral){.menu__link tabindex="0"}
    -   [Repay](/docs/v5/crypto-loan/repay){.menu__link tabindex="0"}
    -   [Get Unpaid Loans](/docs/v5/crypto-loan/unpaid-loan-order){.menu__link tabindex="0"}
    -   [Get Loan Repayment History](/docs/v5/crypto-loan/repay-transaction){.menu__link tabindex="0"}
    -   [Get Completed Loan History](/docs/v5/crypto-loan/completed-loan-order){.menu__link tabindex="0"}
    -   [Get Max. Allowed Collateral Reduction Amount](/docs/v5/crypto-loan/reduce-max-collateral-amt){.menu__link tabindex="0"}
    -   [Adjust Collateral Amount](/docs/v5/crypto-loan/adjust-collateral){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    -   [Get Loan LTV Adjustment History](/docs/v5/crypto-loan/ltv-adjust-history){.menu__link tabindex="0"}
...
-   [Crypto Loan (legacy)]{.breadcrumbs__link}
-   [Adjust Collateral Amount]{.breadcrumbs__link itemprop="name"}
...
You can increase or reduce your collateral amount. When you reduce, please obey the [max. allowed reduction amount](https://bybit-exchange.github.io/docs/v5/crypto-loan/reduce-max-collateral-amt){target="_blank" rel="noopener noreferrer"}.
...
[](/docs/v5/crypto-loan/reduce-max-collateral-amt){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/crypto-loan/ltv-adjust-history){.pagination-nav__link .pagination-nav__link--next}
