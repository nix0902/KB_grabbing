...
fetched: "2026-03-10T08:55:36+00:00"
---

# Get Account Borrowable/Collateralizable Limit

Source: [https://bybit-exchange.github.io/docs/v5/crypto-loan/acct-borrow-collateral](https://bybit-exchange.github.io/docs/v5/crypto-loan/acct-borrow-collateral)
...
-   [English](/docs/v5/crypto-loan/acct-borrow-collateral){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/crypto-loan/acct-borrow-collateral){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Account Borrowable/Collateralizable Limit](/docs/v5/crypto-loan/acct-borrow-collateral){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Account Borrowable/Collateralizable Limit]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/crypto-loan/loan-coin){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/crypto-loan/repay){.pagination-nav__link .pagination-nav__link--next}
