...
fetched: "2026-03-10T08:55:43+00:00"
---

# Get Unpaid Loans

Source: [https://bybit-exchange.github.io/docs/v5/crypto-loan/unpaid-loan-order](https://bybit-exchange.github.io/docs/v5/crypto-loan/unpaid-loan-order)
...
-   [English](/docs/v5/crypto-loan/unpaid-loan-order){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/crypto-loan/unpaid-loan-order){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Unpaid Loans](/docs/v5/crypto-loan/unpaid-loan-order){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Unpaid Loans]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/crypto-loan/repay){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/crypto-loan/repay-transaction){.pagination-nav__link .pagination-nav__link--next}
