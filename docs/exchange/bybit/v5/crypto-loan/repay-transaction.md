...
fetched: "2026-03-10T08:55:42+00:00"
---

# Get Loan Repayment History

Source: [https://bybit-exchange.github.io/docs/v5/crypto-loan/repay-transaction](https://bybit-exchange.github.io/docs/v5/crypto-loan/repay-transaction)
...
-   [English](/docs/v5/crypto-loan/repay-transaction){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/crypto-loan/repay-transaction){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Loan Repayment History](/docs/v5/crypto-loan/repay-transaction){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Loan Repayment History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/crypto-loan/unpaid-loan-order){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/crypto-loan/completed-loan-order){.pagination-nav__link .pagination-nav__link--next}
