...
fetched: "2026-03-10T08:57:49+00:00"
---

# Get System Status

Source: [https://bybit-exchange.github.io/docs/v5/system-status](https://bybit-exchange.github.io/docs/v5/system-status)
...
-   [English](/docs/v5/system-status){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/system-status){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   [Get System Status](/docs/v5/system-status){.menu__link .menu__link--active aria-current="page"}
...
-   [Get System Status]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/demo){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/market/time){.pagination-nav__link .pagination-nav__link--next}
