...
fetched: "2026-03-10T08:54:43+00:00"
---

# Set MMP

Source: [https://bybit-exchange.github.io/docs/v5/account/set-mmp](https://bybit-exchange.github.io/docs/v5/account/set-mmp)
...
-   [English](/docs/v5/account/set-mmp){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/set-mmp){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set MMP](/docs/v5/account/set-mmp){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set MMP]{.breadcrumbs__link itemprop="name"}
...
## What is MMP?[​](#what-is-mmp "Direct link to heading"){.hash-link} 
...
## How to enable MMP[​](#how-to-enable-mmp "Direct link to heading"){.hash-link} 

Send an email to Bybit ([financial.inst@bybit.com](mailto:financial.inst@bybit.com){target="_blank" rel="noopener noreferrer"}) or contact your business development (BD) manager to apply for MMP. After processed, the default settings are as below table:
...
## Applicable[​](#applicable "Direct link to heading"){.hash-link} 

Effective for **options** only. When you place an `option` order, set `mmp`=true, which means you mark this order as a mmp order.

## Some points to note[​](#some-points-to-note "Direct link to heading"){.hash-link} 
...
[](/docs/v5/account/reset-mmp){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/smp-group){.pagination-nav__link .pagination-nav__link--next}
