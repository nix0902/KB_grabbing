...
Source: [https://bybit-exchange.github.io/docs/v5/account/repay](https://bybit-exchange.github.io/docs/v5/account/repay)
...
-   [English](/docs/v5/account/repay){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/repay){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Manual Repay](/docs/v5/account/repay){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Manual Repay]{.breadcrumbs__link itemprop="name"}
...
1.  When repaying, the system will first use the spot available balance of the debt currency. If that's not enough, the remaining amount will be repaid by converting other assets according to the [liquidation order](https://www.bybit.com/en/announcement-info/fullstock-leverage-uta/){target="_blank" rel="noopener noreferrer"}.
...
| result                | array                 | Object                |
+-----------------------+-----------------------+-----------------------+
| \> resultStatus       | string                | -   `P`: Processing   |
|                       |                       | -   `SU`: Success     |
|                       |                       | -   `FA`: Failed      |
+-----------------------+-----------------------+-----------------------+
...
[](/docs/v5/account/no-convert-repay){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/fee-rate){.pagination-nav__link .pagination-nav__link--next}
