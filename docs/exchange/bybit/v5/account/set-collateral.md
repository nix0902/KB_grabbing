...
Source: [https://bybit-exchange.github.io/docs/v5/account/set-collateral](https://bybit-exchange.github.io/docs/v5/account/set-collateral)
...
-   [English](/docs/v5/account/set-collateral){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/set-collateral){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set Collateral Coin](/docs/v5/account/set-collateral){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set Collateral Coin]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/dcp-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/set-margin-mode){.pagination-nav__link .pagination-nav__link--next}
