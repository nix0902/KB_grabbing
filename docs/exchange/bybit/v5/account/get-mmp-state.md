...
Source: [https://bybit-exchange.github.io/docs/v5/account/get-mmp-state](https://bybit-exchange.github.io/docs/v5/account/get-mmp-state)
...
-   [English](/docs/v5/account/get-mmp-state){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/get-mmp-state){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get MMP State](/docs/v5/account/get-mmp-state){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get MMP State]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/coin-greeks){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/reset-mmp){.pagination-nav__link .pagination-nav__link--next}
