...
fetched: "2026-03-10T08:54:42+00:00"
---

# Set Margin Mode

Source: [https://bybit-exchange.github.io/docs/v5/account/set-margin-mode](https://bybit-exchange.github.io/docs/v5/account/set-margin-mode)
...
-   [English](/docs/v5/account/set-margin-mode){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/set-margin-mode){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set Margin Mode](/docs/v5/account/set-margin-mode){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set Margin Mode]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/set-collateral){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/set-spot-hedge){.pagination-nav__link .pagination-nav__link--next}
