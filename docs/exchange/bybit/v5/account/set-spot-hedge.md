...
fetched: "2026-03-10T08:54:45+00:00"
---

# Set Spot Hedging

Source: [https://bybit-exchange.github.io/docs/v5/account/set-spot-hedge](https://bybit-exchange.github.io/docs/v5/account/set-spot-hedge)
...
-   [English](/docs/v5/account/set-spot-hedge){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/set-spot-hedge){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set Spot Hedging](/docs/v5/account/set-spot-hedge){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set Spot Hedging]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/set-margin-mode){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/borrow-history){.pagination-nav__link .pagination-nav__link--next}
