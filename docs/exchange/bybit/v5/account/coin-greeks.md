...
Source: [https://bybit-exchange.github.io/docs/v5/account/coin-greeks](https://bybit-exchange.github.io/docs/v5/account/coin-greeks)
...
-   [English](/docs/v5/account/coin-greeks){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/coin-greeks){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Coin Greeks](/docs/v5/account/coin-greeks){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Coin Greeks]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/batch-set-collateral){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/get-mmp-state){.pagination-nav__link .pagination-nav__link--next}
