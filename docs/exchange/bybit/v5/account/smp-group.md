...
Source: [https://bybit-exchange.github.io/docs/v5/account/smp-group](https://bybit-exchange.github.io/docs/v5/account/smp-group)
...
-   [English](/docs/v5/account/smp-group){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/smp-group){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get SMP Group ID](/docs/v5/account/smp-group){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get SMP Group ID]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/set-mmp){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/get-user-setting-config){.pagination-nav__link .pagination-nav__link--next}
