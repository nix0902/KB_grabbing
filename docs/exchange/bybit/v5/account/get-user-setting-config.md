...
fetched: "2026-03-10T08:54:37+00:00"
---

# Get Trade Behaviour Config

Source: [https://bybit-exchange.github.io/docs/v5/account/get-user-setting-config](https://bybit-exchange.github.io/docs/v5/account/get-user-setting-config)
...
-   [English](/docs/v5/account/get-user-setting-config){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/get-user-setting-config){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Trade Behaviour Config](/docs/v5/account/get-user-setting-config){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Trade Behaviour Config]{.breadcrumbs__link itemprop="name"}
...
| result                | array                 | Object                                                                                                                          |
+-----------------------+-----------------------+---------------------------------------------------------------------------------------------------------------------------------+
| \> lpaSpot            | boolean               | -   `true`: If the order price exceeds the limit, the system will automatically adjust the price to the nearest allowed price   |
...
[](/docs/v5/account/smp-group){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/set-price-limit){.pagination-nav__link .pagination-nav__link--next}
