...
fetched: "2026-03-10T08:54:36+00:00"
---

# Get Fee Rate

Source: [https://bybit-exchange.github.io/docs/v5/account/fee-rate](https://bybit-exchange.github.io/docs/v5/account/fee-rate)
...
-   [English](/docs/v5/account/fee-rate){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/fee-rate){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Fee Rate](/docs/v5/account/fee-rate){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Fee Rate]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/repay){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/collateral-info){.pagination-nav__link .pagination-nav__link--next}
