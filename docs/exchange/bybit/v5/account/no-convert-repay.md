...
fetched: "2026-03-10T08:54:39+00:00"
---

# Manual Repay Without Asset Conversion

Source: [https://bybit-exchange.github.io/docs/v5/account/no-convert-repay](https://bybit-exchange.github.io/docs/v5/account/no-convert-repay)
...
-   [English](/docs/v5/account/no-convert-repay){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/no-convert-repay){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Manual Repay Without Asset Conversion](/docs/v5/account/no-convert-repay){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Manual Repay Without Asset Conversion]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/borrow){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/repay){.pagination-nav__link .pagination-nav__link--next}
