...
Source: [https://bybit-exchange.github.io/docs/v5/account/account-info](https://bybit-exchange.github.io/docs/v5/account/account-info)
...
-   [English](/docs/v5/account/account-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/account-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Account Info](/docs/v5/account/account-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/account/transaction-log){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/instrument){.pagination-nav__link .pagination-nav__link--next}
