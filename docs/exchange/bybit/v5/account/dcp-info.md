...
fetched: "2026-03-10T08:54:35+00:00"
---

# Get DCP Info

Source: [https://bybit-exchange.github.io/docs/v5/account/dcp-info](https://bybit-exchange.github.io/docs/v5/account/dcp-info)
...
-   [English](/docs/v5/account/dcp-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/dcp-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get DCP Info](/docs/v5/account/dcp-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get DCP Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/collateral-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/set-collateral){.pagination-nav__link .pagination-nav__link--next}
