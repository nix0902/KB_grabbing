...
fetched: "2026-03-10T08:54:41+00:00"
---

# Reset MMP

Source: [https://bybit-exchange.github.io/docs/v5/account/reset-mmp](https://bybit-exchange.github.io/docs/v5/account/reset-mmp)
...
-   [English](/docs/v5/account/reset-mmp){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/reset-mmp){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Reset MMP](/docs/v5/account/reset-mmp){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Reset MMP]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/get-mmp-state){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/set-mmp){.pagination-nav__link .pagination-nav__link--next}
