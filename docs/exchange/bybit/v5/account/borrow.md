...
fetched: "2026-03-10T08:54:32+00:00"
---

# Manual Borrow

Source: [https://bybit-exchange.github.io/docs/v5/account/borrow](https://bybit-exchange.github.io/docs/v5/account/borrow)
...
-   [English](/docs/v5/account/borrow){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/borrow){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Manual Borrow](/docs/v5/account/borrow){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Manual Borrow]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/instrument){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/no-convert-repay){.pagination-nav__link .pagination-nav__link--next}
