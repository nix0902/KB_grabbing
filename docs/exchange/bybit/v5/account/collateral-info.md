...
fetched: "2026-03-10T08:54:34+00:00"
---

# Get Collateral Info

Source: [https://bybit-exchange.github.io/docs/v5/account/collateral-info](https://bybit-exchange.github.io/docs/v5/account/collateral-info)
...
-   [English](/docs/v5/account/collateral-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/collateral-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Collateral Info](/docs/v5/account/collateral-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Collateral Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/fee-rate){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/dcp-info){.pagination-nav__link .pagination-nav__link--next}
