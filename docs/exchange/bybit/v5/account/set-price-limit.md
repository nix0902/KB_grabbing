...
fetched: "2026-03-10T08:54:44+00:00"
---

# Set Price Limit Behaviour

Source: [https://bybit-exchange.github.io/docs/v5/account/set-price-limit](https://bybit-exchange.github.io/docs/v5/account/set-price-limit)
...
-   [English](/docs/v5/account/set-price-limit){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/set-price-limit){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set Price Limit Behaviour](/docs/v5/account/set-price-limit){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set Price Limit Behaviour]{.breadcrumbs__link itemprop="name"}
...
You can configure how the system behaves when your limit order price exceeds the highest bid or lowest ask price. You can query your current configuration with [Get Trade Behaviour Setting](/docs/v5/account/get-user-setting-config). Learn more about the price limit for [spot](https://www.bybit.com/en/help-center/article/Bybit-Spot-Trading-Rules#A){target="_blank" rel="noopener noreferrer"} and [futures](https://www.bybit.com/en/help-center/article?id=000002177#D){target="_blank" rel="noopener noreferrer"} in the help centre.
...
[![](data:image/svg+xml;base64,)]{.admonitionIcon_kALy}Default Setting



-   Spot: **modifyEnable = false.** If the order price exceeds the limit, the system rejects the request.\
    Corresponds to [Get Limit Price Behaviour](https://bybit-exchange.github.io/docs/v5/account/get-user-setting-config){target="_blank" rel="noopener noreferrer"}, where **lpaSpot = false, lpaPerp = true**
...
-   Futures: **modifyEnable = true.** If the order price exceeds the limit, the system will automatically adjust the price to the nearest allowed price (i.e., highest bid or lowest ask).\
    Corresponds to [Get Limit Price Behaviour](https://bybit-exchange.github.io/docs/v5/account/get-user-setting-config){target="_blank" rel="noopener noreferrer"}, where **lpaSpot = true, lpaPerp = false**
...
[](/docs/v5/account/get-user-setting-config){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/repay-liability){.pagination-nav__link .pagination-nav__link--next}
