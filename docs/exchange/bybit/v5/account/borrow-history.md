...
fetched: "2026-03-10T08:54:33+00:00"
---

# Get Borrow History

Source: [https://bybit-exchange.github.io/docs/v5/account/borrow-history](https://bybit-exchange.github.io/docs/v5/account/borrow-history)
...
-   [English](/docs/v5/account/borrow-history){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/borrow-history){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Borrow History (2 years)](/docs/v5/account/borrow-history){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Borrow History (2 years)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/set-spot-hedge){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/batch-set-collateral){.pagination-nav__link .pagination-nav__link--next}
