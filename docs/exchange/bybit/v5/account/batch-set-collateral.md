...
fetched: "2026-03-10T08:54:31+00:00"
---

# Batch Set Collateral Coin

Source: [https://bybit-exchange.github.io/docs/v5/account/batch-set-collateral](https://bybit-exchange.github.io/docs/v5/account/batch-set-collateral)
...
-   [English](/docs/v5/account/batch-set-collateral){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/account/batch-set-collateral){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Batch Set Collateral Coin](/docs/v5/account/batch-set-collateral){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Batch Set Collateral Coin]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/account/borrow-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/coin-greeks){.pagination-nav__link .pagination-nav__link--next}
