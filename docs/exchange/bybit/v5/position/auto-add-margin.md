...
fetched: "2026-03-10T08:56:51+00:00"
---

# Set Auto Add Margin

Source: [https://bybit-exchange.github.io/docs/v5/position/auto-add-margin](https://bybit-exchange.github.io/docs/v5/position/auto-add-margin)
...
-   [English](/docs/v5/position/auto-add-margin){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/auto-add-margin){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set Auto Add Margin](/docs/v5/position/auto-add-margin){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set Auto Add Margin]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/position/trading-stop){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/manual-add-margin){.pagination-nav__link .pagination-nav__link--next}
