...
fetched: "2026-03-10T08:56:53+00:00"
---

# Confirm New Risk Limit

Source: [https://bybit-exchange.github.io/docs/v5/position/confirm-mmr](https://bybit-exchange.github.io/docs/v5/position/confirm-mmr)
...
-   [English](/docs/v5/position/confirm-mmr){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/confirm-mmr){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Confirm New Risk Limit](/docs/v5/position/confirm-mmr){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Confirm New Risk Limit]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/position/move-position-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/pre-upgrade/order-list){.pagination-nav__link .pagination-nav__link--next}
