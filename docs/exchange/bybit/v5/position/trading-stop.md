...
Source: [https://bybit-exchange.github.io/docs/v5/position/trading-stop](https://bybit-exchange.github.io/docs/v5/position/trading-stop)
...
-   [English](/docs/v5/position/trading-stop){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/trading-stop){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set Trading Stop](/docs/v5/position/trading-stop){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set Trading Stop]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/position/position-mode){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/auto-add-margin){.pagination-nav__link .pagination-nav__link--next}
