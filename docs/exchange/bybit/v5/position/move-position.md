...
fetched: "2026-03-10T08:56:55+00:00"
---

# Move Position

Source: [https://bybit-exchange.github.io/docs/v5/position/move-position](https://bybit-exchange.github.io/docs/v5/position/move-position)
...
-   [English](/docs/v5/position/move-position){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/move-position){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Move Position](/docs/v5/position/move-position){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Move Position]{.breadcrumbs__link itemprop="name"}
...
+-----------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+
| \> rejectParty        | string                | -   `""` means initial validation is passed, please check the order status via [Get Move Position History](/docs/v5/position/move-position-history) |
...
[](/docs/v5/position/close-position){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/move-position-history){.pagination-nav__link .pagination-nav__link--next}
