...
fetched: "2026-03-10T08:56:57+00:00"
---

# Switch Position Mode

Source: [https://bybit-exchange.github.io/docs/v5/position/position-mode](https://bybit-exchange.github.io/docs/v5/position/position-mode)
...
-   [English](/docs/v5/position/position-mode){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/position-mode){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Position Info](/docs/v5/position){.menu__link tabindex="0"}
    -   [Set Leverage](/docs/v5/position/leverage){.menu__link tabindex="0"}
    -   [Switch Position Mode](/docs/v5/position/position-mode){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Switch Position Mode]{.breadcrumbs__link itemprop="name"}
...
### Example[​](#example "Direct link to heading"){.hash-link} 
...
### The position-switch ability for each contract[​](#the-position-switch-ability-for-each-contract "Direct link to heading"){.hash-link} 
...
[](/docs/v5/position/leverage){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/trading-stop){.pagination-nav__link .pagination-nav__link--next}
...
-   [Example](#example){.table-of-contents__link .toc-highlight}
-   [The position-switch ability for each contract](#the-position-switch-ability-for-each-contract){.table-of-contents__link .toc-highlight}
