...
Source: [https://bybit-exchange.github.io/docs/v5/position/close-pnl](https://bybit-exchange.github.io/docs/v5/position/close-pnl)
...
-   [English](/docs/v5/position/close-pnl){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/close-pnl){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Closed PnL (2 years)](/docs/v5/position/close-pnl){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Closed PnL (2 years)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/position/manual-add-margin){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/close-position){.pagination-nav__link .pagination-nav__link--next}
