...
fetched: "2026-03-10T08:56:56+00:00"
---

# Get Move Position History

Source: [https://bybit-exchange.github.io/docs/v5/position/move-position-history](https://bybit-exchange.github.io/docs/v5/position/move-position-history)
...
-   [English](/docs/v5/position/move-position-history){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/move-position-history){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Move Position History](/docs/v5/position/move-position-history){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Move Position History]{.breadcrumbs__link itemprop="name"}
...
+---------------------------------------+-----------------------+------------------------------------------------------------------------------------------------+
| \> rejectParty                        | string                | -   `""` means the status=`Filled`                                                             |
...
[](/docs/v5/position/move-position){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/confirm-mmr){.pagination-nav__link .pagination-nav__link--next}
