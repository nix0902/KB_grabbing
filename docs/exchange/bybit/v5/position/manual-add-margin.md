...
Source: [https://bybit-exchange.github.io/docs/v5/position/manual-add-margin](https://bybit-exchange.github.io/docs/v5/position/manual-add-margin)
...
-   [English](/docs/v5/position/manual-add-margin){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/manual-add-margin){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Add Or Reduce Margin](/docs/v5/position/manual-add-margin){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Add Or Reduce Margin]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/position/auto-add-margin){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/close-pnl){.pagination-nav__link .pagination-nav__link--next}
