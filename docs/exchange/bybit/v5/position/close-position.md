...
fetched: "2026-03-10T08:56:52+00:00"
---

# Get Closed Options Positions

Source: [https://bybit-exchange.github.io/docs/v5/position/close-position](https://bybit-exchange.github.io/docs/v5/position/close-position)
...
-   [English](/docs/v5/position/close-position){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/close-position){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Closed Options Positions (6 months)](/docs/v5/position/close-position){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Closed Options Positions (6 months)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/position/close-pnl){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/move-position){.pagination-nav__link .pagination-nav__link--next}
