...
fetched: "2026-03-10T08:56:54+00:00"
---

# Set Leverage

Source: [https://bybit-exchange.github.io/docs/v5/position/leverage](https://bybit-exchange.github.io/docs/v5/position/leverage)
...
-   [English](/docs/v5/position/leverage){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/position/leverage){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set Leverage](/docs/v5/position/leverage){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
According to the risk limit, leverage affects the maximum position value that can be opened, that is, the greater the leverage, the smaller the maximum position value that can be opened, and vice versa. [Learn more](https://www.bybit.com/en/help-center/article/Risk-Limit-Perpetual-and-FuturesBybit_Perpetual_Contract_mechanism){target="_blank" rel="noopener noreferrer"}
...
[](/docs/v5/position){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/position/position-mode){.pagination-nav__link .pagination-nav__link--next}
