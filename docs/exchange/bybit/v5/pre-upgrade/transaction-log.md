...
fetched: "2026-03-10T08:57:02+00:00"
---

# Get Pre-upgrade Transaction Log

Source: [https://bybit-exchange.github.io/docs/v5/pre-upgrade/transaction-log](https://bybit-exchange.github.io/docs/v5/pre-upgrade/transaction-log)
...
-   [English](/docs/v5/pre-upgrade/transaction-log){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/pre-upgrade/transaction-log){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    [Pre-upgrade](/docs/v5/pre-upgrade/order-list){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true"}
    

    -   [Get Pre-upgrade Order History](/docs/v5/pre-upgrade/order-list){.menu__link tabindex="0"}
    -   [Get Pre-upgrade Trade History](/docs/v5/pre-upgrade/execution){.menu__link tabindex="0"}
    -   [Get Pre-upgrade Closed PnL](/docs/v5/pre-upgrade/close-pnl){.menu__link tabindex="0"}
    -   [Get Pre-upgrade Transaction Log](/docs/v5/pre-upgrade/transaction-log){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    -   [Get Pre-upgrade Delivery Record](/docs/v5/pre-upgrade/delivery){.menu__link tabindex="0"}
    -   [Get Pre-upgrade USDC Session Settlement](/docs/v5/pre-upgrade/settlement){.menu__link tabindex="0"}
...
-   [Pre-upgrade]{.breadcrumbs__link}
-   [Get Pre-upgrade Transaction Log]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/pre-upgrade/close-pnl){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/pre-upgrade/delivery){.pagination-nav__link .pagination-nav__link--next}
