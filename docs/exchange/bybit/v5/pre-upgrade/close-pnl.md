...
fetched: "2026-03-10T08:56:58+00:00"
---

# Get Pre-upgrade Closed PnL

Source: [https://bybit-exchange.github.io/docs/v5/pre-upgrade/close-pnl](https://bybit-exchange.github.io/docs/v5/pre-upgrade/close-pnl)
...
-   [English](/docs/v5/pre-upgrade/close-pnl){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/pre-upgrade/close-pnl){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Pre-upgrade Closed PnL](/docs/v5/pre-upgrade/close-pnl){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Pre-upgrade Closed PnL]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/pre-upgrade/execution){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/pre-upgrade/transaction-log){.pagination-nav__link .pagination-nav__link--next}
