...
Source: [https://bybit-exchange.github.io/docs/v5/pre-upgrade/order-list](https://bybit-exchange.github.io/docs/v5/pre-upgrade/order-list)
...
-   [English](/docs/v5/pre-upgrade/order-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/pre-upgrade/order-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Pre-upgrade Order History](/docs/v5/pre-upgrade/order-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Pre-upgrade Order History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/position/confirm-mmr){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/pre-upgrade/execution){.pagination-nav__link .pagination-nav__link--next}
