...
fetched: "2026-03-10T08:57:01+00:00"
---

# Get Pre-upgrade USDC Session Settlement

Source: [https://bybit-exchange.github.io/docs/v5/pre-upgrade/settlement](https://bybit-exchange.github.io/docs/v5/pre-upgrade/settlement)
...
-   [English](/docs/v5/pre-upgrade/settlement){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/pre-upgrade/settlement){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Pre-upgrade Transaction Log](/docs/v5/pre-upgrade/transaction-log){.menu__link tabindex="0"}
    -   [Get Pre-upgrade Delivery Record](/docs/v5/pre-upgrade/delivery){.menu__link tabindex="0"}
    -   [Get Pre-upgrade USDC Session Settlement](/docs/v5/pre-upgrade/settlement){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Pre-upgrade USDC Session Settlement]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/pre-upgrade/delivery){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/account/wallet-balance){.pagination-nav__link .pagination-nav__link--next}
