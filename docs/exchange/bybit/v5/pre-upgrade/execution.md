...
fetched: "2026-03-10T08:57:00+00:00"
---

# Get Pre-upgrade Trade History

Source: [https://bybit-exchange.github.io/docs/v5/pre-upgrade/execution](https://bybit-exchange.github.io/docs/v5/pre-upgrade/execution)
...
-   [English](/docs/v5/pre-upgrade/execution){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/pre-upgrade/execution){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Pre-upgrade Trade History](/docs/v5/pre-upgrade/execution){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Pre-upgrade Trade History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/pre-upgrade/order-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/pre-upgrade/close-pnl){.pagination-nav__link .pagination-nav__link--next}
