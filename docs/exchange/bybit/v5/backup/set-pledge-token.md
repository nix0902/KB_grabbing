...
fetched: "2026-03-10T08:55:27+00:00"
---

# Set Pledge Token

Source: [https://bybit-exchange.github.io/docs/v5/backup/set-pledge-token](https://bybit-exchange.github.io/docs/v5/backup/set-pledge-token)
...
-   [English](/docs/v5/backup/set-pledge-token){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/backup/set-pledge-token){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
