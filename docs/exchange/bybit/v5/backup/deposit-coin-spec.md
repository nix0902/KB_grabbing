...
fetched: "2026-03-10T08:55:26+00:00"
---

# 查詢支持的充值幣種信息

Source: [https://bybit-exchange.github.io/docs/v5/backup/deposit-coin-spec](https://bybit-exchange.github.io/docs/v5/backup/deposit-coin-spec)
...
-   [English](/docs/v5/backup/deposit-coin-spec){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/backup/deposit-coin-spec){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
### HTTP 請求[​](#http-請求 "Direct link to heading"){.hash-link} 

GET `/v5/asset/deposit/query-allowed-list`

### 請求參數[​](#請求參數 "Direct link to heading"){.hash-link} 
...
### 響應參數[​](#響應參數 "Direct link to heading"){.hash-link} 
...
### 請求示例[​](#請求示例 "Direct link to heading"){.hash-link} 
...
### 響應示例[​](#響應示例 "Direct link to heading"){.hash-link} 
...
-   [HTTP 請求](#http-請求){.table-of-contents__link .toc-highlight}
-   [請求參數](#請求參數){.table-of-contents__link .toc-highlight}
-   [響應參數](#響應參數){.table-of-contents__link .toc-highlight}
-   [請求示例](#請求示例){.table-of-contents__link .toc-highlight}
-   [響應示例](#響應示例){.table-of-contents__link .toc-highlight}
