...
fetched: "2026-03-10T08:54:21+00:00"
---

# Cancel Redeem

Source: [https://bybit-exchange.github.io/docs/v5/abandon/cancel-redeem](https://bybit-exchange.github.io/docs/v5/abandon/cancel-redeem)
...
-   [English](/docs/v5/abandon/cancel-redeem){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/cancel-redeem){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Cancel Redeem](/docs/v5/abandon/cancel-redeem){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Cancel Redeem]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/redeem){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/borrow){.pagination-nav__link .pagination-nav__link--next}
