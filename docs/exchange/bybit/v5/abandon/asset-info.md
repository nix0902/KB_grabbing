...
fetched: "2026-03-10T08:54:20+00:00"
---

# Get Asset Info

Source: [https://bybit-exchange.github.io/docs/v5/abandon/asset-info](https://bybit-exchange.github.io/docs/v5/abandon/asset-info)
...
-   [English](/docs/v5/abandon/asset-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/asset-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Asset Info (Spot)](/docs/v5/abandon/asset-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Asset Info (Spot)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/error){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/coin-info){.pagination-nav__link .pagination-nav__link--next}
