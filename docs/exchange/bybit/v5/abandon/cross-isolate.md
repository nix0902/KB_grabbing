...
fetched: "2026-03-10T08:54:23+00:00"
---

# Switch Cross/Isolated Margin

Source: [https://bybit-exchange.github.io/docs/v5/abandon/cross-isolate](https://bybit-exchange.github.io/docs/v5/abandon/cross-isolate)
...
-   [English](/docs/v5/abandon/cross-isolate){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/cross-isolate){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Switch Cross/Isolated Margin](/docs/v5/abandon/cross-isolate){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Switch Cross/Isolated Margin]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/account-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/set-risk-limit){.pagination-nav__link .pagination-nav__link--next}
