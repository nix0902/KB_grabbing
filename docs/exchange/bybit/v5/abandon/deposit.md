...
fetched: "2026-03-10T08:54:24+00:00"
---

# Deposit Funds

Source: [https://bybit-exchange.github.io/docs/v5/abandon/deposit](https://bybit-exchange.github.io/docs/v5/abandon/deposit)
...
-   [English](/docs/v5/abandon/deposit){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/deposit){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Deposit Funds](/docs/v5/abandon/deposit){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Deposit Funds]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/ltv){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/margin-coin-info){.pagination-nav__link .pagination-nav__link--next}
