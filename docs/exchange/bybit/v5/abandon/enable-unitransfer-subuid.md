...
fetched: "2026-03-10T08:54:25+00:00"
---

# Enable Universal Transfer for Sub UID

Source: [https://bybit-exchange.github.io/docs/v5/abandon/enable-unitransfer-subuid](https://bybit-exchange.github.io/docs/v5/abandon/enable-unitransfer-subuid)
...
-   [English](/docs/v5/abandon/enable-unitransfer-subuid){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/enable-unitransfer-subuid){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Enable Universal Transfer for Sub UID](/docs/v5/abandon/enable-unitransfer-subuid){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Enable Universal Transfer for Sub UID]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/margin-coin-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/redeem){.pagination-nav__link .pagination-nav__link--next}
