...
fetched: "2026-03-10T08:54:30+00:00"
---

# Set TP/SL Mode

Source: [https://bybit-exchange.github.io/docs/v5/abandon/tpsl-mode](https://bybit-exchange.github.io/docs/v5/abandon/tpsl-mode)
...
-   [English](/docs/v5/abandon/tpsl-mode){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/tpsl-mode){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Set TP/SL Mode (deprecated)](/docs/v5/abandon/tpsl-mode){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Set TP/SL Mode (deprecated)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/contract-transaction-log){.pagination-nav__link .pagination-nav__link--prev}
