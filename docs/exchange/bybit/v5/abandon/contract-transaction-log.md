...
fetched: "2026-03-10T08:54:22+00:00"
---

# Get Transaction Log

Source: [https://bybit-exchange.github.io/docs/v5/abandon/contract-transaction-log](https://bybit-exchange.github.io/docs/v5/abandon/contract-transaction-log)
...
-   [English](/docs/v5/abandon/contract-transaction-log){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/contract-transaction-log){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Transaction Log (Classic)](/docs/v5/abandon/contract-transaction-log){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Transaction Log (Classic)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/set-risk-limit){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/tpsl-mode){.pagination-nav__link .pagination-nav__link--next}
