...
Source: [https://bybit-exchange.github.io/docs/v5/abandon/borrow](https://bybit-exchange.github.io/docs/v5/abandon/borrow)
...
-   [English](/docs/v5/abandon/borrow){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/borrow){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Borrow](/docs/v5/abandon/borrow){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/abandon/cancel-redeem){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/earning){.pagination-nav__link .pagination-nav__link--next}
