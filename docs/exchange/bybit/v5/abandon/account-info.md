...
fetched: "2026-03-10T08:54:19+00:00"
---

# Get Lending Account Info

Source: [https://bybit-exchange.github.io/docs/v5/abandon/account-info](https://bybit-exchange.github.io/docs/v5/abandon/account-info)
...
-   [English](/docs/v5/abandon/account-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/account-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Lending Account Info](/docs/v5/abandon/account-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Lending Account Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/order-record){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/cross-isolate){.pagination-nav__link .pagination-nav__link--next}
