...
fetched: "2026-03-10T08:54:27+00:00"
---

# Get Margin Coin Info

Source: [https://bybit-exchange.github.io/docs/v5/abandon/margin-coin-info](https://bybit-exchange.github.io/docs/v5/abandon/margin-coin-info)
...
-   [English](/docs/v5/abandon/margin-coin-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/margin-coin-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Margin Coin Info](/docs/v5/abandon/margin-coin-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/abandon/deposit){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/enable-unitransfer-subuid){.pagination-nav__link .pagination-nav__link--next}
