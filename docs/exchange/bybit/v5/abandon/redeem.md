...
Source: [https://bybit-exchange.github.io/docs/v5/abandon/redeem](https://bybit-exchange.github.io/docs/v5/abandon/redeem)
...
-   [English](/docs/v5/abandon/redeem){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/redeem){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Redeem Funds](/docs/v5/abandon/redeem){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Redeem Funds]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/enable-unitransfer-subuid){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/cancel-redeem){.pagination-nav__link .pagination-nav__link--next}
