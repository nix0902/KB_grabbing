...
Source: [https://bybit-exchange.github.io/docs/v5/abandon/coin-info](https://bybit-exchange.github.io/docs/v5/abandon/coin-info)
...
-   [English](/docs/v5/abandon/coin-info){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/coin-info){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Lending Coin Info](/docs/v5/abandon/coin-info){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Lending Coin Info]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/asset-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/ltv){.pagination-nav__link .pagination-nav__link--next}
