...
Source: [https://bybit-exchange.github.io/docs/v5/abandon/earning](https://bybit-exchange.github.io/docs/v5/abandon/earning)
...
-   [English](/docs/v5/abandon/earning){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/earning){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Broker Earning](/docs/v5/abandon/earning){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Broker Earning]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/abandon/borrow){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/order-record){.pagination-nav__link .pagination-nav__link--next}
