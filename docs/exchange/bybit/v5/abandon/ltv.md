...
fetched: "2026-03-10T08:54:26+00:00"
---

# Get LTV

Source: [https://bybit-exchange.github.io/docs/v5/abandon/ltv](https://bybit-exchange.github.io/docs/v5/abandon/ltv)
...
-   [English](/docs/v5/abandon/ltv){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/abandon/ltv){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get LTV](/docs/v5/abandon/ltv){.menu__link .menu__link--active aria-current="page" tabindex="0"}
    ...
    -   [Set Risk Limit](/docs/v5/abandon/set-risk-limit){.menu__link tabindex="0"}
...
### Response Parameters[​](#response-parameters "Direct link to heading"){.hash-link} 
  ...
  \> balance            string   Total asset. (margin coins converted to USDT). Please read [here](https://www.bybit.com/en-US/help-center/s/article/Over-the-counter-OTC-Lending){target="_blank" rel="noopener noreferrer"} to understand the calculation
...
[](/docs/v5/abandon/coin-info){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/deposit){.pagination-nav__link .pagination-nav__link--next}
