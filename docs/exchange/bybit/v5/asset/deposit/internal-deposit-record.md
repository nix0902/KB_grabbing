...
fetched: "2026-03-10T08:55:06+00:00"
---

# Get Internal Deposit Records (off-chain)

Source: [https://bybit-exchange.github.io/docs/v5/asset/deposit/internal-deposit-record](https://bybit-exchange.github.io/docs/v5/asset/deposit/internal-deposit-record)
...
-   [English](/docs/v5/asset/deposit/internal-deposit-record){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/deposit/internal-deposit-record){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Set Deposit Account](/docs/v5/asset/deposit/set-deposit-acct){.menu__link tabindex="0"}
        ...
        -   [Get Internal Deposit Records (off-chain)](/docs/v5/asset/deposit/internal-deposit-record){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Internal Deposit Records (off-chain)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/deposit/sub-deposit-record){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/deposit/master-deposit-addr){.pagination-nav__link .pagination-nav__link--next}
