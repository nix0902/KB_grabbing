...
Source: [https://bybit-exchange.github.io/docs/v5/asset/deposit/master-deposit-addr](https://bybit-exchange.github.io/docs/v5/asset/deposit/master-deposit-addr)
...
-   [English](/docs/v5/asset/deposit/master-deposit-addr){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/deposit/master-deposit-addr){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Master Deposit Address](/docs/v5/asset/deposit/master-deposit-addr){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Master Deposit Address]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/deposit/internal-deposit-record){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/deposit/sub-deposit-addr){.pagination-nav__link .pagination-nav__link--next}
