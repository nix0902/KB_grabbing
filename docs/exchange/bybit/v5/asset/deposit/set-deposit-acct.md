...
fetched: "2026-03-10T08:55:07+00:00"
---

# Set Deposit Account

Source: [https://bybit-exchange.github.io/docs/v5/asset/deposit/set-deposit-acct](https://bybit-exchange.github.io/docs/v5/asset/deposit/set-deposit-acct)
...
-   [English](/docs/v5/asset/deposit/set-deposit-acct){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/deposit/set-deposit-acct){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        [Deposit](/docs/v5/asset/deposit/set-deposit-acct){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Set Deposit Account](/docs/v5/asset/deposit/set-deposit-acct){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        -   [Get Deposit Records (on-chain)](/docs/v5/asset/deposit/deposit-record){.menu__link tabindex="0"}
        -   [Get Sub Deposit Records (on-chain)](/docs/v5/asset/deposit/sub-deposit-record){.menu__link tabindex="0"}
        -   [Get Internal Deposit Records (off-chain)](/docs/v5/asset/deposit/internal-deposit-record){.menu__link tabindex="0"}
        -   [Get Master Deposit Address](/docs/v5/asset/deposit/master-deposit-addr){.menu__link tabindex="0"}
        -   [Get Sub Deposit Address](/docs/v5/asset/deposit/sub-deposit-addr){.menu__link tabindex="0"}
...
-   [Deposit]{.breadcrumbs__link}
-   [Set Deposit Account]{.breadcrumbs__link itemprop="name"}
...
Set auto transfer account after deposit. The same function as the setting for Deposit on [web GUI](https://www.bybit.com/app/user/settings){target="_blank" rel="noopener noreferrer"}
...
[](/docs/v5/asset/transfer/transferable-coin){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/deposit/deposit-record){.pagination-nav__link .pagination-nav__link--next}
