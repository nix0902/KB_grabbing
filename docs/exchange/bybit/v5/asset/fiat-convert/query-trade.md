...
Source: [https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/query-trade](https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/query-trade)
...
-   [English](/docs/v5/asset/fiat-convert/query-trade){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/fiat-convert/query-trade){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Convert Status](/docs/v5/asset/fiat-convert/query-trade){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Convert Status]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/fiat-convert/confirm-quote){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/fiat-convert/query-trade-history){.pagination-nav__link .pagination-nav__link--next}
