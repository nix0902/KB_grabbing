...
fetched: "2026-03-10T08:55:10+00:00"
---

# Get Balance

Source: [https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/balance-query](https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/balance-query)
...
-   [English](/docs/v5/asset/fiat-convert/balance-query){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/fiat-convert/balance-query){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Balance](/docs/v5/asset/fiat-convert/balance-query){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Balance]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/fiat-convert/query-trade-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/fiat-convert/trade-notify){.pagination-nav__link .pagination-nav__link--next}
