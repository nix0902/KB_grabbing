...
fetched: "2026-03-10T08:55:12+00:00"
---

# Get Trading Pair List

Source: [https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/query-coin-list](https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/query-coin-list)
...
-   [English](/docs/v5/asset/fiat-convert/query-coin-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/fiat-convert/query-coin-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Trading Pair List](/docs/v5/asset/fiat-convert/query-coin-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        ...
        -   [Trade Notify](/docs/v5/asset/fiat-convert/trade-notify){.menu__link tabindex="0"}
...
-   [Get Trading Pair List]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/convert-small-balance/exchange-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/fiat-convert/reference-price){.pagination-nav__link .pagination-nav__link--next}
