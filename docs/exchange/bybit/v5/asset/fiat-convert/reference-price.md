...
Source: [https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/reference-price](https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/reference-price)
...
-   [English](/docs/v5/asset/fiat-convert/reference-price){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/fiat-convert/reference-price){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Reference Price](/docs/v5/asset/fiat-convert/reference-price){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Reference Price]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/fiat-convert/query-coin-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/fiat-convert/quote-apply){.pagination-nav__link .pagination-nav__link--next}
