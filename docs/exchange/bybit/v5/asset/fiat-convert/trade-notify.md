...
fetched: "2026-03-10T08:55:15+00:00"
---

# Trade Notify

Source: [https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/trade-notify](https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/trade-notify)
...
-   [English](/docs/v5/asset/fiat-convert/trade-notify){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/fiat-convert/trade-notify){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        [Fiat-Convert](/docs/v5/asset/fiat-convert/query-coin-list){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Get Trading Pair List](/docs/v5/asset/fiat-convert/query-coin-list){.menu__link tabindex="0"}
        -   [Get Reference Price](/docs/v5/asset/fiat-convert/reference-price){.menu__link tabindex="0"}
        -   [Request a Quote](/docs/v5/asset/fiat-convert/quote-apply){.menu__link tabindex="0"}
        -   [Confirm a Quote](/docs/v5/asset/fiat-convert/confirm-quote){.menu__link tabindex="0"}
        -   [Get Convert Status](/docs/v5/asset/fiat-convert/query-trade){.menu__link tabindex="0"}
        -   [Get Convert History](/docs/v5/asset/fiat-convert/query-trade-history){.menu__link tabindex="0"}
        -   [Get Balance](/docs/v5/asset/fiat-convert/balance-query){.menu__link tabindex="0"}
        -   [Trade Notify](/docs/v5/asset/fiat-convert/trade-notify){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Fiat-Convert]{.breadcrumbs__link}
-   [Trade Notify]{.breadcrumbs__link itemprop="name"}
...
## Trade Notify[​](#trade-notify "Direct link to heading"){.hash-link} 

### Webhook URL[​](#webhook-url "Direct link to heading"){.hash-link} 

-   **Webhook_url**: Provided in the [trade-execute](/docs/v5/asset/fiat-convert/confirm-quote) API.

### Webhook Method[​](#webhook-method "Direct link to heading"){.hash-link} 
...
### Headers[​](#headers "Direct link to heading"){.hash-link} 
...
### Request Body[​](#request-body "Direct link to heading"){.hash-link} 
...
[](/docs/v5/asset/fiat-convert/balance-query){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/user/sign-agreement){.pagination-nav__link .pagination-nav__link--next}
...
-   [Trade Notify](#trade-notify){.table-of-contents__link .toc-highlight}
    -   [Webhook URL](#webhook-url){.table-of-contents__link .toc-highlight}
    -   [Webhook Method](#webhook-method){.table-of-contents__link .toc-highlight}
    -   [Authentication](#authentication){.table-of-contents__link .toc-highlight}
    -   [Headers](#headers){.table-of-contents__link .toc-highlight}
    -   [Request Body](#request-body){.table-of-contents__link .toc-highlight}
