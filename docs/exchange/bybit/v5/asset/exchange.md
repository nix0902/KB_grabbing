...
Source: [https://bybit-exchange.github.io/docs/v5/asset/exchange](https://bybit-exchange.github.io/docs/v5/asset/exchange)
...
-   [English](/docs/v5/asset/exchange){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/exchange){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Coin Exchange Records](/docs/v5/asset/exchange){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Coin Exchange Records]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/settlement){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/coin-info){.pagination-nav__link .pagination-nav__link--next}
