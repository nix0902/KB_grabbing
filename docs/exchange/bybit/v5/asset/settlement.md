...
fetched: "2026-03-10T08:55:17+00:00"
---

# Get USDC Session Settlement

Source: [https://bybit-exchange.github.io/docs/v5/asset/settlement](https://bybit-exchange.github.io/docs/v5/asset/settlement)
...
-   [English](/docs/v5/asset/settlement){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/settlement){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get USDC Session Settlement (2 years)](/docs/v5/asset/settlement){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get USDC Session Settlement (2 years)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/delivery){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/exchange){.pagination-nav__link .pagination-nav__link--next}
