...
fetched: "2026-03-10T08:55:04+00:00"
---

# Get Delivery Record

Source: [https://bybit-exchange.github.io/docs/v5/asset/delivery](https://bybit-exchange.github.io/docs/v5/asset/delivery)
...
-   [English](/docs/v5/asset/delivery){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/delivery){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   [Get Delivery Record (2 years)](/docs/v5/asset/delivery){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Delivery Record (2 years)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/fund-history){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/settlement){.pagination-nav__link .pagination-nav__link--next}
