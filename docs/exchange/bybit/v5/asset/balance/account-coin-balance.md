...
fetched: "2026-03-10T08:54:52+00:00"
---

# Get Single Coin Balance

Source: [https://bybit-exchange.github.io/docs/v5/asset/balance/account-coin-balance](https://bybit-exchange.github.io/docs/v5/asset/balance/account-coin-balance)
...
-   [English](/docs/v5/asset/balance/account-coin-balance){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/balance/account-coin-balance){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Single Coin Balance](/docs/v5/asset/balance/account-coin-balance){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        ...
        -   [Asset Overview](/docs/v5/asset/balance/asset-overview){.menu__link tabindex="0"}
...
-   [Get Single Coin Balance]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/sub-uid-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/balance/all-balance){.pagination-nav__link .pagination-nav__link--next}
