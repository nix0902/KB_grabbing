...
fetched: "2026-03-10T08:54:56+00:00"
---

# Confirm a Quote

Source: [https://bybit-exchange.github.io/docs/v5/asset/convert-small-balance/confirm-quote](https://bybit-exchange.github.io/docs/v5/asset/convert-small-balance/confirm-quote)
...
-   [English](/docs/v5/asset/convert-small-balance/confirm-quote){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/convert-small-balance/confirm-quote){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Confirm a Quote](/docs/v5/asset/convert-small-balance/confirm-quote){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/asset/convert-small-balance/request-quote){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/convert-small-balance/exchange-history){.pagination-nav__link .pagination-nav__link--next}
