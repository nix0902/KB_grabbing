...
fetched: "2026-03-10T08:54:57+00:00"
---

# Get Exchange History

Source: [https://bybit-exchange.github.io/docs/v5/asset/convert-small-balance/exchange-history](https://bybit-exchange.github.io/docs/v5/asset/convert-small-balance/exchange-history)
...
-   [English](/docs/v5/asset/convert-small-balance/exchange-history){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/convert-small-balance/exchange-history){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Small Balance Coins](/docs/v5/asset/convert-small-balance/small-balanc-coins){.menu__link tabindex="0"}
        ...
        -   [Get Exchange History](/docs/v5/asset/convert-small-balance/exchange-history){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Exchange History]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/convert-small-balance/confirm-quote){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/fiat-convert/query-coin-list){.pagination-nav__link .pagination-nav__link--next}
