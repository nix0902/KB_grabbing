...
fetched: "2026-03-10T08:55:18+00:00"
---

# Create Internal Transfer

Source: [https://bybit-exchange.github.io/docs/v5/asset/transfer/create-inter-transfer](https://bybit-exchange.github.io/docs/v5/asset/transfer/create-inter-transfer)
...
-   [English](/docs/v5/asset/transfer/create-inter-transfer){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/transfer/create-inter-transfer){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        [Transfer](/docs/v5/asset/transfer/create-inter-transfer){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
        

        -   [Create Internal Transfer](/docs/v5/asset/transfer/create-inter-transfer){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        -   [Get Internal Transfer Records](/docs/v5/asset/transfer/inter-transfer-list){.menu__link tabindex="0"}
        -   [Create Universal Transfer](/docs/v5/asset/transfer/unitransfer){.menu__link tabindex="0"}
        -   [Get Universal Transfer Records](/docs/v5/asset/transfer/unitransfer-list){.menu__link tabindex="0"}
        -   [Get Transferable Coin](/docs/v5/asset/transfer/transferable-coin){.menu__link tabindex="0"}
...
-   [Transfer]{.breadcrumbs__link}
-   [Create Internal Transfer]{.breadcrumbs__link itemprop="name"}
...
### Request Parameters[​](#request-parameters "Direct link to heading"){.hash-link} 
  ...
  ---------------------------------------------- ---------- -------- ------------------------------------------------------------------------------------------------------------------------------
  transferId                                     **true**   string   [UUID](https://www.uuidgenerator.net/dev-corner){target="_blank" rel="noopener noreferrer"}. Please manually generate a UUID
...
[](/docs/v5/asset/balance/asset-overview){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/transfer/inter-transfer-list){.pagination-nav__link .pagination-nav__link--next}
