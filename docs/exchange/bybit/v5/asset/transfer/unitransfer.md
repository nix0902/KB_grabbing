...
fetched: "2026-03-10T08:55:20+00:00"
---

# Create Universal Transfer

Source: [https://bybit-exchange.github.io/docs/v5/asset/transfer/unitransfer](https://bybit-exchange.github.io/docs/v5/asset/transfer/unitransfer)
...
-   [English](/docs/v5/asset/transfer/unitransfer){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/asset/transfer/unitransfer){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Create Internal Transfer](/docs/v5/asset/transfer/create-inter-transfer){.menu__link tabindex="0"}
        -   [Get Internal Transfer Records](/docs/v5/asset/transfer/inter-transfer-list){.menu__link tabindex="0"}
        -   [Create Universal Transfer](/docs/v5/asset/transfer/unitransfer){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Create Universal Transfer]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/asset/transfer/inter-transfer-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/asset/transfer/unitransfer-list){.pagination-nav__link .pagination-nav__link--next}
