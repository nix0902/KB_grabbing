...
fetched: "2026-03-10T08:57:23+00:00"
---

# Trade

Source: [https://bybit-exchange.github.io/docs/v5/rfq/websocket/public/public-transaction](https://bybit-exchange.github.io/docs/v5/rfq/websocket/public/public-transaction)
...
-   [English](/docs/v5/rfq/websocket/public/public-transaction){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/websocket/public/public-transaction){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   
            [Public](/docs/v5/rfq/websocket/public/public-transaction){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
            

            -   [Trade](/docs/v5/rfq/websocket/public/public-transaction){.menu__link .menu__link--active aria-current="page" tabindex="0"}

        -   
            [Private](/docs/v5/rfq/websocket/private/quote){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
...
[](/docs/v5/rfq/websocket/private/quote){.pagination-nav__link .pagination-nav__link--next}
