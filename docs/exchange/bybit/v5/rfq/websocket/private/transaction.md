...
fetched: "2026-03-10T08:57:22+00:00"
---

# Execution

Source: [https://bybit-exchange.github.io/docs/v5/rfq/websocket/private/transaction](https://bybit-exchange.github.io/docs/v5/rfq/websocket/private/transaction)
...
-   [English](/docs/v5/rfq/websocket/private/transaction){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/websocket/private/transaction){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        [Trade](/docs/v5/rfq/trade/create-rfq){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
    ...
    -   
        ...
        -   
            [Public](/docs/v5/rfq/websocket/public/public-transaction){.menu__link .menu__link--sublist .menu__link--sublist-caret aria-expanded="false" tabindex="0"}
            

        -   
            [Private](/docs/v5/rfq/websocket/private/quote){.menu__link .menu__link--sublist .menu__link--sublist-caret .menu__link--active aria-expanded="true" tabindex="0"}
            

            -   [Quote](/docs/v5/rfq/websocket/private/quote){.menu__link tabindex="0"}
            -   [Execution](/docs/v5/rfq/websocket/private/transaction){.menu__link .menu__link--active aria-current="page" tabindex="0"}
            -   [RFQ](/docs/v5/rfq/websocket/private/inquiry){.menu__link tabindex="0"}
...
[](/docs/v5/rfq/websocket/private/quote){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/websocket/private/inquiry){.pagination-nav__link .pagination-nav__link--next}
