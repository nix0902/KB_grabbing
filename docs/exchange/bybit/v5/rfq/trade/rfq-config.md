...
Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/rfq-config](https://bybit-exchange.github.io/docs/v5/rfq/trade/rfq-config)
...
-   [English](/docs/v5/rfq/trade/rfq-config){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/rfq-config){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get RFQ Configuration](/docs/v5/rfq/trade/rfq-config){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get RFQ Configuration]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/trade/create-rfq){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/cancel-rfq){.pagination-nav__link .pagination-nav__link--next}
