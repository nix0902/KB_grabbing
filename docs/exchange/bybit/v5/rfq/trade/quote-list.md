...
fetched: "2026-03-10T08:57:16+00:00"
---

# Get Quotes

Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/quote-list](https://bybit-exchange.github.io/docs/v5/rfq/trade/quote-list)
...
-   [English](/docs/v5/rfq/trade/quote-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/quote-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Quotes](/docs/v5/rfq/trade/quote-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Quotes]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/trade/quote-realtime){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/trade-list){.pagination-nav__link .pagination-nav__link--next}
