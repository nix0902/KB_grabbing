...
fetched: "2026-03-10T08:57:20+00:00"
---

# Get Trade History

Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/trade-list](https://bybit-exchange.github.io/docs/v5/rfq/trade/trade-list)
...
-   [English](/docs/v5/rfq/trade/trade-list){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/trade-list){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Trade History](/docs/v5/rfq/trade/trade-list){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
[](/docs/v5/rfq/trade/quote-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/public-trades){.pagination-nav__link .pagination-nav__link--next}
