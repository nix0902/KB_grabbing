...
fetched: "2026-03-10T08:57:12+00:00"
---

# Cancel RFQ

Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/cancel-rfq](https://bybit-exchange.github.io/docs/v5/rfq/trade/cancel-rfq)
...
-   [English](/docs/v5/rfq/trade/cancel-rfq){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/cancel-rfq){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Cancel RFQ](/docs/v5/rfq/trade/cancel-rfq){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Cancel RFQ]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/trade/rfq-config){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/cancel-all-rfq){.pagination-nav__link .pagination-nav__link--next}
