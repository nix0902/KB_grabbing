...
fetched: "2026-03-10T08:57:15+00:00"
---

# Get Public Trades

Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/public-trades](https://bybit-exchange.github.io/docs/v5/rfq/trade/public-trades)
...
-   [English](/docs/v5/rfq/trade/public-trades){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/public-trades){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Public Trades](/docs/v5/rfq/trade/public-trades){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Public Trades]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/trade/trade-list){.pagination-nav__link .pagination-nav__link--prev}
