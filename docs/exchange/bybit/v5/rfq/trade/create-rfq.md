...
Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/create-rfq](https://bybit-exchange.github.io/docs/v5/rfq/trade/create-rfq)
...
-   [English](/docs/v5/rfq/trade/create-rfq){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/create-rfq){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Create RFQ](/docs/v5/rfq/trade/create-rfq){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Create RFQ]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/basic-workflow){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/rfq-config){.pagination-nav__link .pagination-nav__link--next}
