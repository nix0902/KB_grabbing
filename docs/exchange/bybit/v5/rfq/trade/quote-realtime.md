...
fetched: "2026-03-10T08:57:17+00:00"
---

# Get Quotes (real-time)

Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/quote-realtime](https://bybit-exchange.github.io/docs/v5/rfq/trade/quote-realtime)
...
-   [English](/docs/v5/rfq/trade/quote-realtime){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/quote-realtime){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Get Quotes (real-time)](/docs/v5/rfq/trade/quote-realtime){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Get Quotes (real-time)]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/trade/rfq-list){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/quote-list){.pagination-nav__link .pagination-nav__link--next}
