...
fetched: "2026-03-10T08:57:09+00:00"
---

# Accept non-LP Quote

Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/accept-other-quote](https://bybit-exchange.github.io/docs/v5/rfq/trade/accept-other-quote)
...
-   [English](/docs/v5/rfq/trade/accept-other-quote){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/accept-other-quote){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Accept non-LP Quote](/docs/v5/rfq/trade/accept-other-quote){.menu__link .menu__link--active aria-current="page" tabindex="0"}
        ...
        -   [Get RFQs (real-time)](/docs/v5/rfq/trade/rfq-realtime){.menu__link tabindex="0"}
...
-   [Accept non-LP Quote]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/trade/cancel-all-rfq){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/create-quote){.pagination-nav__link .pagination-nav__link--next}
