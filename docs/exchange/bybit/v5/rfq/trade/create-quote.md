...
fetched: "2026-03-10T08:57:13+00:00"
---

# Create Quote

Source: [https://bybit-exchange.github.io/docs/v5/rfq/trade/create-quote](https://bybit-exchange.github.io/docs/v5/rfq/trade/create-quote)
...
-   [English](/docs/v5/rfq/trade/create-quote){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/rfq/trade/create-quote){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   
    ...
    -   
        ...
        -   [Create Quote](/docs/v5/rfq/trade/create-quote){.menu__link .menu__link--active aria-current="page" tabindex="0"}
...
-   [Create Quote]{.breadcrumbs__link itemprop="name"}
...
[](/docs/v5/rfq/trade/accept-other-quote){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/rfq/trade/execute-quote){.pagination-nav__link .pagination-nav__link--next}
