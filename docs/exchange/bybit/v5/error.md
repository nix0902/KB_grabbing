...
Source: [https://bybit-exchange.github.io/docs/v5/error](https://bybit-exchange.github.io/docs/v5/error)
...
-   [English](/docs/v5/error){.dropdown__link .dropdown__link--active target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（台灣）](/docs/zh-TW/v5/error){.dropdown__link target="_self" rel="noopener noreferrer" lang="zh-TW"}
...
-   [Error Codes](/docs/v5/error){.menu__link .menu__link--active aria-current="page"}
...
-   [Error Codes]{.breadcrumbs__link itemprop="name"}
...
## HTTP Code[​](#http-code "Direct link to heading"){.hash-link} 
...
## WS OE General code[​](#ws-oe-general-code "Direct link to heading"){.hash-link} 
...
## UTA[​](#uta "Direct link to heading"){.hash-link} 
  ...
  ------------ --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   ~~10018~~   ~~Exceeded the IP Rate Limit.~~
     ...
     110003    Order price exceeds the [allowable range](https://www.bybithelp.com/en-US/s/article/Contract-Price-Limits){target="_blank" rel="noopener noreferrer"}.
...
## Spot Trade[​](#spot-trade "Direct link to heading"){.hash-link} 
  ...
  -------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   170348  Please go to ([https://www.bybit-tr.com](https://www.bybit-tr.com){target="_blank" rel="noopener noreferrer"}) to proceed.
...
## Spot Margin Trade[​](#spot-margin-trade "Direct link to heading"){.hash-link} 
...
## Asset[​](#asset "Direct link to heading"){.hash-link} 
...
### Fiat Convert[​](#fiat-convert "Direct link to heading"){.hash-link} 
...
### Convert Small Balances[​](#convert-small-balances "Direct link to heading"){.hash-link} 
...
## Crypto Loan (New)[​](#crypto-loan-new "Direct link to heading"){.hash-link} 
...
## Crypto Loan (legacy)[​](#crypto-loan-legacy "Direct link to heading"){.hash-link} 
...
## Institutional Loan[​](#institutional-loan "Direct link to heading"){.hash-link} 
...
## Exchange Broker[​](#exchange-broker "Direct link to heading"){.hash-link} 
...
### Reward[​](#reward "Direct link to heading"){.hash-link} 
...
## Earn[​](#earn "Direct link to heading"){.hash-link} 
...
## User[​](#user "Direct link to heading"){.hash-link} 
...
## Set API rate limit[​](#set-api-rate-limit "Direct link to heading"){.hash-link} 
...
## RFQ[​](#rfq "Direct link to heading"){.hash-link} 
...
## Manual Loan[​](#manual-loan "Direct link to heading"){.hash-link} 
...
[](/docs/v5/enum){.pagination-nav__link .pagination-nav__link--prev}
...
[](/docs/v5/abandon/asset-info){.pagination-nav__link .pagination-nav__link--next}
...
-   [HTTP Code](#http-code){.table-of-contents__link .toc-highlight}
-   [WS OE General code](#ws-oe-general-code){.table-of-contents__link .toc-highlight}
-   [UTA](#uta){.table-of-contents__link .toc-highlight}
-   [Spot Trade](#spot-trade){.table-of-contents__link .toc-highlight}
-   [Spot Margin Trade](#spot-margin-trade){.table-of-contents__link .toc-highlight}
-   [Asset](#asset){.table-of-contents__link .toc-highlight}
    -   [Fiat Convert](#fiat-convert){.table-of-contents__link .toc-highlight}
    -   [Convert Small Balances](#convert-small-balances){.table-of-contents__link .toc-highlight}
-   [Crypto Loan (New)](#crypto-loan-new){.table-of-contents__link .toc-highlight}
-   [Crypto Loan (legacy)](#crypto-loan-legacy){.table-of-contents__link .toc-highlight}
-   [Institutional Loan](#institutional-loan){.table-of-contents__link .toc-highlight}
-   [Exchange Broker](#exchange-broker){.table-of-contents__link .toc-highlight}
    -   [Reward](#reward){.table-of-contents__link .toc-highlight}
-   [Earn](#earn){.table-of-contents__link .toc-highlight}
-   [User](#user){.table-of-contents__link .toc-highlight}
-   [Set API rate limit](#set-api-rate-limit){.table-of-contents__link .toc-highlight}
-   [RFQ](#rfq){.table-of-contents__link .toc-highlight}
-   [Manual Loan](#manual-loan){.table-of-contents__link .toc-highlight}
