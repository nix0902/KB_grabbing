...
**URL:** https://www.tradingview.com/support/solutions/43000756105-transactions-page/
...
- / Portfolio 
- / [ Transactions ](/support/folders/43000598044-transactions/)
- / [ Transactions page ](/support/solutions/43000756105-transactions-page/)
...
There are three table view modes:
...
- Symbol — ticker and company name.
- Date — date of the operation.
- Total dividend — operation amount.
- Notes — transaction notes.
 Previous Previous Holdings page Next Next Analysis: portfolio profitability Launch Supercharts
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43582197881/original/g4Spt9KcIM68_tV0cw3ZbpZ9GiKh0cbkEw.png?1758630489

**Описание:**

This image displays the **Transactions** section of the TradingView interface, focused on the \
