...
- / [ Expected payoff ](/support/solutions/43000772770-expected-payoff/)
...
The Expected payoff is calculated by dividing the total Net P&L by the number of total completed trades.
 ...
 Previous Previous Commission paid Next Next Buy & hold return Launch Supercharts
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43608763158/original/PbzhUOvvjh_kfuFu1HhJnIT0UwJIzkuCsQ.png?1771944424

**Описание:**

The image provided is **not a TradingView interface**—it is a mathematical formula for calculating \
