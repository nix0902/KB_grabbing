...
- / [ Auto Fib Retracement ](/support/solutions/43000585089-auto-fib-retracement/)
...
- [Chart types](https://www.tradingview.com/support/solutions/43000703407-chart-types-available-on-tradingview/)
 Previous Previous Auto Fib Extension Next Next Auto Pitchfork Launch Supercharts
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43570761792/original/FSazIxXASVvGW-35dNfhkRu3-DubO_LToQ.png?1753200676

**Описание:**

This image displays a **TradingView charting interface** focused on **Apple Inc. (AAPL)** stock, showing a 1-day (1D) candlestick chart with NASDAQ data. Below is a detailed breakdown of all UI elements, their purposes, and the information presented:


### **1. Top Navigation Bar (Left to Right)**
- **File/Chart Menu (⚙️ Icon):** Opens chart settings (timeframe, style, etc.).  
- **\
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43570761826/original/n3RNUENy2mLxKu2MxrBbh0CsGiIlBbD3Yg.png?1753200689

**Описание:**

This image shows a **TradingView chart interface** displaying Apple Inc.'s stock (NASDAQ: AAPL) with a focus on the **Indicators menu** open. Here’s a detailed breakdown:
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43582432162/original/t86jDvFeIQCPCW00EmhkOyNhpuqVdsCHqA.png?1758718468

**Описание:**

This image shows a **TradingView chart interface** displaying Apple Inc. (NASDAQ: AAPL) stock data with the **\
