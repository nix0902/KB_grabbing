...
**URL:** https://www.tradingview.com/support/solutions/43000589132-double-exponential-moving-average-ema/
...
- / [ Double Exponential Moving Average (EMA) ](/support/solutions/43000589132-double-exponential-moving-average-ema/)
...
- To calculate Double EMA, first choose the look-back period you would like to examine (i.e. five, 15, 100 periods).
- Once you have selected your period, go ahead and calculate the EMA for that period (EMAN). 
- Then apply a different EMA with the same lookback period to EMAN
- To finish, multiply the EMANby two and subtract the smoothed EMA amount. Now you’re all set.
...
The Double EMA is an indicator that identifies uptrends and downtrends in the current market. It responds quicker than traditional moving averages and can be used with other indicators to help traders analyze overall market trends. Make sure to look into lag if you will be utilizing Double EMAs so that you can determine if reducing lag will be what is best for you and your trade.
 Previous Previous Donchian Channels (DC) Next Next Ease of Movement (EOM) Launch Supercharts
