...
- / [ Ichimoku Cloud ](/support/solutions/43000589152-ichimoku-cloud/)
...
- Start by calculating the conversion line and the baseline.
- Next, use your previous calculations to then calculate the Leading Span A. Once you have this new calculation, plot this data point 26 periods in the future.
- Once you’ve done so, go ahead and calculate Leading Span B, and again, plot this data point 26 periods in the future as well.
...
- In order to create lines, initiate these steps again starting from Step 1. This will allow you to create new data points for the specific period you are interested in. By connecting the data points to each other, you will see the “cloud” start to come together.
...
The Ichimoku Cloud holds a variety of technical indicators that signal support and resistance levels along with trend direction and momentum. The indicator utilizes multiple averages to predict support and resistance levels within the market and can be used in combination with other indicators to give more conclusive data and monitor risk.
 Previous Previous Hull Moving Average Next Next Kaufman's Adaptive Moving Average (KAMA) Launch Supercharts
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43152570891/original/WfcHRSAlKkzvbRDffDDT5CHhqIFhuQeDqw.png?1598368015

**Описание:**

The image you've shared is **not a TradingView interface**—it's a mathematical formula sheet explaining the calculations for the **Ichimoku Kinko Hyō (Ichimoku Cloud)**, a technical analysis indicator. Below is a detailed breakdown of what the image shows, including the formulas and their components:


### 1. What the Image Shows  
The image displays the **five core components of the Ichimoku Cloud indicator**, each with its formula and Japanese name (in parentheses). These components are used to analyze price trends, support/resistance, and momentum in financial markets (stocks, forex, crypto, etc.).  


### 2. UI Elements (Formulas & Their Purposes)  
Each formula calculates a specific line or \

---

### Изображение 2

**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43586557679/original/6FbsO2EsSjNs0jy-c2IIEspJfnkWPMjdKA.png?1760620565

**Описание:**

Error: Command '['z-ai', 'vision', '-p', 'Describe this TradingView interface image in detail. Explain what it shows, all UI elements, buttons, and their purposes.', '-i', 'https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43586557679/original/6FbsO2EsSjNs0jy-c2IIEspJfnkWPMjdKA.png?1760620565']' timed out after 90 seconds
