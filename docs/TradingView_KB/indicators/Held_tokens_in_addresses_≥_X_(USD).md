...
**URL:** https://www.tradingview.com/support/solutions/43000773990-held-tokens-in-addresses-x-usd/
...
- / [ Held tokens in addresses ≥ X (USD) ](/support/solutions/43000773990-held-tokens-in-addresses-x-usd/)
...
Held tokens in addresses ≥ X (USD) is calculated by summing balances from all addresses where (balance × current USD price) ≥ X. Users can adjust the X parameter in the indicator settings to analyze supply concentration at different economic levels.
 Previous Previous Held tokens in addresses ≥ X (tokens) Next Next Historical Volatility Launch Supercharts
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43599213783/original/7CSkxMoZIyC_dnQvpzlzKgJAs-01asam8g.png?1767095597

**Описание:**

This image shows a **TradingView interface** displaying a configuration panel for a technical analysis tool (likely a \
