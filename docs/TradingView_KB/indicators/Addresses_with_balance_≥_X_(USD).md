...
**URL:** https://www.tradingview.com/support/solutions/43000773988-addresses-with-balance-x-usd/
...
- / [ Addresses with balance ≥ X (USD) ](/support/solutions/43000773988-addresses-with-balance-x-usd/)
...
Addresses with balance ≥ X (USD) is calculated by counting unique addresses where (balance × current USD price) ≥ X. Users can adjust the X parameter in the indicator settings to analyze different economic holder tiers.
 Previous Previous Addresses with balance ≥ X (% of supply) Next Next Advance/Decline Line Launch Supercharts
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43599212774/original/jqt1W2_vf04OV9msMzYRtmSzj6-fSZV4Bg.png?1767095197

**Описание:**

This image shows a **TradingView interface** displaying a configuration panel for a technical indicator or study titled **\
