...
- / [ Awesome Oscillator (AO) ](/support/solutions/43000501826-awesome-oscillator-ao/)
...
- [Portfolios: track your assets, know your trades](https://www.tradingview.com/support/solutions/43000760937-tradingview-portfolios-track-your-assets-know-your-trades/)
 Previous Previous Average True Range (ATR) Next Next Balance of Power (BOP) Launch Supercharts
...
**URL:** https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43582440222/original/SJWop1liWfvQQGkPcNlEhFMqiToDU9sMYQ.png?1758720312

**Описание:**

This image shows a **TradingView chart interface** displaying Apple Inc. (NASDAQ: AAPL) stock data with the **Awesome Oscillator (AO)** indicator configuration panel open. Here's a detailed breakdown:
