...
- / [ Symbols you can analyze and trade on TradingView ](/support/solutions/43000764889-symbols-you-can-analyze-and-trade-on-tradingview/)

# Symbols you can analyze and trade on TradingView 
 When you begin trading, the variety of markets and symbols can feel overwhelming. Should you buy stocks, explore crypto, or look into futures? Each type of symbol has its own character: different risks, rewards, and methods of analysis. TradingView brings all of these markets into one place, so you can explore them side by side and decide which fits your style and goals.
...
Futures traders often rely heavily on [technical analysis](https://www.tradingview.com/support/solutions/43000759577-the-technical-analysis-essentials-with-tradingview/), volume data, and global economic news. These instruments can be attractive for active traders who want exposure to markets beyond stocks — from energy to agricultural products — or for businesses that need to hedge price risks.

On TradingView, you can practice [simulated futures trading](https://www.tradingview.com/support/solutions/43000762709-simulated-futures-real-market-experience-with-paper-trading/) to work out your strategy in a risk-free environment.
...
- [Bar Replay: how and why to test a strategy in the past](https://www.tradingview.com/support/solutions/43000712747-bar-replay-how-and-why-to-test-a-strategy-in-the-past/)
 Previous Previous How to trade on TradingView Next Next Chart trading on TradingView: key features and advantages Launch Supercharts
