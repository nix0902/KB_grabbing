# Widget Tutorials: Dynamic Symbol Change

**Source:** https://www.tradingview.com/widget-docs/tutorials/iframe/build-page/dynamic-symbols

---

Home / Tutorials / Iframe / Build a page / Dynamic symbolstype: iframe# Dynamically changing the symbol
...
- JS`{ /* ... the other options ...*/ "symbol": "NASDAQ:NVDA" /* ← changed from NASDAQ:AAPL */}`Symbol names are defined using the syntax `{EXCHANGE}:{NAME}`.
...
Legacy Ticker Tape is excluded because it isn’t specific to a single symbol but rather is used to show the prices for multiple symbols.
...
- Original URL: https://www.tradingview.com/widget-docs/tutorials/iframe/build-page/dynamic-symbols
