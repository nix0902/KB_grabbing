# What are Symbols and Trading Pairs

**URL:** https://help.cornix.io/en/articles/5814970-what-are-symbols-and-trading-pairs

**Created:** 2026-03-03T12:04:55+00:00

---

What are Symbols and Trading Pairs | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
Each cryptocurrency has its own symbol (also called ticker) that is used to identify the currency. For example Bitcoin has the ticker 'BTC' and Ethereum has the ticker 'ETH'.
The term “Trading Pair” describes the pair of assets that are traded between one type of cryptocurrency and another. For example, the trading pair ETH/BTC means that you can buy Ethereum with Bitcoin, or Sell Ethereum for Bitcoin.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"5814970","anonymous_id":"0b97f639-bf19-4083-bf6d-3138dcb853fc"};
...
\n\n---\n\n## Изображения\n\n### Изображение 1\n\n![Image 1](https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png)\n\n**URL:** https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png\n\n**Описание:** The screenshot displays the Cornix trading bot’s logo: a stylized dark blue crow (raven) holding a yellow object in its beak, perched on a curved line, with the brand name “cornix” in bold, dark blue lowercase letters below. The design is clean and minimalist, emphasizing the brand identity without additional UI elements, buttons, or charts visible in this specific frame.\n\n---\n\n### Изображение 2\n\n![Image 2](https://static.intercomassets.com/avatars/4586445/square_128/Screen_Shot_2022-02-06_at_2.34.28_PM-1644150878.png)\n\n**URL:** https://static.intercomassets.com/avatars/4586445/square_128/Screen_Shot_2022-02-06_at_2.34.28_PM-1644150878.png\n\n**Описание:** The screenshot shows a Cornix trading bot interface with a profile section at the top (featuring a circular avatar of a person in a gray shirt, set against a background with a tree and rocks) and likely additional UI elements (e.g., menu, settings, or trading controls) below, though the lower portion is not fully visible. The avatar is the most prominent UI element, with a clean, simple design typical of user profile displays in trading applications.\n\n---\n\n
