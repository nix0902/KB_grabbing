...
**URL:** https://help.cornix.io/en/articles/6166394-cornix-smart-dca-bots

**Created:** 2026-03-03T11:45:40+00:00

---

Cornix Smart DCA Bots | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
Search for articles...
Table of contents
What is DCA?How Does It Work?Basic DCA strategy:How can Cornix Smart DCA Bots benefit you?Why use Cornix Smart DCA Bots?How to Get Started with Cornix DCA bots?- All Collections
- Trading Bots
- DCA
- Cornix Smart DCA Bots
# Cornix Smart DCA Bots
What are smart DCA Bots and how does it work?
Written by Hadar Cornix Updated over 3 months agoTable of contents
What is DCA?How Does It Work?Basic DCA strategy:How can Cornix Smart DCA Bots benefit you?Why use Cornix Smart DCA Bots?How to Get Started with Cornix DCA bots?
# What is DCA?
...
Cornix smart DCA bots will start buying at market price and then will continue purchasing as the price decreases. The bot will sell at a profit when the price increases, or at a loss if the stop-loss is reached, and will start a new trading cycle every time a trade is closed (reached take profit or stop-loss).
...
-
Save time with a set-and-forget approach
-
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"6166394","anonymous_id":"a4caf6b6-bb44-4443-8af8-c44a08d22ab7"};
