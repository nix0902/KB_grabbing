# Signals Bot Advanced Settings - Overview

**URL:** https://help.cornix.io/en/articles/8800218-signals-bot-advanced-settings-overview

**Created:** 2026-03-03T11:46:44+00:00

---

Signals Bot Advanced Settings - Overview | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
Search for articles...
Table of contents
GeneralEntriesTake-ProfitsStopAdvanced- All Collections
- Trading Bots
- Signals
...
GeneralEntriesTake-ProfitsStopAdvanced
The advanced settings are made for advanced users and allow you full control of the signals bot configuration. Switching back to Basic Settings will discard any changes you made in the advanced sections.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"8800218","anonymous_id":"d0900208-73a4-4735-a81e-6a02285ac320"};
