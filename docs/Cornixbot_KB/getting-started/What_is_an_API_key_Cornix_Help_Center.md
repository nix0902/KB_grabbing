# What is an API key? | Cornix Help Center

**URL:** https://help.cornix.io/en/articles/5814843-what-is-an-api-key

---

What is an API key? | Cornix Help Center         - - - - - -          Skip to main content                      

     Dashboard  Announcements Channel    English    
...
What an API key is and permissions, and how it enables secured connection with your exchange
         Written by  Dor   Updated over 8 months ago          Table of contents   
...
**Описание:** The screenshot displays the Cornix trading bot’s logo: a stylized dark blue crow (raven) holding a yellow object (likely a coin) in its beak, perched on a curved line above the bold, dark blue text “cornix.” The design is clean and minimalist, emphasizing the brand’s name and bird mascot without additional UI elements, buttons, or charts visible.

### Изображение 2

**URL:** https://static.intercomassets.com/avatars/4586445/square_128/Screen_Shot_2022-02-06_at_2.34.28_PM-1644150878.png

**Описание:** The Cornix trading bot screenshot displays a clean, functional UI with a central chart (likely for price tracking) flanked by panels for trade settings, order history, and bot configuration. Key elements include buttons for starting/stopping the bot, toggles for strategy parameters (e.g., take profit/stop loss), and a menu bar for accessing account, backtesting, or support features. The layout emphasizes real-time data visualization and quick access to trading controls.
...
**Описание:** The Cornix trading bot screenshot shows a connection setup page with UI elements for entering an **Account Name** (pre-filled with "My Account"), **API Key**, and **API Secret** (all in text input fields). Below, there’s a note about adding Cornix’s IP addresses to Binance’s trusted IPs, a text box displaying IP addresses (with a blue "Copy" button), and a prominent blue "Connect" button at the bottom.
...
**Описание:** The screenshot displays a section titled "API restrictions" with a grid of checkbox options for configuring trading permissions. Checked checkboxes enable "Reading," "Spot & Margin Trading," and "Futures," while unchecked options include "Withdrawals," "Margin," "Permits Universal Transfer," and "Vanilla Options." The UI uses a clean, minimalistic design with gray text and checkboxes on a white background.
