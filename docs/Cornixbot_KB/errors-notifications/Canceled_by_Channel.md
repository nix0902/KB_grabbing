...
**URL:** https://help.cornix.io/en/articles/5814893-canceled-by-channel

**Created:** 2026-03-03T11:58:12+00:00

---

Canceled by Channel | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
Order might be canceled with this status when the order was included in a trade created with auto-trading based on a signal canceled by the channel.

When the admin cancels the signal, if any entry targets were fulfilled (coins\contracts were already purchased), a sell market order will be executed and displayed as a new take profit target that was fulfilled at market price.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"5814893","anonymous_id":"9fe689f5-db91-40d5-92e6-a89413dd1282"};
