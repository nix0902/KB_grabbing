...
**URL:** https://help.cornix.io/en/articles/5814914-position-liquidated

**Created:** 2026-03-03T12:00:36+00:00

---

Position Liquidated | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
The “Position Liquidated” status indicates that the position has been liquidated on the exchange. Meaning the exchange has automatically closed your position to prevent further losses, typically when your margin balance falls below the required maintenance margin.
For some exchanges, you can view the trade’s liquidation price on the trade details page. If the exchange does not support this information via API, it will only be visible directly on the exchange.
This information is currently supported on the following exchanges: Binance, Bybit, and KuCoin.

For all other exchanges, liquidation events will still appear as “Position Decreased.”
This means the closing price of those trades may not always reflect the exact liquidation value, and the data shown directly on the exchange will be more accurate.
In the future, Cornix will support detailed liquidation information across all exchanges.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"5814914","anonymous_id":"bbc60e2e-6065-4a46-bff0-a115fba6b635"};
