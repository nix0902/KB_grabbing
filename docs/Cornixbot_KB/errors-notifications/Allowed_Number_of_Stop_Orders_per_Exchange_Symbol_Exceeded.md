# Allowed Number of Stop Orders per Exchange Symbol Exceeded

**URL:** https://help.cornix.io/en/articles/5814913-allowed-number-of-stop-orders-per-exchange-symbol-exceeded

**Created:** 2026-03-03T12:00:25+00:00

---

Allowed Number of Stop Orders per Exchange Symbol Exceeded | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
Each exchange allows a different number of active Stop Orders (conditional orders) per symbol.

If a trade didn't open or an order was canceled with this status, it means that you reached the exchange limit of the allowed number of active Stop Orders per a certain symbol.

Cornix uses Stop Orders (conditional orders) in the following cases:
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"5814913","anonymous_id":"cecf7e3e-ceef-4e7b-9c87-361b032d16a4"};
...
\n\n---\n\n## Изображения\n\n### Изображение 1\n\n![Image 1](https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png)\n\n**URL:** https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png\n\n**Описание:** The screenshot displays the Cornix trading bot’s logo, featuring a stylized dark blue crow (raven) holding a small yellow object in its beak, perched on a curved line above the bold, dark blue text “cornix.” The design is minimalistic, with a clean white background emphasizing the logo’s graphic and typographic elements.\n\n---\n\n### Изображение 2\n\n![Image 2](https://static.intercomassets.com/avatars/4586445/square_128/Screen_Shot_2022-02-06_at_2.34.28_PM-1644150878.png)\n\n**URL:** https://static.intercomassets.com/avatars/4586445/square_128/Screen_Shot_2022-02-06_at_2.34.28_PM-1644150878.png\n\n**Описание:** The screenshot shows a Cornix trading bot interface with a clean, structured layout. Key UI elements include a sidebar with navigation icons (e.g., home, charts, settings), a central dashboard displaying trading metrics (e.g., profit/loss, trade history), and a top bar with user profile and notification icons. The design emphasizes clarity, with distinct sections for bot configuration, real-time data, and action buttons (e.g., start/stop trading).\n\n---\n\n
