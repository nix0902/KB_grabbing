...
**URL:** https://help.cornix.io/en/articles/5814899-not-enough-funds-available

**Created:** 2026-03-03T11:58:42+00:00

---

Not Enough Funds Available | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
This means that you had sufficient funds for this order when you opened this trade, but now you do not.

This usually happens when you use the funds allocated for this order not through Cornix, for example when directly opening a different order for the same symbol directly in the exchange.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"5814899","anonymous_id":"42375e0c-7bb0-4985-9c79-a00539593eda"};
