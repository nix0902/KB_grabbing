...
**URL:** https://help.cornix.io/en/articles/5814910-invalid-price

**Created:** 2026-03-03T11:59:55+00:00

---

Invalid Price | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
An order might be canceled with this status when the order price is invalid and was rejected when trying to create the order in the exchange. This usually happens when the order price is not between the minimum and maximum price that's allowed in the exchange.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"5814910","anonymous_id":"d1c4b1b4-f6a2-4765-b00d-b5c3a83ad047"};
...
\n\n---\n\n## Изображения\n\n### Изображение 1\n\n![Image 1](https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png)\n\n**URL:** https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png\n\n**Описание:** The screenshot displays the Cornix trading bot’s logo, featuring a stylized dark blue crow holding a small yellow object in its beak, positioned above the lowercase text “cornix” in a matching dark blue font. The design is minimalistic, with the crow perched on a subtle curved line that connects to the letter “x,” emphasizing the brand’s visual identity.\n\n---\n\n### Изображение 2\n\n![Image 2](https://static.intercomassets.com/avatars/4586445/square_128/Screen_Shot_2022-02-06_at_2.34.28_PM-1644150878.png)\n\n**URL:** https://static.intercomassets.com/avatars/4586445/square_128/Screen_Shot_2022-02-06_at_2.34.28_PM-1644150878.png\n\n**Описание:** The screenshot features a Cornix trading bot interface with a clean, minimalistic design. Key UI elements include a navigation bar at the top (likely with tabs or menu options), a central section displaying trading-related data (such as charts, metrics, or bot settings), and a sidebar or panel for additional controls or information. The layout emphasizes clarity, with distinct sections for monitoring and managing trading activities.\n\n---\n\n
