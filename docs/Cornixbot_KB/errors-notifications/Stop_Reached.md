...
**URL:** https://help.cornix.io/en/articles/5814903-stop-reached

**Created:** 2026-03-03T11:59:12+00:00

---

Stop Reached | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
When the trade's Stop target price is reached on the exchange before Entry target was reached and fulfilled, your trade might get closed with this reason.
When this happens, any pending Take-Profit target will be cancelled with the Stop Reached status.

If you don't want that to happen, you might want to disable your "Close Trade on Take Profit/Stop-Loss before Entry" configuration.

Visit this link for more info about how to disable it:
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"5814903","anonymous_id":"c67eac7b-0f60-4328-9ad9-f349786bcaaf"};
