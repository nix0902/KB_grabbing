# Allowed Number of Limit Orders per Exchange Symbol Exceeded

**URL:** https://help.cornix.io/en/articles/6973889-allowed-number-of-limit-orders-per-exchange-symbol-exceeded

**Created:** 2026-03-03T12:01:37+00:00

---

Allowed Number of Limit Orders per Exchange Symbol Exceeded | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
Each exchange allows a different number of active limit orders per symbol.

If a trade didn't open or an order was canceled with this status, it means that you reached the exchange limit of the allowed number of active limit orders per a certain symbol.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"6973889","anonymous_id":"c89bf1c9-6ba7-49e6-b4ac-1092fd7bd69f"};
...
\n\n---\n\n## Изображения\n\n### Изображение 1\n\n![Image 1](https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png)\n\n**URL:** https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png\n\n**Описание:** The screenshot displays the Cornix trading bot’s logo, featuring a stylized dark blue crow holding a small yellow object in its beak, perched above the lowercase “cornix” text (also dark blue) with a subtle dot beneath the “x.” The design is clean and minimalist, emphasizing the brand’s name and bird mascot against a white background.\n\n---\n\n### Изображение 2\n\n![Image 2](https://static.intercomassets.com/avatars/5322994/square_128/IMG-20230206-WA0000_%281%29-1678375300.jpeg)\n\n**URL:** https://static.intercomassets.com/avatars/5322994/square_128/IMG-20230206-WA0000_%281%29-1678375300.jpeg\n\n**Описание:** The screenshot shows a Cornix trading bot interface with a clean, minimalistic design. The UI includes a sidebar on the left with navigation options (likely for bot management, settings, or trading pairs), a central area displaying bot performance metrics (e.g., profit/loss, trade history), and a top bar with user profile or account details. The layout emphasizes clarity, with distinct sections for monitoring and controlling trading activities.\n\n---\n\n
