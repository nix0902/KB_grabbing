# KYC is Required by the Exchange

**URL:** https://help.cornix.io/en/articles/8133282-kyc-is-required-by-the-exchange

**Created:** 2026-03-03T12:01:57+00:00

---

KYC is Required by the Exchange | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
If an order or a trade is closed with this status it means that the exchange rejected your orders as you are required to complete your exchange KYC verification. To avoid this restriction, please log in to your exchange account and complete the necessary verification.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"8133282","anonymous_id":"9fb173c3-1cb2-4db1-937e-ddd0b5853a9f"};
...
\n\n---\n\n## Изображения\n\n### Изображение 1\n\n![Image 1](https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png)\n\n**URL:** https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png\n\n**Описание:** The screenshot displays the Cornix trading bot’s logo, featuring a stylized dark blue crow (or raven) holding a small yellow object in its beak, perched on a curved line above the brand name “cornix” in bold, dark blue lowercase letters. The design is minimalistic, with the logo centered against a plain white background, emphasizing the brand’s visual identity.\n\n---\n\n### Изображение 2\n\n![Image 2](https://static.intercomassets.com/avatars/5322994/square_128/IMG-20230206-WA0000_%281%29-1678375300.jpeg)\n\n**URL:** https://static.intercomassets.com/avatars/5322994/square_128/IMG-20230206-WA0000_%281%29-1678375300.jpeg\n\n**Описание:** The screenshot shows a Cornix trading bot interface with a clean, minimalistic design. Key UI elements include a navigation bar (likely for account or bot management), a central dashboard area (possibly displaying trading metrics or bot status), and a sidebar (for settings or strategy configuration). The layout emphasizes clarity, with distinct sections for monitoring and controlling trading activities.\n\n---\n\n
