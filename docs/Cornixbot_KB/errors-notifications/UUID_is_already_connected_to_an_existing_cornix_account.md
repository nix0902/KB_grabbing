# UUID is already connected to an existing cornix account

**URL:** https://help.cornix.io/en/articles/6175288-uuid-is-already-connected-to-an-existing-cornix-account

**Created:** 2026-03-03T12:01:08+00:00

---

UUID is already connected to an existing cornix account | Cornix Help Center- - - - - - :root{--body-bg: rgb(255, 255, 255);
--body-image: none;
...
If you've received this error message this might mean one of the following:
-
You are trying to connect with a wrong Email address
-
You are trying to connect with a different Telegram account than the one associated with this Email
Please make sure you are using the correct data for the registration.
If you are still not sure, please contact support for further help.
...
Intercom
We run on Intercom
window.intercomSettings = {"app_id":"wrsw0nb0","article_id":"6175288","anonymous_id":"ddf84de5-6493-49b4-856d-50120a72ec39"};
...
\n\n---\n\n## Изображения\n\n### Изображение 1\n\n![Image 1](https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png)\n\n**URL:** https://downloads.intercomcdn.com/i/o/wrsw0nb0/663085/66f657d34c477c0cb5e0ad55a357/811b89d422741a7d1e34bcfcff4f39f0.png\n\n**Описание:** The screenshot displays the Cornix trading bot’s logo, featuring a stylized dark blue crow (raven) holding a small yellow object in its beak, perched on a curved line above the bold, dark blue text “cornix” (with a dot above the “i”). The design is clean and minimalistic, emphasizing the brand’s visual identity.\n\n---\n\n### Изображение 2\n\n![Image 2](https://static.intercomassets.com/avatars/5322994/square_128/IMG-20230206-WA0000_%281%29-1678375300.jpeg)\n\n**URL:** https://static.intercomassets.com/avatars/5322994/square_128/IMG-20230206-WA0000_%281%29-1678375300.jpeg\n\n**Описание:** The screenshot shows a Cornix trading bot interface with a clean, minimalistic design. Key UI elements include a sidebar with navigation icons (e.g., home, charts, settings), a central dashboard displaying trading metrics (e.g., profit/loss, active bots), and a top bar with user profile and settings options. The layout emphasizes clarity, with distinct sections for bot management, performance tracking, and configuration.\n\n---\n\n
